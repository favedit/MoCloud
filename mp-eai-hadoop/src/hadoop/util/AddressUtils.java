 ...
 * 
 * @author 胡国青
 * ip地址查询工具类:http://ip.taobao.com/index.php
 */
            ...
            for(int third = 0; third <= 255; third++){
               for(int fourth = 0; fourth <= 255; fourth++){
                  try{
                     ...
                     Thread.sleep(5000);
                     System.out.println(addressUtils.getAddresses("ip=" + first + "." + second + "." + third + "." + fourth, "utf-8"));
                  }catch(Exception e){
                     //e.printStackTrace();
                  }
               }
