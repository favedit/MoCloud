...
// <T>统计计算器。</T>
//============================================================
public class RStatisticsTenderCalculater
      extends FObject
{
   // 日志输出接口
   protected static ILogger _logger = RLogger.find(RStatisticsTenderCalculater.class);
   ...
   public static void main(String[] args){
      ...
      try(FLogicContext logicContext = new FLogicContext(databaseConsole)){
         FStatisticsTenderCalculater calculater = new FStatisticsTenderCalculater();
