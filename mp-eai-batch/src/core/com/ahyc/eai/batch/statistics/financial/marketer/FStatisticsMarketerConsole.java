         ...
         IStatisticsMarketerConsole
{
   ...
   public FStatisticsFinancialMarketerUnit syncByLinkId(FLogicContext logicContext,
      ...
      if(departmentRow != null){
         ...
         FStatisticsFinancialDepartmentUnit departmentUnit = _departmentConsole.syncByLinkId(logicContext, departmentLinkId);
         unit.setDepartmentId(departmentUnit.ouid());
         unit.setDepartmentLinkId(departmentUnit.linkId());
         unit.setDepartmentLabel(departmentUnit.label());
         unit.setDepartmentLevel1Id(departmentUnit.level1Id());
         unit.setDepartmentLevel1LinkId(departmentUnit.level1LinkId());
         unit.setDepartmentLevel1Label(departmentUnit.level1Label());
         unit.setDepartmentLevel2Id(departmentUnit.level2Id());
         unit.setDepartmentLevel2LinkId(departmentUnit.level2LinkId());
         unit.setDepartmentLevel2Label(departmentUnit.level2Label());
         unit.setDepartmentLevel3Id(departmentUnit.level3Id());
         unit.setDepartmentLevel3LinkId(departmentUnit.level3LinkId());
         unit.setDepartmentLevel3Label(departmentUnit.level3Label());
         unit.setDepartmentLevel4Id(departmentUnit.level4Id());
         unit.setDepartmentLevel4LinkId(departmentUnit.level4LinkId());
         unit.setDepartmentLevel4Label(departmentUnit.level4Label());
         unit.setDepartmentLevel5Id(departmentUnit.level5Id());
         unit.setDepartmentLevel5LinkId(departmentUnit.level5LinkId());
         unit.setDepartmentLevel5Label(departmentUnit.level5Label());
         unit.setDepartmentLevel6Id(departmentUnit.level6Id());
         unit.setDepartmentLevel6LinkId(departmentUnit.level6LinkId());
         unit.setDepartmentLevel6Label(departmentUnit.level6Label());
         unit.setDepartmentLevel7Id(departmentUnit.level7Id());
         unit.setDepartmentLevel7LinkId(departmentUnit.level7LinkId());
         unit.setDepartmentLevel7Label(departmentUnit.level7Label());
      }
      // 设置入职时间
      ...
      if(memberUnit.marketerId() == 0){
         ...
         memberUnit.setDepartmentLinkId(departmentLinkId);
   ...
   public void updateDepartment(FLogicContext logicContext,
      ...
      unit.setRankLabel(row.get("rank"));
      // 设置部门
      long departmentLinkId = row.getLong("dept_id");
      FStatisticsFinancialDepartmentUnit departmentUnit = _departmentConsole.syncByLinkId(logicContext, departmentLinkId);
