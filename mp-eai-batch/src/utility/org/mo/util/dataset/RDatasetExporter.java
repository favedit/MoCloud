...
public class RDatasetExporter
{
   public static void main(String[] args){
      String targetPath = "D:/data";
      RAop.configConsole().defineCollection().attributes().set("application", "D:/Microbject/MoCloud");
      RAop.initialize("D:/Microbject/MoCloud/mp-eai-content/src/config/application-work.xml");
      IDatabaseConsole databaseConsole = RAop.find(IDatabaseConsole.class);
      ISqlConnection connection = databaseConsole.alloc("data");
