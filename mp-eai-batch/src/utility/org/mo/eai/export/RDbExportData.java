   ...
   public static void main(String[] args) throws Exception{
      ...
      try{
         ...
         try(ILogicContext logicContext = new FLogicContext(dbConsole)){
            ...
            storageConsole.exportDataset(logicContext, "online.data", "DT_COM_COUNTRY", path);
            storageConsole.exportDataset(logicContext, "online.data", "DT_COM_AREA", path);
            storageConsole.exportDataset(logicContext, "online.data", "DT_COM_PROVINCE", path);
            storageConsole.exportDataset(logicContext, "online.data", "DT_COM_CITY", path);
            storageConsole.exportDataset(logicContext, "online.data", "DT_COM_CITY_CARD", path);
         }
      }catch(Exception e){
