    ...
    <div class='cy_edit_panel'>
      <table border="0" width="1200">
        ...
        <tr>
          ...
          <td align="left">
             <select id="teacherId" name="teacherId" class="easyui-combogrid" style="width:80px;"></select>
          </td>
        ...
        <tr>
          ...
          <td align="left"><input name="birthday" class="easyui-datetimebox" data-options="required:true,showSeconds:false" value="9999"style="width:140px;"/></td>
       ...
       <tr>
        ...
        <td align="left" width="49">豆币</td>
         ...
         <td align="left" width="49">职业级别</td>
          ...
          value="1" data-options="required:true"/></td>
