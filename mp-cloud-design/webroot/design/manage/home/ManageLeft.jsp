...
<div id="cy_left">
   ...
   <ul id="accordion" class="accordion">
    ...
    <li id="two" class="mail"> 
      <a href="#">用户管理</a>
      <ul class="sub-menu">
         <jh:equals source="manage.user" value="&basePage.menuString"><li><a href="/cloud/manage/user/User.wa" target="right" >用户管理</a></li></jh:equals>
      </ul>
    </li>
    ...
    <li id="four" class="files">
     ...
     <li id="eight" class="files">
      <a href="#">服务器管理</a>
      <ul class="sub-menu">
         <jh:equals source="manage.service.test" value="&basePage.menuString"><li><a href="/cloud/manage/service/ServiceDevelop.wa" target="right" >服务器管理</a></li></jh:equals>        
      </ul>
    </li>
  </ul>
       <!-- 导航 结束 -->
