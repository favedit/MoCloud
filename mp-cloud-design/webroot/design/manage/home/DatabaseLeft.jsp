...
function onDatabaseTypeChanged(){
	...
	var openQueryView = document.getElementById("openQueryView");
	openQueryView.href="/cloud/manage/database/Database.wa?do=getQueryView&databaseType="+databaseType+"&date="+new Date().valueOf();
}
...
<div id="cy_left">
  <ul class="accordion">
    <li id="one" class="common"> <a href="#one">数据库操作</a>
      <ul class="sub-menu">
        <li><a id="openQueryView" href="/cloud/manage/database/Database.wa?do=getQueryView" target="right">数据查询</a></li>
        <li><a id="openBackupView" href="/cloud/manage/database/Database.wa?do=getBackupView" target="right">数据备份</a></li>
      </ul>
    </li>
