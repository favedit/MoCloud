...
<ToolBar width='100%' height='100%' align='right'>
	<ToolButtonText name='btnForm' label='逻辑列表' icon='sys.pst.mgr' target='frmMain' page='#/editor/logic/Logic.wa?do=list&amp;form_name=cloud.editor.logic.LogicList'/>
	<ToolButton name='btnRefresh' icon='tool.refresh' action='refreshNode()'/>
</ToolBar>
</XML>
<!-- TreeView config ----------------------------------------->
<jc:tree name='xTree' source='cloud.editor.logic'/>
<!-- Body begin ---------------------------------------------->
