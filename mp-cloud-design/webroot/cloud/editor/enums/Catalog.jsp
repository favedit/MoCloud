...
function onSearch(){
   ...
   if(s){
      ...
      tree.service = 'search@cloud.editor.enum';
...
<ToolBar width='100%' height='100%' align='right'>
	<ToolButtonText name='btnForm' label='枚举列表' icon='sys.pst.mgr' target='frmMain' page='#/editor/enums/Enum.wa?do=list&amp;form_name=cloud.editor.enum.GroupList'/>
	<ToolButton name='btnRefresh' icon='tool.refresh' action='refreshNode()'/>
</ToolBar>
</XML>
<!-- TreeView config ----------------------------------------->
<jc:tree name='xTree' source='cloud.editor.enum'/>
<!-- Body begin ---------------------------------------------->
