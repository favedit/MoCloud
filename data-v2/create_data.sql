...
-- ------------------------------------------------------------
-- Create table [Data.Resource.Model.Mesh.Track]
-- ------------------------------------------------------------
DROP TABLE IF EXISTS `DT_RES_MODEL_MESH_TRACK`;
CREATE TABLE `DT_RES_MODEL_MESH_TRACK` 
( 
   `OUID`                          BIGINT NOT NULL AUTO_INCREMENT PRIMARY KEY, 
   `OVLD`                          TINYINT NOT NULL DEFAULT TRUE, 
   `GUID`                          VARCHAR(40) NOT NULL, 
...
ALTER TABLE DT_RES_MODEL_MESH_TRACK 
   ADD CONSTRAINT DT_RES_MOD_MSH_TCK_UK_GID UNIQUE ( GUID ); 

ALTER TABLE DT_RES_MODEL_MESH_TRACK ADD CONSTRAINT DT_RES_MOD_MSH_TCK_FK_USR 
      FOREIGN KEY (`USER_ID`) REFERENCES DT_PSN_USER(`OUID`); 

ALTER TABLE DT_RES_MODEL_MESH_TRACK ADD CONSTRAINT DT_RES_MOD_MSH_TCK_FK_PRJ 
      FOREIGN KEY (`PROJECT_ID`) REFERENCES DT_SOL_PROJECT(`OUID`); 

ALTER TABLE DT_RES_MODEL_MESH_TRACK ADD CONSTRAINT DT_RES_MOD_MSH_TCK_FK_MOD 
      FOREIGN KEY (`MODEL_ID`) REFERENCES DT_RES_MODEL(`OUID`); 

ALTER TABLE DT_RES_MODEL_MESH_TRACK ADD CONSTRAINT DT_RES_MOD_MSH_TCK_FK_MSH 
      FOREIGN KEY (`MESH_ID`) REFERENCES DT_RES_MODEL_MESH(`OUID`); 
