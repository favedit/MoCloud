...
public class RBaseLong
{
   ...
   // @return 是否相等
   //============================================================
   public final static boolean equals(long[] source,
                                      long[] target){
      // 内容都为空
   ...
   // @return 是否含有
   //============================================================
   public final static boolean contains(long[] values,
                                        long find){
      if(values != null){
   ...
   // @return 比较结果
   //============================================================
   public final static int compare(long[] source,
                                   long[] target){
   ...
   // @return 索引位置
   //============================================================
   public final static int indexOf(long[] values,
                                   long find){
      if(values != null){
         int loop = values.length;
         for(int n = 0; n < loop; n++){
   ...
   // @return 索引位置
   //============================================================
   public final static int search(long[] source,
                                  long[] target){
   ...
   // @param value 长整数内容
   //============================================================
   public final static void fill(long[] source,
                                 long value){
   ...
   // @param to 被替换字符数组
   //============================================================
   public final static void replace(long[] source,
                                    long from,
                                    long to){
   ...
   // @return 替换后的字符数组
   //============================================================
   public final static long[] replace(long[] source,
                                      int offset,
                                      int length,
                                      long[] from,
                                      long[] to){
   ...
   // @return 中间数组
   //============================================================
   public final static long[] sub(long[] source,
                                  int offset,
                                  int length){
      long[] result = null;
      if(length > 0){
   ...
   // @return 中间数组
   //============================================================
   public static long[] mid(long[] source,
                            int start,
                            int end){
   ...
   // @param length 索引长度
   //============================================================
   public final static int erase(long[] values,
                                 int index,
                                 int length){
      if(values != null){
   ...
   // @param find 长整数内容
   //============================================================
   public final static int remove(long[] values,
                                  int offset,
                                  int length,
                                  long find){
      int index = offset;
   ...
   // @param targetLength 目标长度
   //============================================================
   public final static int remove(long[] source,
                                  int sourceOffset,
                                  int sourceLength,
                                  long[] target,
                                  int targetOffset,
