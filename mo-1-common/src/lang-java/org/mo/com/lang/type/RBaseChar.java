...
public class RBaseChar
{
   ...
   // @return 是否相等
   //============================================================
   public final static boolean equals(char[] source,
                                      char[] target){
      // 内容都为空
   ...
   // @return 比较结果
   //============================================================
   public final static int compare(char[] source,
                                   char[] target){
   ...
   // @return 索引位置
   //============================================================
   public final static int search(char[] source,
                                  char[] target){
   ...
   // @param value 字符内容
   //============================================================
   public final static void fill(char[] source,
                                 char value){
   ...
   // @param to 被替换字符数组
   //============================================================
   public final static void replace(char[] source,
                                    char from,
                                    char to){
   ...
   // @return 替换后的字符数组
   //============================================================
   public final static char[] replace(char[] source,
                                      int offset,
                                      int length,
                                      char[] from,
                                      char[] to){
   ...
   // @return 中间数组
   //============================================================
   public final static char[] sub(char[] source,
                                  int offset,
                                  int length){
      char[] result = null;
      if(length > 0){
   ...
   // @return 中间数组
   //============================================================
   public static char[] mid(char[] source,
                            int start,
                            int end){
   ...
   // @param find 字符内容
   //============================================================
   public final static int remove(char[] values,
                                  int offset,
                                  int length,
                                  char find){
      int index = offset;
   ...
   // @param targetLength 目标长度
   //============================================================
   public final static int remove(char[] source,
                                  int sourceOffset,
                                  int sourceLength,
                                  char[] target,
                                  int targetOffset,
