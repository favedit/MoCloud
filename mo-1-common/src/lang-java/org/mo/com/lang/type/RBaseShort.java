...
public class RBaseShort
{
   ...
   // @return 是否相等
   //============================================================
   public final static boolean equals(short[] source,
                                      short[] target){
      // 内容都为空
   ...
   // @return 是否含有
   //============================================================
   public final static boolean contains(short[] values,
                                        short find){
      if(values != null){
   ...
   // @return 比较结果
   //============================================================
   public final static int compare(short[] source,
                                   short[] target){
   ...
   // @return 索引位置
   //============================================================
   public final static int indexOf(short[] values,
                                   short find){
      if(values != null){
         int loop = values.length;
         for(int n = 0; n < loop; n++){
   ...
   // @return 索引位置
   //============================================================
   public final static int search(short[] source,
                                  short[] target){
   ...
   // @param value 短整数内容
   //============================================================
   public final static void fill(short[] source,
                                 short value){
   ...
   // @param to 被替换字符数组
   //============================================================
   public final static void replace(short[] source,
                                    short from,
                                    short to){
   ...
   // @return 替换后的字符数组
   //============================================================
   public final static short[] replace(short[] source,
                                       int offset,
                                       int length,
                                       short[] from,
                                       short[] to){
   ...
   // @return 中间数组
   //============================================================
   public final static short[] sub(short[] source,
                                   int offset,
                                   int length){
      short[] result = null;
      if(length > 0){
   ...
   // @return 中间数组
   //============================================================
   public static short[] mid(short[] source,
                             int start,
                             int end){
   ...
   // @param length 索引长度
   //============================================================
   public final static int erase(short[] values,
                                 int index,
                                 int length){
      if(values != null){
   ...
   // @param find 短整数内容
   //============================================================
   public final static int remove(short[] values,
                                  int offset,
                                  int length,
                                  short find){
      int index = offset;
   ...
   // @param targetLength 目标长度
   //============================================================
   public final static int remove(short[] source,
                                  int sourceOffset,
                                  int sourceLength,
                                  short[] target,
                                  int targetOffset,
