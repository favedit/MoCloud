...
import org.mo.cloud.editor.common.source.FEditorSource;
import org.mo.cloud.editor.common.source.REditorCsSource;
import org.mo.cloud.editor.common.source.REditorJavaSource;
import org.mo.cloud.editor.core.entity.common.XEntity;
import org.mo.cloud.editor.core.entity.common.XEntityGroup;
import org.mo.cloud.editor.core.entity.common.XEntityItem;
import org.mo.cloud.editor.core.entity.common.XStruct;
import org.mo.cloud.editor.core.enums.IEnumConsole;
   ...
   public FXmlNode buildConfig(IXmlObject xgroup,
      ...
      for(FXmlNode xentity : config.allNodes("Entity")){
         ...
         for(FXmlNode xitem : xentity.allNodes("Item")){
            ...
            String typeCd = xitem.get("type");
            String typeName = xitem.get("type_name", null);
            // 设置Java属性
            xitem.set("data_type_java", REditorJavaSource.convertDataType(typeCd, typeName));
            // 设置属性
         ...
         if("Enum".equals(typeCd)){
            ...
            if(!RString.isEmpty(typeName)){
               ...
               if(null != xenum){
                  ...
                  try{
                     node.set("data_type_java", REditorJavaSource.convertDataType(dataTypeCd, typeName));
                  }catch(Exception e){
                     throw new FFatalError(e, "Build enum type error. (type_name={1}), node={2}", typeName, node.xml());
                  }
               }
