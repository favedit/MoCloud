...
import org.mo.cloud.editor.core.dataset.common.XFieldFace;
...
//============================================================
// <T>双精度浮点数字段对象的XML节点基类。</T>
//============================================================
public abstract class XBaseFieldDouble
      extends FXmlObject
      implements
         XFieldFace
{
   // 名称定义
   public static final String NAME = "FieldDouble";
