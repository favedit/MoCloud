...
<ToolBar width='100%' align='right'>
	<ToolButtonText name='btnForm' label='消息列表' icon='sys.pst.mgr' target='frmMain' page='#/editor/module/Module.wa?do=list&amp;form_name=cloud.editor.module.GroupList'/>
	<ToolButton name='btnRefresh' icon='tool.refresh' action='refreshNode()'/>
</ToolBar>
</XML>
<!-- TreeView config ----------------------------------------->
<jc:tree name='xTree' source='cloud.editor.module'/>
<!-- Body begin ---------------------------------------------->
