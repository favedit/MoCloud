...
<SCRIPT>
   ...
   function onLoadScript() {
      ...
      MO.Console.find(MO.FEnvironmentConsole).registerValue(MO.EEaiVerificationMode.Token, false);
      MO.Console.find(MO.FEnvironmentConsole).registerValue('zmjr.get.time', 'http://182.92.6.158:8089/zm_external/wisdom/get/currentDate');
      MO.Console.find(MO.FEnvironmentConsole).registerValue('zmjr.get.live', 'http://182.92.6.158:8089/zm_external/wisdom/get/currentInvest?');
      MO.Console.find(MO.FEnvironmentConsole).registerValue('zmjr.get.24h', 'http://182.92.6.158:8089/zm_external/wisdom/get/24hoursInvest?');
      // 设置应用
      var application = MO.Desktop.initialize(MO.FEaiChartApplication);
      application.setSceneCode(MO.EEaiScene.ChartSesameFinancial);
