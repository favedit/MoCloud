      ...
      extends XContentObject
{
   ...
   // 配置图片的定义
   @AContentField
   public final static FContentField ICON_OPTION = new FContentField("iconOption", "icon_option", EContentData.String, "", "", "", "YYNY");
   ...
   // @param value 配置图片
   //============================================================
   public void setIconOption(String value){
      _iconOption = value;
   }
