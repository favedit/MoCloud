...
// @author autosource
//============================================================
public abstract class XBaseFrameSet extends XContentObject
{
   // 类名称
   public static final String CONTENT_NAME = "FrameSet";
   ...
   // 方向类型的定义
   @AContentField
   public final static FContentField DIRECTION_CD = new FContentField("directionCd", "direction_cd", EContentData.String, "", "", "", "YYNY");
   ...
   // @param value 方向类型
   //============================================================
   public void setDirectionCd(String value){
      _directionCd = value;
   }
