...
{
   // 类名称
   public static final String CONTENT_NAME = "DataStore";
   ...
   // 父名称的定义
   @AContentField
   public final static FContentField PARENT_NAME = new FContentField("parentName", "parent_name", EContentData.String, "", "", "", "YYY");

   // 排序方法的定义
   @AContentField
   public final static FContentField DATASET_ORDER = new FContentField("datasetOrder", "dataset_order", EContentData.String, "", "", "", "YYY");

   // 数据类型的定义
   @AContentField
   public final static FContentField DATA_TYPE = new FContentField("dataType", "data_type", EContentData.String, "", "", "", "YYN");
