...
// <T>资源显示对象。</T>
//============================================================
public class FResTemplateRenderable
      extends FResDisplay
{
   // 类型名称
   ...
   // 网格集合
   protected FObjects<FResMaterial> _materials = new FObjects<FResMaterial>(FResMaterial.class);

   //============================================================
   // <T>构造资源模型。</T>
   //============================================================
   public FResTemplateRenderable(){
   }
