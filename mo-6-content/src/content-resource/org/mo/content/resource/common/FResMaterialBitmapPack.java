...
// <T>资源纹理位图。</T>
//============================================================
public class FResMaterialBitmapPack
      extends FResObject
      implements
         AutoCloseable
{
   ...
   // 资源位图
   protected FResMaterialBitmap _textureBitmap;

   //============================================================
   // <T>构造资源纹理位图。</T>
   //============================================================
   public FResMaterialBitmapPack(){
      makeGuid();
   }
   ...
   // @return 纹理位图
   //============================================================
   public FResMaterialBitmap textureBitmap(){
   ...
   //============================================================
   public void setTextureBitmap(FResMaterialBitmap textureBitmap){
