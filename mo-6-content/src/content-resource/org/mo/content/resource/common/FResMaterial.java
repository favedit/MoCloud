      ...
      extends FResObject
{
   ...
   // 位图集合
   protected FObjects<FResMaterialBitmap> _bitmaps;

   // 资源位图打包集合
   protected FObjects<FResMaterialBitmapPack> _bitmapPacks;
   ...
   // @param code 代码
   //============================================================
   public FResMaterialBitmap findBitmapByCode(String code){
      // 输出纹理位图集合
      if(_bitmaps != null){
         int bitmapCount = _bitmaps.count();
         for(int i = 0; i < bitmapCount; i++){
            FResMaterialBitmap bitmap = _bitmaps.get(i);
   ...
   // @return 位图集合
   //============================================================
   public FObjects<FResMaterialBitmap> bitmaps(){
      return _bitmaps;
   }
   ...
   // @param bitmap 位图
   //============================================================
   public void pushBitmap(FResMaterialBitmap bitmap){
      if(_bitmaps == null){
         _bitmaps = new FObjects<FResMaterialBitmap>(FResMaterialBitmap.class);
      }
   ...
   // @return 资源位图打包集合
   //============================================================
   public FObjects<FResMaterialBitmapPack> bitmapPacks(){
      return _bitmapPacks;
   }
   ...
   // @param bitmap 位图
   //============================================================
   public void pushBitmapPack(FResMaterialBitmapPack bitmapPack){
      if(_bitmapPacks == null){
         _bitmapPacks = new FObjects<FResMaterialBitmapPack>(FResMaterialBitmapPack.class);
      }
   ...
   // @param material 材质
   //============================================================
   public void assignInfo(FResMaterial material){
   ...
   public void serialize(IDataOutput output){
      ...
      if(hasBitmapPack()){
         ...
         for(FResMaterialBitmapPack bitmapPack : _bitmapPacks){
      ...
      if(hasBitmap()){
         ...
         output.writeUint16(count);
         for(FResMaterialBitmap bitmap : _bitmaps){
   ...
   public void pack(){
      ...
      // 合并颜色纹理和透明纹理
      FResMaterialBitmap diffuseBitmap = findBitmapByCode("diffuse");
      FResMaterialBitmap alphaBitmap = findBitmapByCode("alpha");
      if((diffuseBitmap != null) || (alphaBitmap != null)){
         FResMaterialBitmapPack bitmapPack = new FResMaterialBitmapPack();
         if((diffuseBitmap != null) && (alphaBitmap != null)){
      ...
      //............................................................
      // 合并高光强度，反射强度，高度纹理
      FResMaterialBitmap specularLevelBitmap = findBitmapByCode("specular.level");
      FResMaterialBitmap reflectBitmap = findBitmapByCode("reflect");
      FResMaterialBitmap heightBitmap = findBitmapByCode("height");
      ...
      //............................................................
      // 合并光照纹理
      FResMaterialBitmap lightBitmap = findBitmapByCode("light");
      FResMaterialBitmap refractBitmap = findBitmapByCode("refract");
      FResMaterialBitmap emissiveBitmap = findBitmapByCode("emissive");
