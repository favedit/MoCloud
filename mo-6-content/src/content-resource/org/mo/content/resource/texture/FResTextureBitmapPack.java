...
// <T>资源纹理位图。</T>
//============================================================
public class FResTextureBitmapPack
      extends FResObject
      implements
         AutoCloseable
{
   ...
   // 资源位图
   protected FResTextureBitmap _textureBitmap;

   //============================================================
   // <T>构造资源纹理位图。</T>
   //============================================================
   public FResTextureBitmapPack(){
   }
   ...
   // @return 纹理位图
   //============================================================
   public FResTextureBitmap textureBitmap(){
   ...
   //============================================================
   public void setTextureBitmap(FResTextureBitmap textureBitmap){
   ...
   // @param bitmap 位图
   //============================================================
   public void mergeRgb(FResTextureBitmap bitmap){
      mergeRgb(bitmap, 0);
   }
   ...
   // @param bitmap 位图
   //============================================================
   public void mergeAlpha(FResTextureBitmap bitmap){
      mergeAlpha(bitmap, 0);
   }
   ...
   // @param bitmap 位图
   //============================================================
   public void mergeR(FResTextureBitmap bitmap){
      bitmap.setBitmapPack(this);
      //      // 加载图片
      //      try(FImage image = new FImage(bitmap.data())){
      //         int width = image.width();
   ...
   // @param bitmap 位图
   //============================================================
   public void mergeG(FResTextureBitmap bitmap){
      bitmap.setBitmapPack(this);
      //      // 加载图片
      //      try(FImage image = new FImage(bitmap.data())){
      //         int width = image.width();
   ...
   // @param bitmap 位图
   //============================================================
   public void mergeB(FResTextureBitmap bitmap){
      bitmap.setBitmapPack(this);
      //      // 加载图片
      //      try(FImage image = new FImage(bitmap.data())){
      //         int width = image.width();
