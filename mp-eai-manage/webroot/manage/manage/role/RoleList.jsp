      ...
      <script>
         ...
         function roleSubmit(page) {
            ...
            if (page != null) {
               ...
               url = "/manage/role/Role.wa?do=selectDataByPage&date=" + new Date().valueOf();
            }
            $.ajax({
               type: "POST",
               url: url,
         ...
         function del(id) {
            return confirmx('确定将此角色删除?',
               function() {
                  var url = "/manage/role/Role.wa?do=delete&date=" + new Date().valueOf();
                  var data = {
                     "roleId": id
                  };
         ...
         function edit(id) {
            location.href = "/manage/role/Role.wa?do=updatePrepare&id=" + id + "&date=" + new Date().valueOf();
         }
