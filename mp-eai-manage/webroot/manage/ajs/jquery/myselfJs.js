...
function insert_BrowserButton(value, row, index) {
   var edit = "<a href='javascript:void(0)' class='easyui-linkbutton  l-btn l-btn-plain'  plain='true'><span class='l-btn-left' sizset='false' onClick=phoneInfo("+row.ouid+","+row.linkCd+",'"+row.linkUrl+"')><span class='l-btn-text icon-ok l-btn-icon-left'>手机浏览</span></span></a>";
   return edit;
}
...
function insert_browser_editAndDelAndWithdrawButton(value,row,index){
   if(row.statusCd!='2'){
      return "<a href='javascript:void(0)' class='easyui-linkbutton  l-btn l-btn-plain'  plain='true'><span class='l-btn-left' sizset='false' onClick=phoneInfo("+row.ouid+","+row.linkCd+",'"+row.linkUrl+"')><span class='l-btn-text icon-ok l-btn-icon-left'>手机浏览</span></span></a>&nbsp;|&nbsp;"+
      "<a href='javascript:void(0)' class='easyui-linkbutton  l-btn l-btn-plain'  plain='true'><span class='l-btn-left' sizset='false' onClick='edit("+ row.ouid + ")'><aspan class='l-btn-text icon-edit l-btn-icon-left'>编辑</span></span></a>&nbsp;|&nbsp;"+
      ...
      return "<a href='javascript:void(0)' class='easyui-linkbutton  l-btn l-btn-plain'  plain='true'><span class='l-btn-left' sizset='false' onClick='phoneInfo("+row.ouid+")'><span class='l-btn-text icon-ok l-btn-icon-left'>手机浏览</span></span></a>&nbsp;|&nbsp;"+
      "<a href='javascript:void(0)' class='easyui-linkbutton  l-btn l-btn-plain'  plain='true'><span class='l-btn-left' sizset='false' onClick='reBack("+ row.ouid + ")'><span class='l-btn-text icon-undo l-btn-icon-left'>撤回</span></span></a>&nbsp;|&nbsp;"+
