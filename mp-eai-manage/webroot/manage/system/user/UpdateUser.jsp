<%@ include file='/apl/public.inc' %>
   ...
   <HEAD>
      ...
      <script>
         $(function() {
            var url = "/manage/system/user/role/Role.wa?do=selectAll&date=" + new Date().valueOf();
            $.ajax({
               type: "POST",
               url: url,
         ...
         function submitForm() {
            ...
            var url = "/manage/system/user/User.wa?do=update&date=" + new Date().valueOf();
            var data = {
               "id": $('#id').val(),
            ...
            $.ajax({
               ...
               success: function(msg) {
                  ...
                  if (result == '-1') {
                     ...
                     location.href = "/manage/system/user/User.wa";
                  }
               },
               fail: function() {
                  closeProgress();
      ...
      <div id="cy_right" style="width:100%">
         ...
         <div class="btn_bar">
            <div class="nav_btn">
               ...
               <a href="/manage/system/user/User.wa" class="back_btn"></a>
            </div>
         ...
         <table width="648" border="0" style="text-align:center; margin-left:10px; margin-top:10px; margin-bottom:10px">
            <tr>
               ...
               <td align="left" width="572">
                  ...
                  <input id="oa" style="display:none" value="<jh:write source='&basePage.temp'/>" />
               </td>
            </tr>
