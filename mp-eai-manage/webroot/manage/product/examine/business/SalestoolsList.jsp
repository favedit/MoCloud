...
<script>
    ...
    function doSubmit(page, pageSize) {
        progress();
        var url = "/manage/product/examine/business/Salestools.wa?do=select&date="
                + new Date().valueOf();
        var data = null;
        var label = $.trim($('#label').val()).replaceAll("'", "");
        if (label == "资讯标题") label = null;
        if (page != null) {
            url = "/manage/product/examine/business/Salestools.wa?do=select&page="
    ...
    function phoneInfo(ouid){
        window.showModalDialog("/manage/product/examine/business/Salestools.wa?do=getDescription&ouid="+ouid,null,"dialogWidth=360px;dialogHeight=640px");
    }
    function checkTask(flag){
        ...
        if(rows.length != 0){
           ...
           location.href= "/manage/product/examine/business/Salestools.wa?do=checking&newsIds="+ss+"&flag="+flag;
        }
  }
</script>
</HEAD>
     ...
     <div class="nav_btn">
      ...
      <div class="nav_search">
         <input id="label" name="label" type="text"
           onfocus="if(this.value=='标题'){this.value='';}this.style.color='#000000';"
           onblur="if(this.value=='') {this.value='标题';this.style.color='#ccc';}"
           style="color: #ccc" value="标题"> <a onClick="doSubmit(0)"
