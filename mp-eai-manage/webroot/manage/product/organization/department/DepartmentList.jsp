...
<script>
   ...
   function doSubmit(page, pageSize) {
       progress();
       var url = "/manage/product/organization/department/Department.wa?do=select&date="
               + new Date().valueOf();
       var data = null;
       ...
       if (label == "中文名称")
          label = null;
       if (page != null) {
           url = "/manage/product/organization/department/Department.wa?do=select&page="
   ...
   function edit(id) {
       console.info(id);
       window.location.href = "/manage/product/organization/department/Department.wa?do=updateBefore&id="
               + id + "&date=" + new Date().valueOf();
   }
  //搜索按钮，enter键
...
<body>
 <div id="cy_right" style="width: 100%">
  ...
  <div class="btn_bar">
   <div class="nav_btn">
    <a href="/manage/product/organization/department/Department.wa?do=insertBefore"
     class="add_btn"></a>
   </div>
  ...
  <thead>
   <tr>
    <th data-options="field:'ouid',halign:'center',align:'right'"
     ...
     <th
     data-options="field:'validCdStr',halign:'center',align:'left',sortable:true"
     width="60px">是否有效</th>
     <th
     data-options="field:'parentLable',halign:'center',align:'left',sortable:true"
     width="90px">父级部门名称</th>
    <th
     data-options="field:'pathLabels',halign:'center',align:'left',sortable:true"
     width="280px">祖父级部门名称</th>
    <th
     data-options="field:'userCount',halign:'center',align:'left',sortable:true"
     width="50px">总人数</th>
    <th
     data-options="field:'description',halign:'center',align:'left',sortable:true"
     width="280px">描述</th>
    <th
     data-options="field:'buildDate',halign:'center',align:'left',sortable:true"
     width="140px">成立时间</th>
