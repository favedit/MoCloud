...
//                     }
//                  });
               location.href = "/product/financial/department/Department.wa?do=delete&id=" + id + "&date=" + new Date().valueOf();
               });
         }
         ...
         function edit(id){
         console.info(id);
         window.location.href="/product/financial/department/Department.wa?do=updateBefore&id=" + id + "&date=" + new Date().valueOf();
   ...
   <body>
      <div id="cy_right" style="width:100%">
         ...
         <div class="btn_bar">
            <div class="nav_btn">
               <a href="/product/financial/department/Department.wa?do=insertBefore" class="add_btn"></a>
            </div>
