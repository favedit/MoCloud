      ...
      <table id="config" class="easyui-datagrid" fit='true' style="align:true" data-options="toolbar:'#cy_right',pagination:true,collapsible:true,singleSelect:true,remoteSort:false,multiSort:false,striped: true">
         <thead>
            <tr>
               ...
               <th data-options="field:'ovld',halign:'center',align:'right'" width="60px">是否删除</th>
               ...
               <th data-options="field:'label',halign:'center',align:'left',sortable:true" width="100px">标签</th>
               ...
               <th data-options="field:'level',halign:'center',align:'right'" width="100px">级别</th>
               <th data-options="field:'leaderId',halign:'center',align:'right'" width="100px">负责人编号</th>
               <th data-options="field:'leaderLabel',halign:'center',align:'right'" width="100px">负责人标签</th>
               ...
               <th data-options="field:'provinceLabel',halign:'center',align:'right'" width="100px">省份标签</th>
               <th data-options="field:'cityId',halign:'center',align:'right'" width="100px">城市编号</th>
               <th data-options="field:'cityLabel',halign:'center',align:'right'" width="100px">城市标签</th>
               <th data-options="field:'locationLatitude',halign:'center',align:'right'" width="100px">位置维度</th>
               <th data-options="field:'locationLongitude',halign:'center',align:'right'" width="100px">位置经度</th>
               <th data-options="field:'detailAddress',halign:'center',align:'left',sortable:true" width="180px">详细地址</th>
               <th data-options="field:'departmentPhone',halign:'center',align:'left',sortable:true" width="180px">部门电话</th>
               <th data-options="field:'investmentTotal',halign:'center',align:'left',sortable:true" width="100px">投资总额</th>
               <th data-options="field:'investmentCount',halign:'center',align:'left',sortable:true" width="100px">投资次数</th>
               <th data-options="field:'investmentDate',halign:'center',align:'left',sortable:true" width="100px">投资时间</th>
               <th data-options="field:'redemptionTotal',halign:'center',align:'left',sortable:true" width="100px">赎回总额</th>
               <th data-options="field:'redemptionCount',halign:'center',align:'left',sortable:true" width="100px">赎回次数</th>
               <th data-options="field:'redemptionDate',halign:'center',align:'left',sortable:true" width="100px">赎回时间</th>
