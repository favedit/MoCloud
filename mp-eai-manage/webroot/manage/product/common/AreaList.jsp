...
<script>
    ...
    function doSubmit(page, pageSize) {
        progress();
        var url = "/product/common/Area.wa?do=select&date="
                + new Date().valueOf();
        var data = null;
        if (page != null) {
            url = "/product/common/Area.wa?do=select&page=" + page + "&date="
                    + new Date().valueOf();
            data = {
                "page" : page,
                "pageSize" : pageSize
    ...
    function del(id) {
        return confirmx('确定删除?', function() {
            ...
            //                     }
            //                  });
            location.href = "/product/common/Area.wa?do=delete&id=" + id
    ...
    function edit(id) {
        console.info(id);
        window.location.href = "/product/common/Area.wa?do=updateBefore&id="
...
<body>
 <div id="cy_right" style="width: 100%">
  ...
  <div class="btn_bar">
   <div class="nav_btn">
    <a href="/product/common/Area.wa?do=insertBefore"
     class="add_btn"></a>
   </div>
