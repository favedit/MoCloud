 ...
 <div class="easyui-panel" fit='true' data-options="border:false">
  <form id="logicNews" enctype=multipart/form-data
   ...
   <table width="870" height="646" border="0" align="left"
    ...
    <tr>
      <td width="84" height="38"><div align="left" style="width:84px;">资&nbsp;&nbsp;讯&nbsp;&nbsp;标&nbsp;&nbsp;题:</div></td>
    ...
    <tr>
     <td width="84" height="38"><div align="left">是&nbsp;&nbsp;否&nbsp;&nbsp;展&nbsp;&nbsp;示:</div></td>
    ...
    <tr>
     <td width="84" height="38"><div align="left">外&nbsp;&nbsp;链&nbsp;&nbsp;状&nbsp;&nbsp;态:</div></td>
     <td><div align="left">
    ...
    <tr>
      <td width="84" height="38" width="74"><div align="left">排&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;序:</div></td>
    ...
    <tr>
      <td width="84" height="38"><div align="left">关&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;键&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;字:</div></td>
    ...
    <tr>
     <td width="84" height="38"><div align="left">外&nbsp;&nbsp;链&nbsp;&nbsp;地&nbsp;&nbsp;址:</div></td>
     <td><div align="left">
    ...
    <tr>
     <td width="84"><div align="left">资&nbsp;&nbsp;讯&nbsp;&nbsp;内&nbsp;&nbsp;容:</div></td>
