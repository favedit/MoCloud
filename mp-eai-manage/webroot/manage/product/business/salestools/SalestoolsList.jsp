...
<script>
    ...
    function phoneInfo(ouid,linkCd,linkUrl){
       ...
       if(linkCd==2){
          ...
          window.open('/manage/product/business/salestools/Salestools.wa?do=getDescription&ouid='+ouid,'_blank','height=640px,width=360px,top='+t+',left='+l+',toolbar=no,menubar=no,scrollbars=no, resizable=no,location=no, status=no');
       }
    }
    //搜索按钮，enter键
...
<div id="manage_id" style="width:100%;height:100%;">
 <div id="cy_right" style="width: 100%">
  ...
  <div id="add_id">
    <a href="/manage/product/business/salestools/Salestools.wa?do=insertBefore" class="add_btn"></a>
  </div>
  <div id="cond_id">
    <span>状态:</span>
