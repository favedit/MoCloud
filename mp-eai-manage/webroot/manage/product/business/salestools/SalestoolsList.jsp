...
<script>
    ...
    function phoneInfo(ouid){
       ...
       window.open('/manage/product/business/salestools/Salestools.wa?do=getDescription&ouid='+ouid,'_blank','height='+h+',width='+w+',top='+t+',left='+l+',toolbar=no,menubar=no,scrollbars=no, resizable=no,location=no, status=no');
    }
   //搜索按钮，enter键
