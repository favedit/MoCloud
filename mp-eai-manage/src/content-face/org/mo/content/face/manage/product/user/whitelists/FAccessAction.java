...
import org.mo.content.core.manage.product.user.whitelists.IAccessConsole;
         ...
         IAccessAction 
{
   ...
   public String construct(IWebContext context, 
      ...
      return "/manage/product/user/whitelists/AccessList";
   }
   ...
   public String select(IWebContext context, 
      ...
      unit.setHostAddress(context.parameter("hostAddress"));
      String StrPageSize = context.parameter("pageSize");
      int pageSize = 20;
      if (null != StrPageSize) {
         pageSize = Integer.parseInt(StrPageSize);
      }
      FLogicDataset<FDataPersonAccessAuthorityUnit> unitlist = _accessConsole.select(logicContext, unit, page.pageCurrent() - 1, pageSize);
   ...
   public String delete(IWebContext context, 
      ...
      page.setResult("/manage/product/user/whitelists/Access.wa");
      return "/manage/product/user/whitelists/Success";
   }
   ...
   public String insertBefore(IWebContext context, 
      ...
      return "/manage/product/user/whitelists/InsertUser";
   }
   ...
   public String insert(IWebContext context, 
      ...
      if (password.indexOf("'") > -1 || password.indexOf("%") > -1 || password.indexOf(";") > -1) {
         ...
         return "/manage/product/user/whitelists/Failure";
      }
      if (!host.isEmpty()) {
   ...
   public String updateBefore(IWebContext context, 
      ...
      page.setUnit(unit);
      return "/manage/product/user/whitelists/UpdateUser";
   }

   @Override
   public String update(IWebContext context, ILogicContext logicContext, FAccessPage page, FBasePage basePage) {
      if (!basePage.userExists()) {
         return "/manage/common/ConnectTimeout";
      }
      String host = context.parameter("host_address").replaceAll(" ", "");
