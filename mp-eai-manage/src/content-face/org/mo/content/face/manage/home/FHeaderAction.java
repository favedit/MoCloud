   ...
   private void tackAuthority(IWebContext context, ILogicContext logicContext, FBasePage basePage) {
      ...
      if (roleCd == EGcPersonUserRole.Admin) {
         menuStrings
               ...
               .append("manage.product.common.configration.rule|manage.product.examine.news|product.system.application|product.system.version|product.financial.marketer|product.device|product.user.logger|product.user.writelists");
