...
public interface INewsAction {
   ...
   // @return 页面
   // ============================================================
   String getDescription(IWebContext context, ILogicContext logicContext, @AContainer(name = "page") FNewsPage page, @AContainer(name = "basePage") FBasePage basePage);
   ...
   // @return 页面
   // ============================================================
   String checking(IWebContext context, ILogicContext logicContext, @AContainer(name = "page") FNewsPage page, @AContainer(name = "basePage") FBasePage basePage);
