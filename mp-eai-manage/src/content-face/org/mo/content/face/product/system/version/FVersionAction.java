...
public class FVersionAction 
   ...
   public String select(IWebContext context, ILogicContext logicContext, FVersionPage page, FBasePage basePage) {
      ...
      for(Iterator<FDataVersionInfo> iter = unitList.iterator();iter.hasNext();){
         FDataVersionInfo info = iter.next();
         info.setApplicationLabel(info.application().label());
         setInfoVersionLabel(info);
      }
   ...
   //============================================================
   @Override
   public String insertBefore(IWebContext context, ILogicContext logicContext, FVersionPage page,
         FBasePage basePage) {
   ...
   //============================================================
   @Override
   public String updateBefore(IWebContext context, ILogicContext logicContext, FVersionPage page,
         FBasePage basePage) {
   ...
   public void setLogicVersion(IWebContext context, ILogicContext logicContext,FDataSystemVersionUnit unit){
      ...
      FDataSystemApplicationUnit unita = _applicationConsole.findByLable(logicContext, context.parameter("applicationLabel"));
      if(null != unita){
         unit.setApplicationId(unita.ouid());
      }
