...
import org.mo.content.core.product.configration.FDataRuleInfo;
import org.mo.content.core.product.configration.IRuleConsole;
...
// 配置控制台
   ...
   public String updateBefore(IWebContext context, ILogicContext logicContext, FRulePage page, FBasePage basePage) {
      ...
      return "/manage/product/configration/UpdateRule";
   }
