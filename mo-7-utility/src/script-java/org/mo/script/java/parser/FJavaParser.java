...
import org.mo.script.java.common.FJavaTextContextL1;
      ...
      extends FObject
{
   ...
   public void parseFile(String fileName){
      ...
      parser.setContext(new FJavaTextContextL1());
   ...
   public static void main(String[] args){
      // 打开文件
      String fileName = "E:/GameCollege/platform/mo-5-cloud/src/cloud-logic/com/cyou/gccloud/logic/system/IGcSessionConsole.java";
      FStringFile file = new FStringFile(fileName);
      FTextParser parser = new FTextParser();
      parser.setContext(new FJavaTextContextL1());
      parser.parse(file.toString());
