...
// <T>用户登出应答消息。</T>
//============================================================
public class FRsaUserLogoutResponse
      extends FNetMessage
      implements
         INetObject
{
   // 名称
   public final static String NAME = "RsaUserLogoutResponse";

   // 类型
   public final static int TYPE = ENetMessageType.Response;

   // 代码
   public final static int CODE = ENetMessageGroup.ResourceApplication + 0x000A;
   ...
   // @return 实例对象
   //============================================================
   public FRsaUserLogoutResponse(FXmlNode xconfig){
      this();
      loadConfig(xconfig);
   }
