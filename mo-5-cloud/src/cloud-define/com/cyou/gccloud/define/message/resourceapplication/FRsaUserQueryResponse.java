...
// <T>用户查询应答消息。</T>
//============================================================
public class FRsaUserQueryResponse
      extends FNetMessage
      implements
         INetObject
{
   // 名称
   public final static String NAME = "RsaUserQueryResponse";

   // 类型
   public final static int TYPE = ENetMessageType.Response;

   // 代码
   public final static int CODE = ENetMessageGroup.ResourceApplication + 0x0006;
   ...
   // @return 实例对象
   //============================================================
   public FRsaUserQueryResponse(FXmlNode xconfig){
      this();
      loadConfig(xconfig);
   }
