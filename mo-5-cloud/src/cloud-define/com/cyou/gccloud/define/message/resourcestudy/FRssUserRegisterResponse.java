...
// <T>用户注册应答消息。</T>
//============================================================
public class FRssUserRegisterResponse
      extends FNetMessage
      implements
         INetObject
{
   // 名称
   public final static String NAME = "RssUserRegisterResponse";

   // 类型
   public final static int TYPE = ENetMessageType.Response;

   // 代码
   public final static int CODE = ENetMessageGroup.ResourceStudy + 0x0002;
   ...
   // @return 实例对象
   //============================================================
   public FRssUserRegisterResponse(){
      _head.name = NAME;
      _head.type = TYPE;
      _head.code = CODE;
   ...
   // @return 实例对象
   //============================================================
   public FRssUserRegisterResponse(FXmlNode xconfig){
      this();
      loadConfig(xconfig);
   }
