...
// <T>用户查询应答消息。</T>
//============================================================
public class FRssUserQueryResponse
      extends FNetMessage
      implements
         INetObject
{
   // 名称
   public final static String NAME = "RssUserQueryResponse";

   // 类型
   public final static int TYPE = ENetMessageType.Response;

   // 代码
   public final static int CODE = ENetMessageGroup.ResourceStudy + 0x0006;
   ...
   // @return 实例对象
   //============================================================
   public FRssUserQueryResponse(FXmlNode xconfig){
      this();
      loadConfig(xconfig);
   }
