...
// <T>用户更新请求消息。</T>
//============================================================
public class FRssUserUpdateRequest
      extends FNetMessage
      implements
         INetObject
{
   // 名称
   public final static String NAME = "RssUserUpdateRequest";

   // 类型
   public final static int TYPE = ENetMessageType.Request;

   // 代码
   public final static int CODE = ENetMessageGroup.ResourceStudy + 0x0007;
   ...
   // @return 实例对象
   //============================================================
   public FRssUserUpdateRequest(FXmlNode xconfig){
      this();
      loadConfig(xconfig);
   }
