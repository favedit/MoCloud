...
// <T>用户更新应答消息。</T>
//============================================================
public class FRssUserUpdateResponse
      extends FNetMessage
      implements
         INetObject
{
   // 名称
   public final static String NAME = "RssUserUpdateResponse";

   // 类型
   public final static int TYPE = ENetMessageType.Response;

   // 代码
   public final static int CODE = ENetMessageGroup.ResourceStudy + 0x0008;
   ...
   // @return 实例对象
   //============================================================
   public FRssUserUpdateResponse(FXmlNode xconfig){
      this();
      loadConfig(xconfig);
   }
