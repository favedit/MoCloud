...
// <T>用户查询应答消息。</T>
//============================================================
public class FPsuUserQueryResponse
      extends FNetMessage
      implements
         INetObject
{
   // 名称
   public final static String NAME = "PsuUserQueryResponse";

   // 类型
   public final static int TYPE = ENetMessageType.Response;

   // 代码
   public final static int CODE = ENetMessageGroup.PersonUser + 0x0006;
   ...
   // @return 实例对象
   //============================================================
   public FPsuUserQueryResponse(FXmlNode xconfig){
      this();
      loadConfig(xconfig);
   }
