...
// <T>用户注册请求消息。</T>
//============================================================
public class FRssUserRegisterRequest
      extends FNetMessage
      implements
         INetObject
{
   // 名称
   public final static String NAME = "RssUserRegisterRequest";

   // 类型
   public final static int TYPE = ENetMessageType.Request;

   // 代码
   public final static int CODE = ENetMessageGroup.ResourceStudy + 0x0001;
   ...
   // @return 实例对象
   //============================================================
   public FRssUserRegisterRequest(){
      _head.name = NAME;
      _head.type = TYPE;
      _head.code = CODE;
   ...
   // @return 实例对象
   //============================================================
   public FRssUserRegisterRequest(FXmlNode xconfig){
      this();
      loadConfig(xconfig);
   }
