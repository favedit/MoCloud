...
// <T>用户登录应答消息。</T>
//============================================================
public class FPsuUserLoginResponse
      extends FNetMessage
      implements
         INetObject
{
   // 名称
   public final static String NAME = "PsuUserLoginResponse";

   // 类型
   public final static int TYPE = ENetMessageType.Response;

   // 代码
   public final static int CODE = ENetMessageGroup.PersonUser + 0x0004;
            ...
            INetObject
   {
      ...
      // @return 个数
      //============================================================
      public int occupationCd(){
         return _occupationCd;
      }
      ...
      // @return 对象
      //============================================================
      public void setOccupationCd(int value){
         _occupationCd = value;
      }
      ...
      public void loadConfig(FXmlNode xconfig){
         ...
         _occupationCd = xconfig.getInt("occupation_cd");
      }
      ...
      public void saveConfig(FXmlNode xconfig){
         ...
         xconfig.set("occupation_cd", _occupationCd);
      }
   ...
   // @return 实例对象
   //============================================================
   public FPsuUserLoginResponse(FXmlNode xconfig){
      this();
      loadConfig(xconfig);
   }
