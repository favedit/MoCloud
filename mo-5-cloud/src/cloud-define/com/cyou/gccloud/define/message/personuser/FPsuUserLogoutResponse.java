...
// <T>用户登出应答消息。</T>
//============================================================
public class FPsuUserLogoutResponse
      extends FNetMessage
      implements
         INetObject
{
   // 名称
   public final static String NAME = "PsuUserLogoutResponse";

   // 类型
   public final static int TYPE = ENetMessageType.Response;

   // 代码
   public final static int CODE = ENetMessageGroup.PersonUser + 0x000A;
   ...
   // @return 实例对象
   //============================================================
   public FPsuUserLogoutResponse(FXmlNode xconfig){
      this();
      loadConfig(xconfig);
   }
