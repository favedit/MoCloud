...
// <T>运行信息请求消息。</T>
//============================================================
public class FSyuRuntimeInfoRequest
      extends FNetMessage
      implements
         INetObject
{
   // 名称
   public final static String NAME = "SyuRuntimeInfoRequest";

   // 类型
   public final static int TYPE = ENetMessageType.Request;

   // 代码
   public final static int CODE = ENetMessageGroup.SystemUtility + 0x0001;
   ...
   // @return 实例对象
   //============================================================
   public FSyuRuntimeInfoRequest(FXmlNode xconfig){
      this();
      loadConfig(xconfig);
   }
