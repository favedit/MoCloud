...
// <T>用户登出应答消息。</T>
//============================================================
public class FRssUserLogoutResponse
      extends FNetMessage
      implements
         INetObject
{
   // 名称
   public final static String NAME = "RssUserLogoutResponse";

   // 类型
   public final static int TYPE = ENetMessageType.Response;

   // 代码
   public final static int CODE = ENetMessageGroup.ResourceStudy + 0x000A;
   ...
   // @return 实例对象
   //============================================================
   public FRssUserLogoutResponse(FXmlNode xconfig){
      this();
      loadConfig(xconfig);
   }
