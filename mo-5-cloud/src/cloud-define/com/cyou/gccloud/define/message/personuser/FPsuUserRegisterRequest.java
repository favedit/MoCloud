...
// <T>用户注册请求消息。</T>
//============================================================
public class FPsuUserRegisterRequest
      extends FNetMessage
      implements
         INetObject
{
   // 名称
   public final static String NAME = "PsuUserRegisterRequest";

   // 类型
   public final static int TYPE = ENetMessageType.Request;

   // 代码
   public final static int CODE = ENetMessageGroup.PersonUser + 0x0001;

   // 版本
   public final static int VERSION = 0x00E3C204;

   // 链接代码
   protected String _connectCode;
   ...
   // @return 实例对象
   //============================================================
   public FPsuUserRegisterRequest(){
      _head.name = NAME;
      _head.type = TYPE;
      _head.code = CODE;
   ...
   // @return 实例对象
   //============================================================
   public FPsuUserRegisterRequest(FXmlNode xconfig){
      this();
      loadConfig(xconfig);
   }
   ...
   public void loadConfig(FXmlNode xconfig){
      _connectCode = xconfig.nodeText("ConnectCode");
   ...
   public void saveConfig(FXmlNode xconfig){
      xconfig.createNode("connect_code").setText(_connectCode);
