...
// <T>用户登出请求消息。</T>
//============================================================
public class FRssUserLogoutRequest
      extends FNetMessage
      implements
         INetObject
{
   // 名称
   public final static String NAME = "RssUserLogoutRequest";

   // 类型
   public final static int TYPE = ENetMessageType.Request;

   // 代码
   public final static int CODE = ENetMessageGroup.ResourceStudy + 0x0009;
   ...
   // @return 实例对象
   //============================================================
   public FRssUserLogoutRequest(FXmlNode xconfig){
      this();
      loadConfig(xconfig);
   }
