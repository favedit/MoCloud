...
// <T>用户登出请求消息。</T>
//============================================================
public class FPsuUserLogoutRequest
      extends FNetMessage
      implements
         INetObject
{
   // 名称
   public final static String NAME = "PsuUserLogoutRequest";

   // 类型
   public final static int TYPE = ENetMessageType.Request;

   // 代码
   public final static int CODE = ENetMessageGroup.PersonUser + 0x0009;
   ...
   // @return 实例对象
   //============================================================
   public FPsuUserLogoutRequest(FXmlNode xconfig){
      this();
      loadConfig(xconfig);
   }
