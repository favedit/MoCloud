...
// <T>用户登录应答消息。</T>
//============================================================
public class FRssUserLoginResponse
      extends FNetMessage
      implements
         INetObject
{
   // 名称
   public final static String NAME = "RssUserLoginResponse";

   // 类型
   public final static int TYPE = ENetMessageType.Response;

   // 代码
   public final static int CODE = ENetMessageGroup.ResourceStudy + 0x0004;
   ...
   // @return 实例对象
   //============================================================
   public FRssUserLoginResponse(FXmlNode xconfig){
      this();
      loadConfig(xconfig);
   }
