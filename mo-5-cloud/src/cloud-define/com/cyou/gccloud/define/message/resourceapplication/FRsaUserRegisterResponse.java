...
// <T>用户注册应答消息。</T>
//============================================================
public class FRsaUserRegisterResponse
      extends FNetMessage
      implements
         INetObject
{
   // 名称
   public final static String NAME = "RsaUserRegisterResponse";

   // 类型
   public final static int TYPE = ENetMessageType.Response;

   // 代码
   public final static int CODE = ENetMessageGroup.ResourceApplication + 0x0002;
   ...
   // @return 实例对象
   //============================================================
   public FRsaUserRegisterResponse(){
      _head.name = NAME;
      _head.type = TYPE;
      _head.code = CODE;
   ...
   // @return 实例对象
   //============================================================
   public FRsaUserRegisterResponse(FXmlNode xconfig){
      this();
      loadConfig(xconfig);
   }
