...
// <T>用户登录请求消息。</T>
//============================================================
public class FRsaUserLoginRequest
      extends FNetMessage
      implements
         INetObject
{
   // 名称
   public final static String NAME = "RsaUserLoginRequest";

   // 类型
   public final static int TYPE = ENetMessageType.Request;

   // 代码
   public final static int CODE = ENetMessageGroup.ResourceApplication + 0x0003;
   ...
   // @return 实例对象
   //============================================================
   public FRsaUserLoginRequest(FXmlNode xconfig){
      this();
      loadConfig(xconfig);
   }
