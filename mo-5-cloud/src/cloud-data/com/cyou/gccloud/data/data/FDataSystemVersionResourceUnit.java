...
//============================================================
@ASourceMachine
public class FDataSystemVersionResourceUnit
      extends FLogicUnit
{
   // 存储字段对象标识的定义。
   private long __ouid;
   ...
   // 存储字段指定下载地址的定义。
   private String __downloadCustomUrl;

   // 字段指定下载地址的定义。
   protected String _downloadCustomUrl;
   ...
   // @return 数据内容
   //============================================================
   public boolean isDownloadCustomUrlChanged(){
      return !RString.equals(__downloadCustomUrl, _downloadCustomUrl);
   }
   ...
   // @return 数据内容
   //============================================================
   public String downloadCustomUrl(){
      return _downloadCustomUrl;
   }
   ...
   // @param value 数据内容
   //============================================================
   public void setDownloadCustomUrl(String value){
      _downloadCustomUrl = value;
   }
      ...
      for(IStringPair pair : row){
         ...
         switch(name){
            ...
            case "download_size":
               ...
               break;
            case "download_custom_url":
               __downloadCustomUrl = value;
               _downloadCustomUrl = __downloadCustomUrl;
               break;
            case "note":
               __note = value;
               _note = __note;
   ...
   public void save(FRow row){
      ...
      row.set("downloadCustomUrl", _downloadCustomUrl);
      row.set("note", _note);
   ...
   public void saveMap(Map<String, String> map){
      ...
      map.put("downloadCustomUrl", _downloadCustomUrl);
      map.put("note", _note);
