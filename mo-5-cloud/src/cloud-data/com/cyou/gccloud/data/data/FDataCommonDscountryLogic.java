...
//============================================================
@ASourceMachine
public class FDataCommonDscountryLogic extends FLogicTable
{
   // 全球的定义。
   public final static SLogicConnectionInfo CONNECTION = new SLogicConnectionInfo("data");

   // 全球的定义。
   public final static SLogicTableInfo TABLE = new SLogicTableInfo("data.common.dscountry", "ds_country");
   ...
   // 字段编号的定义。
   public final static SLogicFieldInfo ID = new SLogicFieldInfo("ID");

   // 字段名称的定义。
   public final static SLogicFieldInfo NAME = new SLogicFieldInfo("NAME");

   // 字段中文名称的定义。
   public final static SLogicFieldInfo ZH_NAME = new SLogicFieldInfo("ZH_NAME");

   // 字段代码的定义。
   public final static SLogicFieldInfo CODE = new SLogicFieldInfo("CODE");

   // 字段国家区号的定义。
   public final static SLogicFieldInfo CODE2 = new SLogicFieldInfo("CODE2");

   // 字段是否显示的定义。
   public final static SLogicFieldInfo IS_SHOW = new SLogicFieldInfo("IS_SHOW");
   ...
   // 字段集合的定义。
   public final static String FIELDS = "`OUID`,`OVLD`,`GUID`,`ID`,`NAME`,`ZH_NAME`,`CODE`,`CODE2`,`IS_SHOW`,`CREATE_USER_ID`,`CREATE_DATE`,`UPDATE_USER_ID`,`UPDATE_DATE`";

   //============================================================
   // <T>构造全球逻辑单元。</T>
   //============================================================
   public FDataCommonDscountryLogic(){
      _name = TABLE.name();
      _classUnit = FDataCommonDscountryUnit.class;
   }
   ...
   // @param context 逻辑环境
   //============================================================
   public FDataCommonDscountryLogic(ILogicContext context){
      super(context);
      _name = TABLE.name();
      _classUnit = FDataCommonDscountryUnit.class;
   }
   ...
   public <T extends FLogicUnit> T find(T unit, Class<T> clazz, long recordId){
      ...
      if(unit == null){
         if(clazz == null){
            unit = (T)(new FDataCommonDscountryUnit());
         }else{
   ...
   // @return 数据单元
   //============================================================
   public FDataCommonDscountryUnit findByGuid(CharSequence guid){
      return findByGuid(null, FDataCommonDscountryUnit.class, guid);
   }
   ...
   // @return 数据单元
   //============================================================
   public FDataCommonDscountryUnit search(CharSequence whereSql){
      return search(null, FDataCommonDscountryUnit.class, whereSql);
   }
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FDataCommonDscountryUnit> fetch(CharSequence whereSql){
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FDataCommonDscountryUnit> fetch(int pageSize, int page){
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FDataCommonDscountryUnit> fetch(CharSequence whereSql, int pageSize, int page){
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FDataCommonDscountryUnit> fetch(CharSequence whereSql, CharSequence orderSql){
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FDataCommonDscountryUnit> fetch(CharSequence whereSql, CharSequence orderSql, int pageSize, int page){
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FDataCommonDscountryUnit> fetch(CharSequence fields, CharSequence whereSql, CharSequence orderSql, int pageSize, int page){
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FDataCommonDscountryUnit> fetch(CharSequence fields, CharSequence whereSql, CharSequence groupSql, CharSequence orderSql, int pageSize, int page){
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FDataCommonDscountryUnit> fetchSql(CharSequence code, CharSequence sql, int pageSize, int page){
   ...
   public <T extends FLogicUnit> FLogicDataset<T> fetchSql(Class<T> clazz, CharSequence code, CharSequence sql, int pageSize, int page){
      ...
      if(clazz == null){
         result = (FLogicDataset<T>)(new FLogicDataset<FDataCommonDscountryUnit>(FDataCommonDscountryUnit.class, _logicContext));
      }else{
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FDataCommonDscountryUnit> fetchAll(){
      // 生成命令
   ...
   // @return 数据单元
   //============================================================
   public FDataCommonDscountryUnit doPrepare(){
      FDataCommonDscountryUnit unit = new FDataCommonDscountryUnit();
      unit.linkLogicContext(_logicContext);
      doPrepare(unit);
      return unit;
   }
   ...
   public EResult doPrepare(FLogicUnit logicUnit){
      FDataCommonDscountryUnit unit = (FDataCommonDscountryUnit)logicUnit;
      unit.setOvld(true);
   ...
   public EResult doInsert(FLogicUnit logicUnit){
      ...
      cmd.append(',');
      String zhName = unit.zhName();
      if(RString.isEmpty(zhName)){
         cmd.append("NULL");
      }else{
         cmd.append('\'');
         cmd.append(RSql.formatValue(zhName));
         cmd.append('\'');
      }
      cmd.append(',');
      ...
      cmd.append(',');
      String code2 = unit.code2();
      if(RString.isEmpty(code2)){
         cmd.append("NULL");
      }else{
         cmd.append('\'');
         cmd.append(RSql.formatValue(code2));
         cmd.append('\'');
      }
      cmd.append(',');
      cmd.append(unit.isShow());
      // 设置更新信息
