...
//============================================================
@ASourceMachine
public class FDataBatchDownloadLogic
      extends FLogicTable
{
   // 后台下载表的定义。
   ...
   // 后台下载表的定义。
   public final static SLogicTableInfo TABLE = new SLogicTableInfo("data.batch.download", "DT_BAT_DOWNLOAD");
   ...
   // 字段存储访问地址的定义。
   public final static SLogicFieldInfo STORAGE_URI = new SLogicFieldInfo("STORAGE_URI");

   // 字段存储文件的定义。
   public final static SLogicFieldInfo STORAGE_FILE = new SLogicFieldInfo("STORAGE_FILE");

   // 字段存储命令的定义。
   public final static SLogicFieldInfo STORAGE_ACTION_CD = new SLogicFieldInfo("STORAGE_ACTION_CD");

   // 字段存储状态的定义。
   public final static SLogicFieldInfo STORAGE_STATUS_CD = new SLogicFieldInfo("STORAGE_STATUS_CD");
   ...
   // 字段集合的定义。
   public final static String FIELDS = "OUID,OVLD,GUID,TYPE_CD,USER_ID,LINK_ID,STATUS_CD,DOWNLOAD_URL,DOWNLOAD_SIZE,STORAGE_URI,STORAGE_FILE,STORAGE_ACTION_CD,STORAGE_STATUS_CD,CREATE_USER_ID,CREATE_DATE,UPDATE_USER_ID,UPDATE_DATE";

   //============================================================
   // <T>构造后台下载表逻辑单元。</T>
   //============================================================
   public FDataBatchDownloadLogic(){
      _name = TABLE.name();
      _classUnit = FDataBatchDownloadUnit.class;
   }
   ...
   // @param context 逻辑环境
   //============================================================
   public FDataBatchDownloadLogic(ILogicContext context){
      super(context);
      _name = TABLE.name();
      _classUnit = FDataBatchDownloadUnit.class;
   }
   ...
   public <T extends FLogicUnit> T find(T unit,
      ...
      if(unit == null){
         if(clazz == null){
            unit = (T)(new FDataBatchDownloadUnit());
         }else{
   ...
   // @return 数据单元
   //============================================================
   public FDataBatchDownloadUnit search(CharSequence whereSql){
      return search(null, FDataBatchDownloadUnit.class, whereSql);
   }
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FDataBatchDownloadUnit> fetch(int pageSize,
                                                      int page){
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FDataBatchDownloadUnit> fetch(CharSequence whereSql,
                                                      int pageSize,
                                                      int page){
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FDataBatchDownloadUnit> fetch(CharSequence fields,
                                                      CharSequence whereSql,
                                                      CharSequence orderSql,
                                                      int pageSize,
                                                      int page){
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FDataBatchDownloadUnit> fetchSql(CharSequence code,
                                                         CharSequence sql,
                                                         int pageSize,
                                                         int page){
   ...
   public <T extends FLogicUnit> FLogicDataset<T> fetchSql(Class<T> clazz,
      ...
      if(clazz == null){
         result = (FLogicDataset<T>)(new FLogicDataset<FDataBatchDownloadUnit>(FDataBatchDownloadUnit.class, _logicContext));
      }else{
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FDataBatchDownloadUnit> fetchAll(){
      // 生成命令
   ...
   // @return 数据单元
   //============================================================
   public FDataBatchDownloadUnit doPrepare(){
      FDataBatchDownloadUnit unit = new FDataBatchDownloadUnit();
      unit.linkLogicContext(_logicContext);
      doPrepare(unit);
      return unit;
   }
   ...
   public EResult doPrepare(FLogicUnit logicUnit){
      FDataBatchDownloadUnit unit = (FDataBatchDownloadUnit)logicUnit;
      unit.setOvld(true);
   ...
   public EResult doInsert(FLogicUnit logicUnit){
      ...
      cmd.append(",`STORAGE_URI`");
      cmd.append(",`STORAGE_FILE`");
      cmd.append(",`STORAGE_ACTION_CD`");
      cmd.append(",`STORAGE_STATUS_CD`");
      ...
      cmd.append(',');
      String storageUri = unit.storageUri();
      if(RString.isEmpty(storageUri)){
         cmd.append("NULL");
      }else{
         cmd.append('\'');
         cmd.append(RSql.formatValue(storageUri));
         cmd.append('\'');
      }
      cmd.append(',');
      ...
      cmd.append(',');
      cmd.append(unit.storageActionCd());
      cmd.append(',');
      cmd.append(unit.storageStatusCd());
      // 设置更新信息
   ...
   public EResult doUpdate(FLogicUnit logicUnit,
      ...
      if(unit.isStorageActionCdChanged()){
         cmd.append(",`STORAGE_ACTION_CD`=");
         cmd.append(unit.storageActionCd());
      }
      if(unit.isStorageStatusCdChanged()){
         cmd.append(",`STORAGE_STATUS_CD`=");
         cmd.append(unit.storageStatusCd());
      }
