...
//============================================================
@ASourceMachine
public class FDataExternalWeixinReplyLogic
      extends FLogicTable
{
   // 微信回复表的定义。
   ...
   // 微信回复表的定义。
   public final static SLogicTableInfo TABLE = new SLogicTableInfo("data.external.weixin.reply", "DT_ENL_WX_REPLY");
   ...
   // 字段回复类型的定义。
   public final static SLogicFieldInfo REPLAY_CD = new SLogicFieldInfo("REPLAY_CD");
   ...
   // 字段集合的定义。
   public final static String FIELDS = "OUID,OVLD,GUID,LABEL,ICON_URL,REPLAY_CD,NEWS_ID,VIEW_COUNT,NOTE,CREATE_USER_ID,CREATE_DATE,UPDATE_USER_ID,UPDATE_DATE";

   //============================================================
   // <T>构造微信回复表逻辑单元。</T>
   //============================================================
   public FDataExternalWeixinReplyLogic(){
      _name = TABLE.name();
      _classUnit = FDataExternalWeixinReplyUnit.class;
   }
   ...
   // @param context 逻辑环境
   //============================================================
   public FDataExternalWeixinReplyLogic(ILogicContext context){
      super(context);
      _name = TABLE.name();
      _classUnit = FDataExternalWeixinReplyUnit.class;
   }
   ...
   public <T extends FLogicUnit> T find(T unit,
      ...
      if(unit == null){
         if(clazz == null){
            unit = (T)(new FDataExternalWeixinReplyUnit());
         }else{
   ...
   // @return 数据单元
   //============================================================
   public FDataExternalWeixinReplyUnit search(CharSequence whereSql){
      return search(null, FDataExternalWeixinReplyUnit.class, whereSql);
   }
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FDataExternalWeixinReplyUnit> fetch(int pageSize,
                                                            int page){
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FDataExternalWeixinReplyUnit> fetch(CharSequence whereSql,
                                                            int pageSize,
                                                            int page){
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FDataExternalWeixinReplyUnit> fetch(CharSequence fields,
                                                            CharSequence whereSql,
                                                            CharSequence orderSql,
                                                            int pageSize,
                                                            int page){
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FDataExternalWeixinReplyUnit> fetchSql(CharSequence code,
                                                               CharSequence sql,
                                                               int pageSize,
                                                               int page){
   ...
   public <T extends FLogicUnit> FLogicDataset<T> fetchSql(Class<T> clazz,
      ...
      if(clazz == null){
         result = (FLogicDataset<T>)(new FLogicDataset<FDataExternalWeixinReplyUnit>(FDataExternalWeixinReplyUnit.class, _logicContext));
      }else{
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FDataExternalWeixinReplyUnit> fetchAll(){
      // 生成命令
   ...
   // @return 数据单元
   //============================================================
   public FDataExternalWeixinReplyUnit doPrepare(){
      FDataExternalWeixinReplyUnit unit = new FDataExternalWeixinReplyUnit();
      unit.linkLogicContext(_logicContext);
      doPrepare(unit);
      return unit;
   }
   ...
   public EResult doPrepare(FLogicUnit logicUnit){
      FDataExternalWeixinReplyUnit unit = (FDataExternalWeixinReplyUnit)logicUnit;
      unit.setOvld(true);
