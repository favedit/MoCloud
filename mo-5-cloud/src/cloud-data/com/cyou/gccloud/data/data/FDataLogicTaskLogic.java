...
//============================================================
@ASourceMachine
public class FDataLogicTaskLogic
      extends FLogicTable
{
   // 业务任务表的定义。
   ...
   // 业务任务表的定义。
   public final static SLogicTableInfo TABLE = new SLogicTableInfo("data.logic.task", "DT_LGC_TASK");
   ...
   // 字段分组枚举的定义。
   public final static SLogicFieldInfo GROUP_CD = new SLogicFieldInfo("GROUP_CD");
   ...
   // 字段重复枚举的定义。
   public final static SLogicFieldInfo REPEAT_CD = new SLogicFieldInfo("REPEAT_CD");

   // 字段得分枚举的定义。
   public final static SLogicFieldInfo SCORE_CD = new SLogicFieldInfo("SCORE_CD");
   ...
   // 字段关联类型编号的定义。
   public final static SLogicFieldInfo LINK_TYPE_ID = new SLogicFieldInfo("LINK_TYPE_ID");
   ...
   // 字段集合的定义。
   public final static String FIELDS = "OUID,OVLD,GUID,CODE,LABEL,ICON_URL,STATUS_CD,DISPLAY_CD,DISPLAY_ORDER,GROUP_CD,TYPE_CD,ACCEPT_CD,FINISH_CD,REPEAT_CD,SCORE_CD,SCORE_BEAN,SCORE_POINT,SCORE_GOLD,LINK_TYPE_ID,KEYWORDS,VIEW_COUNT,DESCRIPTION,CONTENT,NOTE,CREATE_USER_ID,CREATE_DATE,UPDATE_USER_ID,UPDATE_DATE";

   //============================================================
   // <T>构造业务任务表逻辑单元。</T>
   //============================================================
   public FDataLogicTaskLogic(){
      _name = TABLE.name();
      _classUnit = FDataLogicTaskUnit.class;
   }
   ...
   // @param context 逻辑环境
   //============================================================
   public FDataLogicTaskLogic(ILogicContext context){
      super(context);
      _name = TABLE.name();
      _classUnit = FDataLogicTaskUnit.class;
   }
   ...
   // @return 数据单元
   //============================================================
   public FDataLogicTaskUnit search(CharSequence whereSql){
      return search(null, FDataLogicTaskUnit.class, whereSql);
   }
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FDataLogicTaskUnit> fetch(int pageSize,
                                                  int page){
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FDataLogicTaskUnit> fetch(CharSequence whereSql,
                                                  int pageSize,
                                                  int page){
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FDataLogicTaskUnit> fetch(CharSequence fields,
                                                  CharSequence whereSql,
                                                  CharSequence orderSql,
                                                  int pageSize,
                                                  int page){
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FDataLogicTaskUnit> fetchSql(CharSequence code,
                                                     CharSequence sql,
                                                     int pageSize,
                                                     int page){
   ...
   public <T extends FLogicUnit> FLogicDataset<T> fetchSql(Class<T> clazz,
      ...
      if(clazz == null){
         result = (FLogicDataset<T>)(new FLogicDataset<FDataLogicTaskUnit>(FDataLogicTaskUnit.class, _logicContext));
      }else{
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FDataLogicTaskUnit> fetchAll(){
      // 生成命令
   ...
   // @return 数据单元
   //============================================================
   public FDataLogicTaskUnit doPrepare(){
      FDataLogicTaskUnit unit = new FDataLogicTaskUnit();
      unit.linkLogicContext(_logicContext);
      doPrepare(unit);
      return unit;
   }
   ...
   public EResult doPrepare(FLogicUnit logicUnit){
      FDataLogicTaskUnit unit = (FDataLogicTaskUnit)logicUnit;
      unit.setOvld(true);
   ...
   public EResult doInsert(FLogicUnit logicUnit){
      ...
      cmd.append(',');
      cmd.append(unit.repeatCd());
      cmd.append(',');
      cmd.append(unit.scoreCd());
      cmd.append(',');
      ...
      cmd.append(',');
      long linkTypeId = unit.linkTypeId();
      if(linkTypeId == 0){
         cmd.append("NULL");
      }else{
         cmd.append(linkTypeId);
      }
      cmd.append(',');
   ...
   public EResult doUpdate(FLogicUnit logicUnit,
      ...
      if(unit.isRepeatCdChanged()){
         cmd.append(",`REPEAT_CD`=");
         cmd.append(unit.repeatCd());
      }
      if(unit.isScoreCdChanged()){
         cmd.append(",`SCORE_CD`=");
         cmd.append(unit.scoreCd());
      }
