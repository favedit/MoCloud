...
//============================================================
@ASourceMachine
public class FDataResourceModelMeshUnit
      extends FLogicUnit
{
   // 存储字段对象标识的定义。
   private long __ouid;
   ...
   // <T>构造资源模型网格表逻辑单元。</T>
   //============================================================
   public FDataResourceModelMeshUnit(){
   }
   ...
   //============================================================
   @Override
   public FDataResourceModelMeshUnit clone(){
      FDataResourceModelMeshUnit unit = RClass.newInstance(FDataResourceModelMeshUnit.class);
      copy(unit);
      return unit;
   }
}
