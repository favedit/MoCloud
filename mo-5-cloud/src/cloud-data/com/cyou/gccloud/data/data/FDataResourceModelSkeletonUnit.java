      ...
      extends FLogicUnit
{
   ...
   // <T>构造资源网格骨骼表逻辑单元。</T>
   //============================================================
   public FDataResourceModelSkeletonUnit(){
   }
   ...
   //============================================================
   @Override
   public FDataResourceModelSkeletonUnit clone(){
      FDataResourceModelSkeletonUnit unit = RClass.newInstance(FDataResourceModelSkeletonUnit.class);
      copy(unit);
      return unit;
   }
}
