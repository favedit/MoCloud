...
//============================================================
@ASourceMachine
public class FDataResourceTemplateUnit
      extends FLogicUnit
{
   // 存储字段对象标识的定义。
   private long __ouid;
   ...
   // <T>构造资源模板表逻辑单元。</T>
   //============================================================
   public FDataResourceTemplateUnit(){
   }
   ...
   //============================================================
   @Override
   public FDataResourceTemplateUnit clone(){
      FDataResourceTemplateUnit unit = RClass.newInstance(FDataResourceTemplateUnit.class);
      copy(unit);
      return unit;
   }
}
