...
//============================================================
@ASourceMachine
public class FDataExternalWeixinReplyItemLogic
      extends FLogicTable
{
   // 微信回复项目表的定义。
   ...
   // 微信回复项目表的定义。
   public final static SLogicTableInfo TABLE = new SLogicTableInfo("data.external.weixin.reply.item", "DT_ENL_WX_REPLY_ITEM");
   ...
   // 字段资讯编号的定义。
   public final static SLogicFieldInfo NEWS_ID = new SLogicFieldInfo("NEWS_ID");
   ...
   // 字段集合的定义。
   public final static String FIELDS = "OUID,OVLD,GUID,REPLY_ID,NEWS_ID,DISPLAY_ORDER,VIEW_COUNT,CREATE_USER_ID,CREATE_DATE,UPDATE_USER_ID,UPDATE_DATE";

   //============================================================
   // <T>构造微信回复项目表逻辑单元。</T>
   //============================================================
   public FDataExternalWeixinReplyItemLogic(){
      _name = TABLE.name();
      _classUnit = FDataExternalWeixinReplyItemUnit.class;
   }
   ...
   // @param context 逻辑环境
   //============================================================
   public FDataExternalWeixinReplyItemLogic(ILogicContext context){
      super(context);
      _name = TABLE.name();
      _classUnit = FDataExternalWeixinReplyItemUnit.class;
   }
   ...
   public <T extends FLogicUnit> T find(T unit,
      ...
      if(unit == null){
         if(clazz == null){
            unit = (T)(new FDataExternalWeixinReplyItemUnit());
         }else{
   ...
   // @return 数据单元
   //============================================================
   public FDataExternalWeixinReplyItemUnit search(CharSequence whereSql){
      return search(null, FDataExternalWeixinReplyItemUnit.class, whereSql);
   }
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FDataExternalWeixinReplyItemUnit> fetch(int pageSize,
                                                                int page){
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FDataExternalWeixinReplyItemUnit> fetch(CharSequence whereSql,
                                                                int pageSize,
                                                                int page){
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FDataExternalWeixinReplyItemUnit> fetch(CharSequence fields,
                                                                CharSequence whereSql,
                                                                CharSequence orderSql,
                                                                int pageSize,
                                                                int page){
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FDataExternalWeixinReplyItemUnit> fetchSql(CharSequence code,
                                                                   CharSequence sql,
                                                                   int pageSize,
                                                                   int page){
   ...
   public <T extends FLogicUnit> FLogicDataset<T> fetchSql(Class<T> clazz,
      ...
      if(clazz == null){
         result = (FLogicDataset<T>)(new FLogicDataset<FDataExternalWeixinReplyItemUnit>(FDataExternalWeixinReplyItemUnit.class, _logicContext));
      }else{
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FDataExternalWeixinReplyItemUnit> fetchAll(){
      // 生成命令
   ...
   // @return 数据单元
   //============================================================
   public FDataExternalWeixinReplyItemUnit doPrepare(){
      FDataExternalWeixinReplyItemUnit unit = new FDataExternalWeixinReplyItemUnit();
      unit.linkLogicContext(_logicContext);
      doPrepare(unit);
      return unit;
   }
   ...
   public EResult doPrepare(FLogicUnit logicUnit){
      FDataExternalWeixinReplyItemUnit unit = (FDataExternalWeixinReplyItemUnit)logicUnit;
      unit.setOvld(true);
