...
//============================================================
@ASourceMachine
public class FDataCommonConfigurationLogic extends FLogicTable
{
   // 共通配置表的定义。
   public final static SLogicConnectionInfo CONNECTION = new SLogicConnectionInfo("data");

   // 共通配置表的定义。
   public final static SLogicTableInfo TABLE = new SLogicTableInfo("data.common.configuration", "DT_COM_CONFIGURATION");
   ...
   // 字段数据类型的定义。
   public final static SLogicFieldInfo DATA_TYPE_CD = new SLogicFieldInfo("DATA_TYPE_CD");

   // 字段数据内容的定义。
   public final static SLogicFieldInfo DATA_VALUE = new SLogicFieldInfo("DATA_VALUE");
   ...
   // 字段集合的定义。
   public final static String FIELDS = "`OUID`,`OVLD`,`GUID`,`CODE`,`LABEL`,`DATA_TYPE_CD`,`DATA_VALUE`,`NOTE`,`CREATE_USER_ID`,`CREATE_DATE`,`UPDATE_USER_ID`,`UPDATE_DATE`";

   //============================================================
   // <T>构造共通配置表逻辑单元。</T>
   //============================================================
   public FDataCommonConfigurationLogic(){
      _name = TABLE.name();
      _classUnit = FDataCommonConfigurationUnit.class;
   }
   ...
   // @param context 逻辑环境
   //============================================================
   public FDataCommonConfigurationLogic(ILogicContext context){
      super(context);
      _name = TABLE.name();
      _classUnit = FDataCommonConfigurationUnit.class;
   }
   ...
   public <T extends FLogicUnit> T find(T unit, Class<T> clazz, long recordId){
      ...
      if(unit == null){
         if(clazz == null){
            unit = (T)(new FDataCommonConfigurationUnit());
         }else{
   ...
   // @return 数据单元
   //============================================================
   public FDataCommonConfigurationUnit findByGuid(CharSequence guid){
      return findByGuid(null, FDataCommonConfigurationUnit.class, guid);
   }
   ...
   // @return 数据单元
   //============================================================
   public FDataCommonConfigurationUnit search(CharSequence whereSql){
      return search(null, FDataCommonConfigurationUnit.class, whereSql);
   }
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FDataCommonConfigurationUnit> fetch(CharSequence whereSql){
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FDataCommonConfigurationUnit> fetch(int pageSize, int page){
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FDataCommonConfigurationUnit> fetch(CharSequence whereSql, int pageSize, int page){
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FDataCommonConfigurationUnit> fetch(CharSequence whereSql, CharSequence orderSql){
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FDataCommonConfigurationUnit> fetch(CharSequence whereSql, CharSequence orderSql, int pageSize, int page){
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FDataCommonConfigurationUnit> fetch(CharSequence fields, CharSequence whereSql, CharSequence orderSql, int pageSize, int page){
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FDataCommonConfigurationUnit> fetch(CharSequence fields, CharSequence whereSql, CharSequence groupSql, CharSequence orderSql, int pageSize, int page){
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FDataCommonConfigurationUnit> fetchSql(CharSequence code, CharSequence sql, int pageSize, int page){
   ...
   public <T extends FLogicUnit> FLogicDataset<T> fetchSql(Class<T> clazz, CharSequence code, CharSequence sql, int pageSize, int page){
      ...
      if(clazz == null){
         result = (FLogicDataset<T>)(new FLogicDataset<FDataCommonConfigurationUnit>(FDataCommonConfigurationUnit.class, _logicContext));
      }else{
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FDataCommonConfigurationUnit> fetchAll(){
      // 生成命令
   ...
   // @return 数据单元
   //============================================================
   public FDataCommonConfigurationUnit doPrepare(){
   ...
   public EResult doInsert(FLogicUnit logicUnit){
      ...
      cmd.append(",`CODE`");
      cmd.append(",`LABEL`");
      cmd.append(",`DATA_TYPE_CD`");
      cmd.append(",`DATA_VALUE`");
      cmd.append(",`NOTE`");
      ...
      cmd.append(',');
      String dataTypeCd = unit.dataTypeCd();
      if(RString.isEmpty(dataTypeCd)){
         cmd.append("NULL");
      }else{
         cmd.append('\'');
         cmd.append(RSql.formatValue(dataTypeCd));
         cmd.append('\'');
      }
      cmd.append(',');
      String dataValue = unit.dataValue();
      if(RString.isEmpty(dataValue)){
         cmd.append("NULL");
      }else{
         cmd.append('\'');
         cmd.append(RSql.formatValue(dataValue));
         cmd.append('\'');
      }
      cmd.append(',');
