...
//============================================================
@ASourceMachine
public class FDataPersonUserResourceLogic
      extends FLogicTable
{
   // 用户资源表的定义。
   ...
   // 字段评价类型的定义。
   public final static SLogicFieldInfo ESTIMATE_CD = new SLogicFieldInfo("ESTIMATE_CD");

   // 字段收藏类型的定义。
   public final static SLogicFieldInfo COLLECT_CD = new SLogicFieldInfo("COLLECT_CD");

   // 字段用过类型的定义。
   public final static SLogicFieldInfo PLAY_CD = new SLogicFieldInfo("PLAY_CD");

   // 字段下载类型的定义。
   public final static SLogicFieldInfo DOWNLOAD_CD = new SLogicFieldInfo("DOWNLOAD_CD");
   ...
   // 字段集合的定义。
   public final static String FIELDS = "OUID,OVLD,GUID,USER_ID,RESOURCE_CD,RESOURCE_ID,ESTIMATE_CD,COLLECT_CD,PLAY_CD,DOWNLOAD_CD,SCORE_BEAN,SCORE_POINT,SCORE_GOLD,CREATE_USER_ID,CREATE_DATE,UPDATE_USER_ID,UPDATE_DATE";
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FDataPersonUserResourceUnit> fetch(int pageSize,
                                                           int page){
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FDataPersonUserResourceUnit> fetch(CharSequence fields,
                                                           CharSequence whereSql,
                                                           CharSequence orderSql,
                                                           int pageSize,
                                                           int page){
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FDataPersonUserResourceUnit> fetchSql(CharSequence code,
                                                              CharSequence sql,
                                                              int pageSize,
                                                              int page){
   ...
   public EResult doInsert(FLogicUnit logicUnit){
      ...
      cmd.append(",`ESTIMATE_CD`");
      cmd.append(",`COLLECT_CD`");
      cmd.append(",`PLAY_CD`");
      cmd.append(",`DOWNLOAD_CD`");
      ...
      cmd.append(',');
      cmd.append(unit.estimateCd());
      cmd.append(',');
      cmd.append(unit.collectCd());
      cmd.append(',');
      cmd.append(unit.playCd());
      cmd.append(',');
      cmd.append(unit.downloadCd());
      cmd.append(',');
   ...
   public EResult doUpdate(FLogicUnit logicUnit,
      ...
      if(unit.isEstimateCdChanged()){
         cmd.append(",`ESTIMATE_CD`=");
         cmd.append(unit.estimateCd());
      }
      if(unit.isCollectCdChanged()){
         cmd.append(",`COLLECT_CD`=");
         cmd.append(unit.collectCd());
      }
      if(unit.isPlayCdChanged()){
         cmd.append(",`PLAY_CD`=");
         cmd.append(unit.playCd());
      }
      if(unit.isDownloadCdChanged()){
         cmd.append(",`DOWNLOAD_CD`=");
         cmd.append(unit.downloadCd());
      }
