...
//============================================================
@ASourceMachine
public class FDataFinancialCustomerTenderUnit
      extends FLogicUnit
{
   // 存储字段对象标识的定义。
   private long __ouid;
   ...
   //============================================================
   public FDataFinancialCustomerTenderUnit(){
   }
   ...
   // @return 数据内容
   //============================================================
   public FDataFinancialTenderUnit tender(){
      FDataFinancialTenderLogic logic = _logicContext.findLogic(FDataFinancialTenderLogic.class);
      FDataFinancialTenderUnit unit = logic.find(_tenderId);
      return unit;
   }
   ...
   //============================================================
   @Override
   public FDataFinancialCustomerTenderUnit clone(){
      FDataFinancialCustomerTenderUnit unit = RClass.newInstance(FDataFinancialCustomerTenderUnit.class);
      copy(unit);
      return unit;
   }
}
