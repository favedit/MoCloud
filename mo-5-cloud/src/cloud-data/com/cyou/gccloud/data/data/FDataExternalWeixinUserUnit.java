...
//============================================================
@ASourceMachine
public class FDataExternalWeixinUserUnit
      extends FLogicUnit
{
   // 存储字段对象标识的定义。
   private long __ouid;
   ...
   // 存储字段微信公开码的定义。
   private String __openCode;

   // 字段微信公开码的定义。
   protected String _openCode;
   ...
   // <T>构造微信用户表逻辑单元。</T>
   //============================================================
   public FDataExternalWeixinUserUnit(){
   }
   ...
   // @return 数据内容
   //============================================================
   public boolean isOpenCodeChanged(){
      return !RString.equals(__openCode, _openCode);
   }
   ...
   public boolean isNickNameChanged(){
      return !RString.equals(__nickName, _nickName);
   }
   ...
   public void save(FRow row){
      ...
      row.set("openCode", _openCode);
      row.set("nickName", _nickName);
   ...
   public void saveMap(Map<String, String> map){
      ...
      map.put("openCode", _openCode);
      map.put("nickName", _nickName);
