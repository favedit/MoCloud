...
//============================================================
@ASourceMachine
public class FDataControlRoleLogic extends FLogicTable
{
   // 控制角色表的定义。
   public final static SLogicConnectionInfo CONNECTION = new SLogicConnectionInfo("data");

   // 控制角色表的定义。
   public final static SLogicTableInfo TABLE = new SLogicTableInfo("data.control.role", "DT_CTL_ROLE");
   ...
   // <T>构造控制角色表逻辑单元。</T>
   //============================================================
   public FDataControlRoleLogic(){
      _name = TABLE.name();
      _classUnit = FDataControlRoleUnit.class;
   }
   ...
   // @param context 逻辑环境
   //============================================================
   public FDataControlRoleLogic(ILogicContext context){
      super(context);
      _name = TABLE.name();
      _classUnit = FDataControlRoleUnit.class;
   }
   ...
   public <T extends FLogicUnit> T find(T unit, Class<T> clazz, long recordId){
      ...
      if(unit == null){
         if(clazz == null){
            unit = (T)(new FDataControlRoleUnit());
         }else{
   ...
   // @return 数据单元
   //============================================================
   public FDataControlRoleUnit findByGuid(CharSequence guid){
      return findByGuid(null, FDataControlRoleUnit.class, guid);
   }
   ...
   // @return 数据单元
   //============================================================
   public FDataControlRoleUnit search(CharSequence whereSql){
      return search(null, FDataControlRoleUnit.class, whereSql);
   }
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FDataControlRoleUnit> fetch(CharSequence whereSql){
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FDataControlRoleUnit> fetch(int pageSize, int page){
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FDataControlRoleUnit> fetch(CharSequence whereSql, int pageSize, int page){
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FDataControlRoleUnit> fetch(CharSequence whereSql, CharSequence orderSql){
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FDataControlRoleUnit> fetch(CharSequence whereSql, CharSequence orderSql, int pageSize, int page){
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FDataControlRoleUnit> fetch(CharSequence fields, CharSequence whereSql, CharSequence orderSql, int pageSize, int page){
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FDataControlRoleUnit> fetch(CharSequence fields, CharSequence whereSql, CharSequence groupSql, CharSequence orderSql, int pageSize, int page){
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FDataControlRoleUnit> fetchSql(CharSequence code, CharSequence sql, int pageSize, int page){
   ...
   public <T extends FLogicUnit> FLogicDataset<T> fetchSql(Class<T> clazz, CharSequence code, CharSequence sql, int pageSize, int page){
      ...
      if(clazz == null){
         result = (FLogicDataset<T>)(new FLogicDataset<FDataControlRoleUnit>(FDataControlRoleUnit.class, _logicContext));
      }else{
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FDataControlRoleUnit> fetchAll(){
      // 生成命令
   ...
   // @return 数据单元
   //============================================================
   public FDataControlRoleUnit doPrepare(){
      FDataControlRoleUnit unit = new FDataControlRoleUnit();
      unit.linkLogicContext(_logicContext);
      doPrepare(unit);
      return unit;
   }
   ...
   public EResult doPrepare(FLogicUnit logicUnit){
      FDataControlRoleUnit unit = (FDataControlRoleUnit)logicUnit;
      unit.setOvld(true);
