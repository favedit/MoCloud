...
//============================================================
@ASourceMachine
public class FDataResourceLessonChapterLogic
      extends FLogicTable
{
   // 课程章节表的定义。
   ...
   // 课程章节表的定义。
   public final static SLogicTableInfo TABLE = new SLogicTableInfo("data.resource.lesson.chapter", "DT_RES_LESSON_CHAPTER");
   ...
   // 字段课程编号的定义。
   public final static SLogicFieldInfo LESSON_ID = new SLogicFieldInfo("LESSON_ID");

   // 字段章节编号的定义。
   public final static SLogicFieldInfo CHAPTER_NO = new SLogicFieldInfo("CHAPTER_NO");
   ...
   // 字段章节时长的定义。
   public final static SLogicFieldInfo DURATION = new SLogicFieldInfo("DURATION");
   ...
   // 字段集合的定义。
   public final static String FIELDS = "OUID,OVLD,GUID,RESOURCE_ID,LESSON_ID,CHAPTER_NO,LABEL,DISPLAY_CD,DISPLAY_ORDER,DURATION,DESCRIPTION,CONTENT,NOTE,CREATE_USER_ID,CREATE_DATE,UPDATE_USER_ID,UPDATE_DATE";

   //============================================================
   // <T>构造课程章节表逻辑单元。</T>
   //============================================================
   public FDataResourceLessonChapterLogic(){
      _name = TABLE.name();
      _classUnit = FDataResourceLessonChapterUnit.class;
   }
   ...
   // @param context 逻辑环境
   //============================================================
   public FDataResourceLessonChapterLogic(ILogicContext context){
      super(context);
      _name = TABLE.name();
      _classUnit = FDataResourceLessonChapterUnit.class;
   }
   ...
   public <T extends FLogicUnit> T find(T unit,
      ...
      if(unit == null){
         if(clazz == null){
            unit = (T)(new FDataResourceLessonChapterUnit());
         }else{
   ...
   // @return 数据单元
   //============================================================
   public FDataResourceLessonChapterUnit search(CharSequence whereSql){
      return search(null, FDataResourceLessonChapterUnit.class, whereSql);
   }
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FDataResourceLessonChapterUnit> fetch(int pageSize,
                                                              int page){
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FDataResourceLessonChapterUnit> fetch(CharSequence whereSql,
                                                              int pageSize,
                                                              int page){
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FDataResourceLessonChapterUnit> fetch(CharSequence fields,
                                                              CharSequence whereSql,
                                                              CharSequence orderSql,
                                                              int pageSize,
                                                              int page){
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FDataResourceLessonChapterUnit> fetchSql(CharSequence code,
                                                                 CharSequence sql,
                                                                 int pageSize,
                                                                 int page){
   ...
   public <T extends FLogicUnit> FLogicDataset<T> fetchSql(Class<T> clazz,
      ...
      if(clazz == null){
         result = (FLogicDataset<T>)(new FLogicDataset<FDataResourceLessonChapterUnit>(FDataResourceLessonChapterUnit.class, _logicContext));
      }else{
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FDataResourceLessonChapterUnit> fetchAll(){
      // 生成命令
   ...
   // @return 数据单元
   //============================================================
   public FDataResourceLessonChapterUnit doPrepare(){
      FDataResourceLessonChapterUnit unit = new FDataResourceLessonChapterUnit();
      unit.linkLogicContext(_logicContext);
      doPrepare(unit);
      return unit;
   }
   ...
   public EResult doPrepare(FLogicUnit logicUnit){
      FDataResourceLessonChapterUnit unit = (FDataResourceLessonChapterUnit)logicUnit;
      unit.setOvld(true);
   ...
   public EResult doInsert(FLogicUnit logicUnit){
      ...
      cmd.append(",`LESSON_ID`");
      cmd.append(",`CHAPTER_NO`");
      cmd.append(",`LABEL`");
