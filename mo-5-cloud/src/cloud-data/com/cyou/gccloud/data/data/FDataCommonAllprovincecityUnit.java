      ...
      extends FLogicUnit
{
   ...
   public void copy(FLogicUnit logicUnit){
      ...
      unit.setGuid(_guid);
      unit.setNo(_no);
      unit.setAreaname(_areaname);
      unit.setTopno(_topno);
      unit.setAreacode(_areacode);
      unit.setArealevel(_arealevel);
      unit.setTypename(_typename);
   ...
   //============================================================
   @Override
   public FDataCommonAllprovincecityUnit clone(){
      FDataCommonAllprovincecityUnit unit = RClass.newInstance(FDataCommonAllprovincecityUnit.class);
      copy(unit);
      return unit;
   }
}
