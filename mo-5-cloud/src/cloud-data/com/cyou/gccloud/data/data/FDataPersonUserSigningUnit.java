...
//============================================================
@ASourceMachine
public class FDataPersonUserSigningUnit
      extends FLogicUnit
{
   // 存储字段对象标识的定义。
   private long __ouid;
   ...
   public void copy(FLogicUnit logicUnit){
      ...
      unit.singnDate().assign(_singnDate);
   ...
   //============================================================
   @Override
   public FDataPersonUserSigningUnit clone(){
      FDataPersonUserSigningUnit unit = RClass.newInstance(FDataPersonUserSigningUnit.class);
      copy(unit);
      return unit;
   }
}
