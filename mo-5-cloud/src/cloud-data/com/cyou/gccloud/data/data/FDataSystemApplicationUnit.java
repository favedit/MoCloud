...
//============================================================
@ASourceMachine
public class FDataSystemApplicationUnit
      extends FLogicUnit
{
   // 存储字段对象标识的定义。
   private long __ouid;
   ...
   // <T>构造系统应用表逻辑单元。</T>
   //============================================================
   public FDataSystemApplicationUnit(){
   }
   ...
   //============================================================
   @Override
   public FDataSystemApplicationUnit clone(){
      FDataSystemApplicationUnit unit = RClass.newInstance(FDataSystemApplicationUnit.class);
      copy(unit);
      return unit;
   }
}
