...
//============================================================
@ASourceMachine
public class FDataBatchProcessResultUnit
      extends FLogicUnit
{
   // 存储字段对象标识的定义。
   private long __ouid;
   ...
   // <T>构造后台处理结果表逻辑单元。</T>
   //============================================================
   public FDataBatchProcessResultUnit(){
   }
   ...
   public String get(String name){
      switch(name){
         ...
         case "guid":
            return _guid;
         case "process_id":
            return Long.toString(_processId);
         case "status_cd":
      ...
      for(IStringPair pair : row){
         ...
         switch(name){
            ...
            case "guid":
               ...
               break;
            case "process_id":
               __processId = RLong.parse(value);
               _processId = __processId;
               break;
            case "status_cd":
   ...
   public void saveMap(Map<String, String> map){
      ...
      map.put("guid", _guid);
      map.put("processId", RLong.toString(_processId));
