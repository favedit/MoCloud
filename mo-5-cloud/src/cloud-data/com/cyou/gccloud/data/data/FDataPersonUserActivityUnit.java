...
//============================================================
@ASourceMachine
public class FDataPersonUserActivityUnit
      extends FLogicUnit
{
   // 存储字段对象标识的定义。
   private long __ouid;
   ...
   // 存储字段是否签到的定义。
   private int __signCd;

   // 字段是否签到的定义。
   protected int _signCd;
   ...
   // 存储字段团队编号的定义。
   private long __teamId;

   // 字段团队编号的定义。
   protected long _teamId;

   // 存储字段团队描述的定义。
   private String __teamDescription;
   ...
   // <T>构造用户活动表逻辑单元。</T>
   //============================================================
   public FDataPersonUserActivityUnit(){
   }
   ...
   // @return 数据内容
   //============================================================
   public FDataLogicActivityUnit activity(){
      FDataLogicActivityLogic logic = _logicContext.findLogic(FDataLogicActivityLogic.class);
      FDataLogicActivityUnit unit = logic.find(_activityId);
      return unit;
   }
   ...
   // @return 数据内容
   //============================================================
   public boolean isSignCdChanged(){
      return __signCd != _signCd;
   }
   ...
   // @param value 数据内容
   //============================================================
   public void setSignCd(int value){
      _signCd = value;
   }
   ...
   // @return 数据内容
   //============================================================
   public boolean isTeamDescriptionChanged(){
      return !RString.equals(__teamDescription, _teamDescription);
   }
   ...
   // @return 数据内容
   //============================================================
   public boolean isProductDescriptionChanged(){
      return !RString.equals(__productDescription, _productDescription);
   }
   ...
   public String get(String name){
      switch(name){
         ...
         case "sign_cd":
            return RInteger.toString(_signCd);
         case "teacher_id":
            return Long.toString(_teacherId);
         case "team_id":
            return Long.toString(_teamId);
   ...
   public void set(String name,
      ...
      switch(name){
         ...
         case "activity_id":
            ...
            break;
         case "sign_cd":
            _signCd = RInteger.parse(value);
            break;
         case "teacher_id":
            _teacherId = RLong.parse(value);
            break;
         case "team_id":
            _teamId = RLong.parse(value);
            break;
         case "team_description":
            _teamDescription = value;
            break;
      ...
      for(IStringPair pair : row){
         ...
         switch(name){
            ...
            case "teacher_id":
               ...
               break;
            case "team_id":
               __teamId = RLong.parse(value);
               _teamId = __teamId;
               break;
            case "team_description":
               __teamDescription = value;
               _teamDescription = __teamDescription;
               break;
            case "product_description":
               __productDescription = value;
               _productDescription = __productDescription;
               break;
            case "create_user_id":
   ...
   public void save(FRow row){
      ...
      row.set("signCd", _signCd);
      row.set("teacherId", _teacherId);
      row.set("teamId", _teamId);
      row.set("teamDescription", _teamDescription);
      row.set("productDescription", _productDescription);
   ...
   public void saveMap(Map<String, String> map){
      ...
      map.put("signCd", RInteger.toString(_signCd));
      map.put("teacherId", RLong.toString(_teacherId));
      map.put("teamId", RLong.toString(_teamId));
      map.put("teamDescription", _teamDescription);
      map.put("productDescription", _productDescription);
