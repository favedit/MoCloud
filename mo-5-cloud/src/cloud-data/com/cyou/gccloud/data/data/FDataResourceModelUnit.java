...
//============================================================
@ASourceMachine
public class FDataResourceModelUnit
      extends FLogicUnit
{
   // 存储字段对象标识的定义。
   private long __ouid;
   ...
   //============================================================
   @Override
   public FDataResourceModelUnit clone(){
      FDataResourceModelUnit unit = RClass.newInstance(FDataResourceModelUnit.class);
      copy(unit);
      return unit;
   }
}
