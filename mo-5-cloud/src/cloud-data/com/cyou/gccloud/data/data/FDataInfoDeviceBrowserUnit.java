...
//============================================================
@ASourceMachine
public class FDataInfoDeviceBrowserUnit
      extends FLogicUnit
{
   // 存储字段对象标识的定义。
   private long __ouid;
   ...
   // <T>构造信息设备浏览器表逻辑单元。</T>
   //============================================================
   public FDataInfoDeviceBrowserUnit(){
   }
   ...
   // @return 数据内容
   //============================================================
   public FDataInfoDeviceUnit device(){
      FDataInfoDeviceLogic logic = _logicContext.findLogic(FDataInfoDeviceLogic.class);
      FDataInfoDeviceUnit unit = logic.find(_deviceId);
      return unit;
   }
   ...
   public void unserialize(IDataInput input){
      ...
      _deviceId = input.readInt64();
      _agentCode = input.readString();
      _identityCode = input.readString();
   ...
   public void serialize(IDataOutput output){
      ...
      output.writeInt64(_deviceId);
      output.writeString(_agentCode);
      output.writeString(_identityCode);
   ...
   public void copy(FLogicUnit logicUnit){
      ...
      unit.setOvld(_ovld);
      unit.setGuid(_guid);
      unit.setDeviceId(_deviceId);
      unit.setAgentCode(_agentCode);
      unit.setIdentityCode(_identityCode);
   ...
   //============================================================
   @Override
   public FDataInfoDeviceBrowserUnit clone(){
      FDataInfoDeviceBrowserUnit unit = RClass.newInstance(FDataInfoDeviceBrowserUnit.class);
      copy(unit);
      return unit;
   }
}
