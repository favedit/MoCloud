...
//============================================================
// <T>资源模型骨骼蒙皮数据流表逻辑单元。</T>
//============================================================
@ASourceMachine
public class FDataResourceModelSkeletonSkinStreamUnit
      extends FLogicUnit
{
   // 存储字段对象标识的定义。
   private long __ouid;
   ...
   //============================================================
   public FDataResourceModelSkeletonSkinStreamUnit(){
   }
   ...
   // @return 数据内容
   //============================================================
   public FDataResourceModelSkeletonSkinUnit skin(){
      FDataResourceModelSkeletonSkinLogic logic = _logicContext.findLogic(FDataResourceModelSkeletonSkinLogic.class);
      FDataResourceModelSkeletonSkinUnit unit = logic.find(_skinId);
      return unit;
   }
   ...
   public void unserialize(IDataInput input){
      ...
      _skinId = input.readInt64();
      _sortIndex = input.readInt32();
      _fullCode = input.readString();
      _code = input.readString();
      _elementDataCd = input.readInt32();
      _elementCount = input.readInt32();
      _dataStride = input.readInt32();
      _dataCount = input.readInt32();
      _dataLength = input.readInt32();
   ...
   public void serialize(IDataOutput output){
      ...
      output.writeInt64(_skinId);
      output.writeInt32(_sortIndex);
      output.writeString(_fullCode);
      output.writeString(_code);
      output.writeInt32(_elementDataCd);
      output.writeInt32(_elementCount);
      output.writeInt32(_dataStride);
      output.writeInt32(_dataCount);
      output.writeInt32(_dataLength);
   ...
   public void copy(FLogicUnit logicUnit){
      ...
      unit.setDataLength(_dataLength);
      unit.setNote(_note);
   ...
   //============================================================
   @Override
   public FDataResourceModelSkeletonSkinStreamUnit clone(){
      FDataResourceModelSkeletonSkinStreamUnit unit = RClass.newInstance(FDataResourceModelSkeletonSkinStreamUnit.class);
      copy(unit);
      return unit;
   }
}
