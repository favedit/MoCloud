...
//============================================================
@ASourceMachine
public class FDataPersonUserInviteUnit
      extends FLogicUnit
{
   // 存储字段对象标识的定义。
   private long __ouid;
   ...
   // 存储字段邀请编号的定义。
   private long __inviteId;

   // 字段邀请编号的定义。
   protected long _inviteId;

   // 存储字段邀请用户编号的定义。
   private long __inviteUserId;

   // 字段邀请用户编号的定义。
   protected long _inviteUserId;
   ...
   // <T>构造用户邀请表逻辑单元。</T>
   //============================================================
   public FDataPersonUserInviteUnit(){
   }
   ...
   // @return 数据内容
   //============================================================
   public boolean isInviteIdChanged(){
      return __inviteId != _inviteId;
   }
   ...
   // @return 数据内容
   //============================================================
   public FDataLogicInviteUnit invite(){
      FDataLogicInviteLogic logic = _logicContext.findLogic(FDataLogicInviteLogic.class);
      FDataLogicInviteUnit unit = logic.find(_inviteId);
      return unit;
   }
   ...
   // @return 数据内容
   //============================================================
   public boolean isInviteUserIdChanged(){
      return __inviteUserId != _inviteUserId;
   }
   ...
   // @return 数据内容
   //============================================================
   public FDataPersonUserUnit inviteUser(){
      FDataPersonUserLogic logic = _logicContext.findLogic(FDataPersonUserLogic.class);
      FDataPersonUserUnit unit = logic.find(_inviteUserId);
      return unit;
   }
   ...
   // @param value 数据内容
   //============================================================
   public void setInviteUserId(long value){
      _inviteUserId = value;
   }
   ...
   public String get(String name){
      switch(name){
         ...
         case "invite_id":
            return Long.toString(_inviteId);
         case "invite_user_id":
            return Long.toString(_inviteUserId);
         case "status_cd":
   ...
   public void set(String name,
      ...
      switch(name){
         ...
         case "project_id":
            ...
            break;
         case "invite_id":
            _inviteId = RLong.parse(value);
            break;
         case "invite_user_id":
            _inviteUserId = RLong.parse(value);
            break;
         case "status_cd":
      ...
      for(IStringPair pair : row){
         ...
         switch(name){
            ...
            case "project_id":
               ...
               break;
            case "invite_id":
               __inviteId = RLong.parse(value);
               _inviteId = __inviteId;
               break;
            case "invite_user_id":
               __inviteUserId = RLong.parse(value);
               _inviteUserId = __inviteUserId;
               break;
            case "status_cd":
   ...
   public void save(FRow row){
      ...
      row.set("inviteId", _inviteId);
      row.set("inviteUserId", _inviteUserId);
   ...
   public void saveMap(Map<String, String> map){
      ...
      map.put("inviteId", RLong.toString(_inviteId));
      map.put("inviteUserId", RLong.toString(_inviteUserId));
