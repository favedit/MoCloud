...
//============================================================
@ASourceMachine
public class FDataBatchProcessUnit
      extends FLogicUnit
{
   // 存储字段对象标识的定义。
   private long __ouid;
   ...
   // 存储字段运行参数集合的定义。
   private String __runtimeParameters;

   // 字段运行参数集合的定义。
   protected String _runtimeParameters;
   ...
   // @return 数据内容
   //============================================================
   public boolean isRuntimeParametersChanged(){
      return !RString.equals(__runtimeParameters, _runtimeParameters);
   }
   ...
   // @param value 数据内容
   //============================================================
   public void setRuntimeParameters(String value){
      ...
      for(IStringPair pair : row){
         ...
         switch(name){
            ...
            case "output_parameters":
               ...
               break;
            case "runtime_parameters":
               __runtimeParameters = value;
               _runtimeParameters = __runtimeParameters;
               break;
            case "begin_date":
   ...
   public void save(FRow row){
      ...
      row.set("runtimeParameters", _runtimeParameters);
   ...
   public void saveMap(Map<String, String> map){
      ...
      map.put("runtimeParameters", _runtimeParameters);
