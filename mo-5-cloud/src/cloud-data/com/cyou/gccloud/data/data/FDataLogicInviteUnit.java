...
//============================================================
@ASourceMachine
public class FDataLogicInviteUnit
      extends FLogicUnit
{
   // 存储字段对象标识的定义。
   private long __ouid;
   ...
   // 存储字段邀请类型的定义。
   private int __inviteCd;

   // 字段邀请类型的定义。
   protected int _inviteCd;

   // 存储字段邀请代码的定义。
   private String __inviteCode;
   ...
   // @return 数据内容
   //============================================================
   public boolean isInviteCdChanged(){
      return __inviteCd != _inviteCd;
   }
   ...
   // @param value 数据内容
   //============================================================
   public void setInviteCd(int value){
      _inviteCd = value;
   }
   ...
   // @return 数据内容
   //============================================================
   public boolean isInviteCodeChanged(){
      return !RString.equals(__inviteCode, _inviteCode);
   }
   ...
   public String get(String name){
      switch(name){
         ...
         case "invite_cd":
            return RInteger.toString(_inviteCd);
         case "invite_code":
            return _inviteCode;
         case "description":
            return _description;
   ...
   public void set(String name,
      ...
      switch(name){
         ...
         case "user_id":
            ...
            break;
         case "invite_cd":
            _inviteCd = RInteger.parse(value);
            break;
         case "invite_code":
            _inviteCode = value;
            break;
      ...
      for(IStringPair pair : row){
         ...
         switch(name){
            ...
            case "user_id":
               ...
               break;
            case "invite_cd":
               __inviteCd = RInteger.parse(value);
               _inviteCd = __inviteCd;
               break;
            case "invite_code":
               __inviteCode = value;
               _inviteCode = __inviteCode;
               break;
            case "description":
               __description = value;
   ...
   public void save(FRow row){
      ...
      row.set("inviteCd", _inviteCd);
      row.set("inviteCode", _inviteCode);
   ...
   public void saveMap(Map<String, String> map){
      ...
      map.put("inviteCd", RInteger.toString(_inviteCd));
      map.put("inviteCode", _inviteCode);
