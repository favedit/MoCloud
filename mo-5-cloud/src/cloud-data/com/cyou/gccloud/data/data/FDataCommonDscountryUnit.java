      ...
      extends FLogicUnit
{
   ...
   public void copy(FLogicUnit logicUnit){
      ...
      unit.setId(_id);
      unit.setName(_name);
      unit.setZhName(_zhName);
      unit.setCode(_code);
      unit.setCode2(_code2);
      unit.setIsShow(_isShow);
   ...
   //============================================================
   @Override
   public FDataCommonDscountryUnit clone(){
      FDataCommonDscountryUnit unit = RClass.newInstance(FDataCommonDscountryUnit.class);
      copy(unit);
      return unit;
   }
}
