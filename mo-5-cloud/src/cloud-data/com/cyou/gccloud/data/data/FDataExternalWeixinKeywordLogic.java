...
//============================================================
@ASourceMachine
public class FDataExternalWeixinKeywordLogic
      extends FLogicTable
{
   // 微信关键字表的定义。
   ...
   // 微信关键字表的定义。
   public final static SLogicTableInfo TABLE = new SLogicTableInfo("data.external.weixin.keyword", "DT_ENL_WX_KEYWORD");
   ...
   // 字段集合的定义。
   public final static String FIELDS = "OUID,OVLD,GUID,CODE,LABEL,VIEW_COUNT,CREATE_USER_ID,CREATE_DATE,UPDATE_USER_ID,UPDATE_DATE";

   //============================================================
   // <T>构造微信关键字表逻辑单元。</T>
   //============================================================
   public FDataExternalWeixinKeywordLogic(){
      _name = TABLE.name();
      _classUnit = FDataExternalWeixinKeywordUnit.class;
   }
   ...
   // @param context 逻辑环境
   //============================================================
   public FDataExternalWeixinKeywordLogic(ILogicContext context){
      super(context);
      _name = TABLE.name();
      _classUnit = FDataExternalWeixinKeywordUnit.class;
   }
   ...
   public <T extends FLogicUnit> T find(T unit,
      ...
      if(unit == null){
         if(clazz == null){
            unit = (T)(new FDataExternalWeixinKeywordUnit());
         }else{
   ...
   // @return 数据单元
   //============================================================
   public FDataExternalWeixinKeywordUnit search(CharSequence whereSql){
      return search(null, FDataExternalWeixinKeywordUnit.class, whereSql);
   }
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FDataExternalWeixinKeywordUnit> fetch(int pageSize,
                                                              int page){
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FDataExternalWeixinKeywordUnit> fetch(CharSequence whereSql,
                                                              int pageSize,
                                                              int page){
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FDataExternalWeixinKeywordUnit> fetch(CharSequence fields,
                                                              CharSequence whereSql,
                                                              CharSequence orderSql,
                                                              int pageSize,
                                                              int page){
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FDataExternalWeixinKeywordUnit> fetchSql(CharSequence code,
                                                                 CharSequence sql,
                                                                 int pageSize,
                                                                 int page){
   ...
   public <T extends FLogicUnit> FLogicDataset<T> fetchSql(Class<T> clazz,
      ...
      if(clazz == null){
         result = (FLogicDataset<T>)(new FLogicDataset<FDataExternalWeixinKeywordUnit>(FDataExternalWeixinKeywordUnit.class, _logicContext));
      }else{
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FDataExternalWeixinKeywordUnit> fetchAll(){
      // 生成命令
   ...
   // @return 数据单元
   //============================================================
   public FDataExternalWeixinKeywordUnit doPrepare(){
      FDataExternalWeixinKeywordUnit unit = new FDataExternalWeixinKeywordUnit();
      unit.linkLogicContext(_logicContext);
      doPrepare(unit);
      return unit;
   }
   ...
   public EResult doPrepare(FLogicUnit logicUnit){
      FDataExternalWeixinKeywordUnit unit = (FDataExternalWeixinKeywordUnit)logicUnit;
      unit.setOvld(true);
