...
//============================================================
@ASourceMachine
public class FDataResourceModelSkeletonSkinStreamLogic extends FLogicTable
{
   // 资源模型骨骼蒙皮数据流表的定义。
   public final static SLogicConnectionInfo CONNECTION = new SLogicConnectionInfo("data");

   // 资源模型骨骼蒙皮数据流表的定义。
   public final static SLogicTableInfo TABLE = new SLogicTableInfo("data.resource.model.skeleton.skin.stream", "DT_RES_MODEL_SKELETON_SKIN_STREAM");
   ...
   //============================================================
   public FDataResourceModelSkeletonSkinStreamLogic(){
      _name = TABLE.name();
      _classUnit = FDataResourceModelSkeletonSkinStreamUnit.class;
   }
   ...
   // @param context 逻辑环境
   //============================================================
   public FDataResourceModelSkeletonSkinStreamLogic(ILogicContext context){
      super(context);
      _name = TABLE.name();
      _classUnit = FDataResourceModelSkeletonSkinStreamUnit.class;
   }
   ...
   public <T extends FLogicUnit> T find(T unit, Class<T> clazz, long recordId){
      ...
      if(unit == null){
         if(clazz == null){
            unit = (T)(new FDataResourceModelSkeletonSkinStreamUnit());
         }else{
   ...
   // @return 数据单元
   //============================================================
   public FDataResourceModelSkeletonSkinStreamUnit findByGuid(CharSequence guid){
      return findByGuid(null, FDataResourceModelSkeletonSkinStreamUnit.class, guid);
   }
   ...
   // @return 数据单元
   //============================================================
   public FDataResourceModelSkeletonSkinStreamUnit search(CharSequence whereSql){
      return search(null, FDataResourceModelSkeletonSkinStreamUnit.class, whereSql);
   }
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FDataResourceModelSkeletonSkinStreamUnit> fetch(CharSequence whereSql){
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FDataResourceModelSkeletonSkinStreamUnit> fetch(int pageSize, int page){
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FDataResourceModelSkeletonSkinStreamUnit> fetch(CharSequence whereSql, int pageSize, int page){
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FDataResourceModelSkeletonSkinStreamUnit> fetch(CharSequence whereSql, CharSequence orderSql){
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FDataResourceModelSkeletonSkinStreamUnit> fetch(CharSequence whereSql, CharSequence orderSql, int pageSize, int page){
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FDataResourceModelSkeletonSkinStreamUnit> fetch(CharSequence fields, CharSequence whereSql, CharSequence orderSql, int pageSize, int page){
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FDataResourceModelSkeletonSkinStreamUnit> fetch(CharSequence fields, CharSequence whereSql, CharSequence groupSql, CharSequence orderSql, int pageSize, int page){
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FDataResourceModelSkeletonSkinStreamUnit> fetchSql(CharSequence code, CharSequence sql, int pageSize, int page){
   ...
   public <T extends FLogicUnit> FLogicDataset<T> fetchSql(Class<T> clazz, CharSequence code, CharSequence sql, int pageSize, int page){
      ...
      if(clazz == null){
         result = (FLogicDataset<T>)(new FLogicDataset<FDataResourceModelSkeletonSkinStreamUnit>(FDataResourceModelSkeletonSkinStreamUnit.class, _logicContext));
      }else{
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FDataResourceModelSkeletonSkinStreamUnit> fetchAll(){
      // 生成命令
   ...
   // @return 数据单元
   //============================================================
   public FDataResourceModelSkeletonSkinStreamUnit doPrepare(){
      FDataResourceModelSkeletonSkinStreamUnit unit = new FDataResourceModelSkeletonSkinStreamUnit();
      unit.linkLogicContext(_logicContext);
      doPrepare(unit);
      return unit;
   }
