...
//============================================================
@ASourceMachine
public class FDataResourceLessonChapterUnit
      extends FLogicUnit
{
   // 存储字段对象标识的定义。
   private long __ouid;
   ...
   // 存储字段课程编号的定义。
   private long __lessonId;

   // 字段课程编号的定义。
   protected long _lessonId;

   // 存储字段章节编号的定义。
   private int __chapterNo;

   // 字段章节编号的定义。
   protected int _chapterNo;
   ...
   // <T>构造课程章节表逻辑单元。</T>
   //============================================================
   public FDataResourceLessonChapterUnit(){
   }
   ...
   // @return 数据内容
   //============================================================
   public boolean isLessonIdChanged(){
      return __lessonId != _lessonId;
   }
   ...
   // @return 数据内容
   //============================================================
   public FDataResourceLessonUnit lesson(){
      FDataResourceLessonLogic logic = _logicContext.findLogic(FDataResourceLessonLogic.class);
      FDataResourceLessonUnit unit = logic.find(_lessonId);
      return unit;
   }
   ...
   // @return 数据内容
   //============================================================
   public boolean isChapterNoChanged(){
      return __chapterNo != _chapterNo;
   }
   ...
   // @param value 数据内容
   //============================================================
   public void setChapterNo(int value){
      _chapterNo = value;
   }
   ...
   public String get(String name){
      switch(name){
         ...
         case "lesson_id":
            return Long.toString(_lessonId);
         case "chapter_no":
            return RInteger.toString(_chapterNo);
         case "label":
            return _label;
         case "display_cd":
         ...
         case "duration":
            return RInteger.toString(_duration);
         case "description":
            return _description;
         case "content":
            return _content;
   ...
   public void set(String name,
      ...
      switch(name){
         ...
         case "resource_id":
            ...
            break;
         case "lesson_id":
            _lessonId = RLong.parse(value);
            break;
         case "chapter_no":
            _chapterNo = RInteger.parse(value);
            break;
         case "label":
            _label = value;
            break;
         ...
         case "display_order":
            ...
            break;
         case "duration":
            _duration = RInteger.parse(value);
            break;
         case "description":
            _description = value;
            break;
      ...
      for(IStringPair pair : row){
         ...
         switch(name){
            ...
            case "resource_id":
               ...
               break;
            case "lesson_id":
               __lessonId = RLong.parse(value);
               _lessonId = __lessonId;
               break;
            case "chapter_no":
               __chapterNo = RInteger.parse(value);
               _chapterNo = __chapterNo;
               break;
            case "label":
               __label = value;
               _label = __label;
            ...
            case "display_order":
               ...
               break;
            case "duration":
               __duration = RInteger.parse(value);
   ...
   public void save(FRow row){
      ...
      row.set("lessonId", _lessonId);
      row.set("chapterNo", _chapterNo);
      row.set("label", _label);
      row.set("displayCd", _displayCd);
      row.set("displayOrder", _displayOrder);
      row.set("duration", _duration);
   ...
   public void saveMap(Map<String, String> map){
      ...
      map.put("lessonId", RLong.toString(_lessonId));
      map.put("chapterNo", RInteger.toString(_chapterNo));
      map.put("label", _label);
      map.put("displayCd", RInteger.toString(_displayCd));
      map.put("displayOrder", RInteger.toString(_displayOrder));
      map.put("duration", RInteger.toString(_duration));
