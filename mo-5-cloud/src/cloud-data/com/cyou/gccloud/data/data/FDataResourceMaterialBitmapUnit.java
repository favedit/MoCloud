...
//============================================================
@ASourceMachine
public class FDataResourceMaterialBitmapUnit
      extends FLogicUnit
{
   // 存储字段对象标识的定义。
   private long __ouid;
   ...
   // <T>构造资源材质位图表逻辑单元。</T>
   //============================================================
   public FDataResourceMaterialBitmapUnit(){
   }
   ...
   //============================================================
   @Override
   public FDataResourceMaterialBitmapUnit clone(){
      FDataResourceMaterialBitmapUnit unit = RClass.newInstance(FDataResourceMaterialBitmapUnit.class);
      copy(unit);
      return unit;
   }
}
