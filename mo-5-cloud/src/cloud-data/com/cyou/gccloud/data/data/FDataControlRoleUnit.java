...
//============================================================
@ASourceMachine
public class FDataControlRoleUnit
      extends FLogicUnit
{
   // 存储字段对象标识的定义。
   private long __ouid;
   ...
   //============================================================
   @Override
   public FDataControlRoleUnit clone(){
      FDataControlRoleUnit unit = RClass.newInstance(FDataControlRoleUnit.class);
      copy(unit);
      return unit;
   }
}
