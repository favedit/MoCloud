...
//============================================================
@ASourceMachine
public class FDataSystemMessageLogic
      extends FLogicTable
{
   // 系统消息表的定义。
   ...
   // 系统消息表的定义。
   public final static SLogicTableInfo TABLE = new SLogicTableInfo("data.system.message", "DT_SYS_MESSAGE");
   ...
   // 字段集合的定义。
   public final static String FIELDS = "OUID,OVLD,GUID,LEVEL_CD,CODE,LABEL,DESCRIPTION,NOTE,CREATE_USER_ID,CREATE_DATE,UPDATE_USER_ID,UPDATE_DATE";

   //============================================================
   // <T>构造系统消息表逻辑单元。</T>
   //============================================================
   public FDataSystemMessageLogic(){
      _name = TABLE.name();
      _classUnit = FDataSystemMessageUnit.class;
   }
   ...
   // @param context 逻辑环境
   //============================================================
   public FDataSystemMessageLogic(ILogicContext context){
      super(context);
      _name = TABLE.name();
      _classUnit = FDataSystemMessageUnit.class;
   }
   ...
   public <T extends FLogicUnit> T find(T unit,
      ...
      if(unit == null){
         if(clazz == null){
            unit = (T)(new FDataSystemMessageUnit());
         }else{
   ...
   // @return 数据单元
   //============================================================
   public FDataSystemMessageUnit search(CharSequence whereSql){
      return search(null, FDataSystemMessageUnit.class, whereSql);
   }
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FDataSystemMessageUnit> fetch(int pageSize,
                                                      int page){
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FDataSystemMessageUnit> fetch(CharSequence whereSql,
                                                      int pageSize,
                                                      int page){
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FDataSystemMessageUnit> fetch(CharSequence fields,
                                                      CharSequence whereSql,
                                                      CharSequence orderSql,
                                                      int pageSize,
                                                      int page){
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FDataSystemMessageUnit> fetchSql(CharSequence code,
                                                         CharSequence sql,
                                                         int pageSize,
                                                         int page){
   ...
   public <T extends FLogicUnit> FLogicDataset<T> fetchSql(Class<T> clazz,
      ...
      if(clazz == null){
         result = (FLogicDataset<T>)(new FLogicDataset<FDataSystemMessageUnit>(FDataSystemMessageUnit.class, _logicContext));
      }else{
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FDataSystemMessageUnit> fetchAll(){
      // 生成命令
   ...
   // @return 数据单元
   //============================================================
   public FDataSystemMessageUnit doPrepare(){
      FDataSystemMessageUnit unit = new FDataSystemMessageUnit();
      unit.linkLogicContext(_logicContext);
      doPrepare(unit);
      return unit;
   }
   ...
   public EResult doPrepare(FLogicUnit logicUnit){
      FDataSystemMessageUnit unit = (FDataSystemMessageUnit)logicUnit;
      unit.setOvld(true);
