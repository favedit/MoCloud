      ...
      extends FLogicUnit
{
   ...
   public void copy(FLogicUnit logicUnit){
      ...
      unit.setRecommendMarketerId(_recommendMarketerId);
      unit.setRecommendMarketerUserId(_recommendMarketerUserId);
      unit.recommendBeginDate().assign(_recommendBeginDate);
      unit.recommendEndDate().assign(_recommendEndDate);
      unit.setRecommendScore(_recommendScore);
      unit.setNote(_note);
   ...
   //============================================================
   @Override
   public FDataFinancialMemberUnit clone(){
      FDataFinancialMemberUnit unit = RClass.newInstance(FDataFinancialMemberUnit.class);
      copy(unit);
      return unit;
   }
}
