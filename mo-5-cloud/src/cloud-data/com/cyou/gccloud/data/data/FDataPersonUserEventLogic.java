...
//============================================================
@ASourceMachine
public class FDataPersonUserEventLogic
      extends FLogicTable
{
   // 用户事件表的定义。
   ...
   // 用户事件表的定义。
   public final static SLogicTableInfo TABLE = new SLogicTableInfo("data.person.user.event", "DT_PSN_USER_EVENT");
   ...
   // 字段事件编号的定义。
   public final static SLogicFieldInfo EVENT_ID = new SLogicFieldInfo("EVENT_ID");
   ...
   // 字段集合的定义。
   public final static String FIELDS = "OUID,OVLD,GUID,USER_ID,EVENT_ID,LINK_CD,LINK_ID,STATUS_CD,CREATE_USER_ID,CREATE_DATE,UPDATE_USER_ID,UPDATE_DATE";

   //============================================================
   // <T>构造用户事件表逻辑单元。</T>
   //============================================================
   public FDataPersonUserEventLogic(){
      _name = TABLE.name();
      _classUnit = FDataPersonUserEventUnit.class;
   }
   ...
   // @param context 逻辑环境
   //============================================================
   public FDataPersonUserEventLogic(ILogicContext context){
      super(context);
      _name = TABLE.name();
      _classUnit = FDataPersonUserEventUnit.class;
   }
   ...
   public <T extends FLogicUnit> T find(T unit,
      ...
      if(unit == null){
         if(clazz == null){
            unit = (T)(new FDataPersonUserEventUnit());
         }else{
   ...
   // @return 数据单元
   //============================================================
   public FDataPersonUserEventUnit search(CharSequence whereSql){
      return search(null, FDataPersonUserEventUnit.class, whereSql);
   }
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FDataPersonUserEventUnit> fetch(int pageSize,
                                                        int page){
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FDataPersonUserEventUnit> fetch(CharSequence whereSql,
                                                        int pageSize,
                                                        int page){
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FDataPersonUserEventUnit> fetch(CharSequence fields,
                                                        CharSequence whereSql,
                                                        CharSequence orderSql,
                                                        int pageSize,
                                                        int page){
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FDataPersonUserEventUnit> fetchSql(CharSequence code,
                                                           CharSequence sql,
                                                           int pageSize,
                                                           int page){
   ...
   public <T extends FLogicUnit> FLogicDataset<T> fetchSql(Class<T> clazz,
      ...
      if(clazz == null){
         result = (FLogicDataset<T>)(new FLogicDataset<FDataPersonUserEventUnit>(FDataPersonUserEventUnit.class, _logicContext));
      }else{
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FDataPersonUserEventUnit> fetchAll(){
      // 生成命令
   ...
   // @return 数据单元
   //============================================================
   public FDataPersonUserEventUnit doPrepare(){
      FDataPersonUserEventUnit unit = new FDataPersonUserEventUnit();
      unit.linkLogicContext(_logicContext);
      doPrepare(unit);
      return unit;
   }
   ...
   public EResult doPrepare(FLogicUnit logicUnit){
      FDataPersonUserEventUnit unit = (FDataPersonUserEventUnit)logicUnit;
      unit.setOvld(true);
