...
//============================================================
@ASourceMachine
public class FDataPersonUserTruetimedataUnit extends FLogicUnit
{
   // 存储字段对象标识的定义。
   private long __ouid;
   ...
   // 存储字段实时数据编号的定义。
   private long __truetimeId;

   // 字段实时数据编号的定义。
   protected long _truetimeId;
   ...
   // <T>构造人员实时数据访问逻辑单元。</T>
   //============================================================
   public FDataPersonUserTruetimedataUnit(){
   }
   ...
   // @return 数据内容
   //============================================================
   public boolean isTruetimeIdChanged(){
      return __truetimeId != _truetimeId;
   }
   ...
   // @return 数据内容
   //============================================================
   public FDataLogicTruetimeUnit truetime(){
      FDataLogicTruetimeLogic logic = _logicContext.findLogic(FDataLogicTruetimeLogic.class);
      FDataLogicTruetimeUnit unit = logic.find(_truetimeId);
      return unit;
   }
   ...
   // @param value 数据内容
   //============================================================
   public void setTruetimeId(long value){
      _truetimeId = value;
   }
   ...
   public String get(String name){
      switch(name){
         ...
         case "truetime_id":
            return Long.toString(_truetimeId);
         case "active_cd":
      ...
      for(IStringPair pair : row){
         ...
         switch(name){
            ...
            case "user_id":
               ...
               break;
            case "truetime_id":
               __truetimeId = RLong.parse(value);
               _truetimeId = __truetimeId;
               break;
            case "active_cd":
   ...
   public void save(FRow row){
      ...
      row.set("truetimeId", _truetimeId);
   ...
   public void saveMap(Map<String, String> map){
      ...
      map.put("truetimeId", RLong.toString(_truetimeId));
   ...
   public void copy(FLogicUnit logicUnit){
      ...
      unit.setTruetimeId(_truetimeId);
   ...
   //============================================================
   @Override
   public FDataPersonUserTruetimedataUnit clone(){
      FDataPersonUserTruetimedataUnit unit = RClass.newInstance(FDataPersonUserTruetimedataUnit.class);
      copy(unit);
      return unit;
   }
}
