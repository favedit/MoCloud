...
//============================================================
@ASourceMachine
public class FDataExternalWeixinMenuLogic
      extends FLogicTable
{
   // 微信菜单的定义。
   ...
   // 微信菜单的定义。
   public final static SLogicTableInfo TABLE = new SLogicTableInfo("data.external.weixin.menu", "DT_ENL_WX_MENU");
   ...
   // 字段集合的定义。
   public final static String FIELDS = "OUID,OVLD,GUID,PARENT_ID,LABEL,KEYWORD_ID,LINK_CD,LINK_URL,DISPLAY_ORDER,VIEW_COUNT,CREATE_USER_ID,CREATE_DATE,UPDATE_USER_ID,UPDATE_DATE";

   //============================================================
   // <T>构造微信菜单逻辑单元。</T>
   //============================================================
   public FDataExternalWeixinMenuLogic(){
      _name = TABLE.name();
      _classUnit = FDataExternalWeixinMenuUnit.class;
   }
   ...
   // @param context 逻辑环境
   //============================================================
   public FDataExternalWeixinMenuLogic(ILogicContext context){
      super(context);
      _name = TABLE.name();
      _classUnit = FDataExternalWeixinMenuUnit.class;
   }
   ...
   public <T extends FLogicUnit> T find(T unit,
      ...
      if(unit == null){
         if(clazz == null){
            unit = (T)(new FDataExternalWeixinMenuUnit());
         }else{
   ...
   // @return 数据单元
   //============================================================
   public FDataExternalWeixinMenuUnit search(CharSequence whereSql){
      return search(null, FDataExternalWeixinMenuUnit.class, whereSql);
   }
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FDataExternalWeixinMenuUnit> fetch(int pageSize,
                                                           int page){
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FDataExternalWeixinMenuUnit> fetch(CharSequence whereSql,
                                                           int pageSize,
                                                           int page){
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FDataExternalWeixinMenuUnit> fetch(CharSequence fields,
                                                           CharSequence whereSql,
                                                           CharSequence orderSql,
                                                           int pageSize,
                                                           int page){
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FDataExternalWeixinMenuUnit> fetchSql(CharSequence code,
                                                              CharSequence sql,
                                                              int pageSize,
                                                              int page){
   ...
   public <T extends FLogicUnit> FLogicDataset<T> fetchSql(Class<T> clazz,
      ...
      if(clazz == null){
         result = (FLogicDataset<T>)(new FLogicDataset<FDataExternalWeixinMenuUnit>(FDataExternalWeixinMenuUnit.class, _logicContext));
      }else{
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FDataExternalWeixinMenuUnit> fetchAll(){
      // 生成命令
   ...
   // @return 数据单元
   //============================================================
   public FDataExternalWeixinMenuUnit doPrepare(){
      FDataExternalWeixinMenuUnit unit = new FDataExternalWeixinMenuUnit();
      unit.linkLogicContext(_logicContext);
      doPrepare(unit);
      return unit;
   }
   ...
   public EResult doPrepare(FLogicUnit logicUnit){
      FDataExternalWeixinMenuUnit unit = (FDataExternalWeixinMenuUnit)logicUnit;
      unit.setOvld(true);
