...
//============================================================
@ASourceMachine
public class FDataControlModuleUnit
      extends FLogicUnit
{
   // 存储字段对象标识的定义。
   private long __ouid;
   ...
   //============================================================
   @Override
   public FDataControlModuleUnit clone(){
      FDataControlModuleUnit unit = RClass.newInstance(FDataControlModuleUnit.class);
      copy(unit);
      return unit;
   }
}
