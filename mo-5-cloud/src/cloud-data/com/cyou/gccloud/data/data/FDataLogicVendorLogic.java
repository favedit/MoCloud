...
//============================================================
@ASourceMachine
public class FDataLogicVendorLogic
      extends FLogicTable
{
   // 业务提供商表的定义。
   ...
   // 业务提供商表的定义。
   public final static SLogicTableInfo TABLE = new SLogicTableInfo("data.logic.vendor", "DT_LGC_VENDOR");
   ...
   // 字段主页地址的定义。
   public final static SLogicFieldInfo HOME_URL = new SLogicFieldInfo("HOME_URL");
   ...
   // 字段集合的定义。
   public final static String FIELDS = "OUID,OVLD,GUID,CODE,LABEL,DISPLAY_CD,DISPLAY_ORDER,ICON_URL,HOME_URL,NOTE,CREATE_USER_ID,CREATE_DATE,UPDATE_USER_ID,UPDATE_DATE";

   //============================================================
   // <T>构造业务提供商表逻辑单元。</T>
   //============================================================
   public FDataLogicVendorLogic(){
      _name = TABLE.name();
      _classUnit = FDataLogicVendorUnit.class;
      _timeout = 3600 * 1000;
   }
   ...
   // @param context 逻辑环境
   //============================================================
   public FDataLogicVendorLogic(ILogicContext context){
      super(context);
      _name = TABLE.name();
      _classUnit = FDataLogicVendorUnit.class;
      _timeout = 3600 * 1000;
   ...
   public <T extends FLogicUnit> T find(T unit,
      ...
      if(unit == null){
         if(clazz == null){
            unit = (T)(new FDataLogicVendorUnit());
         }else{
   ...
   // @return 数据单元
   //============================================================
   public FDataLogicVendorUnit search(CharSequence whereSql){
      return search(null, FDataLogicVendorUnit.class, whereSql);
   }
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FDataLogicVendorUnit> fetch(int pageSize,
                                                    int page){
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FDataLogicVendorUnit> fetch(CharSequence whereSql,
                                                    int pageSize,
                                                    int page){
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FDataLogicVendorUnit> fetch(CharSequence fields,
                                                    CharSequence whereSql,
                                                    CharSequence orderSql,
                                                    int pageSize,
                                                    int page){
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FDataLogicVendorUnit> fetchSql(CharSequence code,
                                                       CharSequence sql,
                                                       int pageSize,
                                                       int page){
   ...
   public <T extends FLogicUnit> FLogicDataset<T> fetchSql(Class<T> clazz,
      ...
      if(clazz == null){
         result = (FLogicDataset<T>)(new FLogicDataset<FDataLogicVendorUnit>(FDataLogicVendorUnit.class, _logicContext));
      }else{
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FDataLogicVendorUnit> fetchAll(){
      // 生成命令
   ...
   // @return 数据单元
   //============================================================
   public FDataLogicVendorUnit doPrepare(){
      FDataLogicVendorUnit unit = new FDataLogicVendorUnit();
      unit.linkLogicContext(_logicContext);
      doPrepare(unit);
      return unit;
   }
   ...
   public EResult doPrepare(FLogicUnit logicUnit){
      FDataLogicVendorUnit unit = (FDataLogicVendorUnit)logicUnit;
      unit.setOvld(true);
   ...
   public EResult doInsert(FLogicUnit logicUnit){
      ...
      cmd.append(',');
      String homeUrl = unit.homeUrl();
      if(RString.isEmpty(homeUrl)){
         cmd.append("NULL");
      }else{
         cmd.append('\'');
         cmd.append(RSql.formatValue(homeUrl));
         cmd.append('\'');
      }
      cmd.append(',');
