      ...
      extends FLogicTable
{
   ...
   // 字段集合的定义。
   public final static String FIELDS = "`OUID`,`OVLD`,`GUID`,`USER_ID`,`PROJECT_ID`,`ANIMATION_ID`,`BONE_INDEX`,`TRACK_ID`,`CODE`,`LABEL`,`NOTE`,`CREATE_USER_ID`,`CREATE_DATE`,`UPDATE_USER_ID`,`UPDATE_DATE`";
