      ...
      extends FLogicTable
{
   ...
   // 字段骨头编号的定义。
   public final static SLogicFieldInfo BONE_ID = new SLogicFieldInfo("BONE_ID");
   ...
   // 字段集合的定义。
   public final static String FIELDS = "OUID,OVLD,GUID,ANIMATION_ID,BONE_ID,TRACK_ID,CODE,LABEL,NOTE,CREATE_USER_ID,CREATE_DATE,UPDATE_USER_ID,UPDATE_DATE";
