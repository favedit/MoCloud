...
//============================================================
@ASourceMachine
public class FDataSolutionProjectUnit
      extends FLogicUnit
{
   // 存储字段对象标识的定义。
   private long __ouid;
   ...
   // <T>构造方案项目信息逻辑单元。</T>
   //============================================================
   public FDataSolutionProjectUnit(){
   }
   ...
   //============================================================
   @Override
   public FDataSolutionProjectUnit clone(){
      FDataSolutionProjectUnit unit = RClass.newInstance(FDataSolutionProjectUnit.class);
      copy(unit);
      return unit;
   }
}
