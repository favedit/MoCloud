      ...
      extends FLogicUnit
{
   ...
   public void unserialize(IDataInput input){
      ...
      _sizeWidth = input.readInt32();
      _sizeHeight = input.readInt32();
   ...
   public void serialize(IDataOutput output){
      ...
      output.writeInt32(_sizeWidth);
      output.writeInt32(_sizeHeight);
   ...
   public void copy(FLogicUnit logicUnit){
      ...
      unit.setSizeWidth(_sizeWidth);
      unit.setSizeHeight(_sizeHeight);
      unit.setNote(_note);
   ...
   //============================================================
   @Override
   public FDataResourceBitmapUnit clone(){
      FDataResourceBitmapUnit unit = RClass.newInstance(FDataResourceBitmapUnit.class);
      copy(unit);
      return unit;
   }
}
