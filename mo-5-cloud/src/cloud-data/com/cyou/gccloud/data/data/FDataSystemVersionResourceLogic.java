...
//============================================================
@ASourceMachine
public class FDataSystemVersionResourceLogic extends FLogicTable
{
   // 方案项目信息的定义。
   public final static SLogicConnectionInfo CONNECTION = new SLogicConnectionInfo("data");

   // 方案项目信息的定义。
   public final static SLogicTableInfo TABLE = new SLogicTableInfo("data.system.version.resource", "DT_SYS_VERSION_RESOURCE");
   ...
   // 字段版本编号的定义。
   public final static SLogicFieldInfo VERSION_ID = new SLogicFieldInfo("VERSION_ID");

   // 字段代码的定义。
   public final static SLogicFieldInfo CODE = new SLogicFieldInfo("CODE");

   // 字段存储文件的定义。
   public final static SLogicFieldInfo STORAGE_FILE = new SLogicFieldInfo("STORAGE_FILE");
   ...
   // 字段指定存储地址的定义。
   public final static SLogicFieldInfo CUSTOM_STORAGE_FILE = new SLogicFieldInfo("CUSTOM_STORAGE_FILE");

   // 字段指定下载地址的定义。
   public final static SLogicFieldInfo CUSTOM_DOWNLOAD_URL = new SLogicFieldInfo("CUSTOM_DOWNLOAD_URL");
   ...
   // 字段集合的定义。
   public final static String FIELDS = "`OUID`,`OVLD`,`GUID`,`APPLICATION_ID`,`VERSION_ID`,`CODE`,`STORAGE_FILE`,`DOWNLOAD_URL`,`DOWNLOAD_SIZE`,`CUSTOM_STORAGE_FILE`,`CUSTOM_DOWNLOAD_URL`,`NOTE`,`CREATE_USER_ID`,`CREATE_DATE`,`UPDATE_USER_ID`,`UPDATE_DATE`";

   //============================================================
   // <T>构造方案项目信息逻辑单元。</T>
   //============================================================
   public FDataSystemVersionResourceLogic(){
      _name = TABLE.name();
      _classUnit = FDataSystemVersionResourceUnit.class;
   }
   ...
   // @param context 逻辑环境
   //============================================================
   public FDataSystemVersionResourceLogic(ILogicContext context){
      super(context);
      _name = TABLE.name();
      _classUnit = FDataSystemVersionResourceUnit.class;
   }
   ...
   public <T extends FLogicUnit> T find(T unit, Class<T> clazz, long recordId){
      ...
      if(unit == null){
         if(clazz == null){
            unit = (T)(new FDataSystemVersionResourceUnit());
         }else{
   ...
   // @return 数据单元
   //============================================================
   public FDataSystemVersionResourceUnit findByGuid(CharSequence guid){
      return findByGuid(null, FDataSystemVersionResourceUnit.class, guid);
   }
   ...
   // @return 数据单元
   //============================================================
   public FDataSystemVersionResourceUnit search(CharSequence whereSql){
      return search(null, FDataSystemVersionResourceUnit.class, whereSql);
   }
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FDataSystemVersionResourceUnit> fetch(CharSequence whereSql){
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FDataSystemVersionResourceUnit> fetch(int pageSize, int page){
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FDataSystemVersionResourceUnit> fetch(CharSequence whereSql, int pageSize, int page){
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FDataSystemVersionResourceUnit> fetch(CharSequence whereSql, CharSequence orderSql){
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FDataSystemVersionResourceUnit> fetch(CharSequence whereSql, CharSequence orderSql, int pageSize, int page){
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FDataSystemVersionResourceUnit> fetch(CharSequence fields, CharSequence whereSql, CharSequence orderSql, int pageSize, int page){
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FDataSystemVersionResourceUnit> fetch(CharSequence fields, CharSequence whereSql, CharSequence groupSql, CharSequence orderSql, int pageSize, int page){
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FDataSystemVersionResourceUnit> fetchSql(CharSequence code, CharSequence sql, int pageSize, int page){
   ...
   public <T extends FLogicUnit> FLogicDataset<T> fetchSql(Class<T> clazz, CharSequence code, CharSequence sql, int pageSize, int page){
      ...
      if(clazz == null){
         result = (FLogicDataset<T>)(new FLogicDataset<FDataSystemVersionResourceUnit>(FDataSystemVersionResourceUnit.class, _logicContext));
      }else{
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FDataSystemVersionResourceUnit> fetchAll(){
      // 生成命令
   ...
   // @return 数据单元
   //============================================================
   public FDataSystemVersionResourceUnit doPrepare(){
      FDataSystemVersionResourceUnit unit = new FDataSystemVersionResourceUnit();
      unit.linkLogicContext(_logicContext);
      doPrepare(unit);
      return unit;
   }
   ...
   public EResult doPrepare(FLogicUnit logicUnit){
      FDataSystemVersionResourceUnit unit = (FDataSystemVersionResourceUnit)logicUnit;
      unit.setOvld(true);
   ...
   public EResult doInsert(FLogicUnit logicUnit){
      ...
      cmd.append(",`CUSTOM_STORAGE_FILE`");
      cmd.append(",`CUSTOM_DOWNLOAD_URL`");
      cmd.append(",`NOTE`");
      ...
      cmd.append(',');
      long versionId = unit.versionId();
      if(versionId == 0){
         cmd.append("NULL");
      }else{
         cmd.append(versionId);
      }
      cmd.append(',');
      ...
      if(RString.isEmpty(storageFile)){
         cmd.append("NULL");
      }else{
         cmd.append('\'');
         cmd.append(RSql.formatValue(storageFile));
         cmd.append('\'');
      }
      cmd.append(',');
      ...
      cmd.append(',');
      String customStorageFile = unit.customStorageFile();
      if(RString.isEmpty(customStorageFile)){
         cmd.append("NULL");
      }else{
         cmd.append('\'');
         cmd.append(RSql.formatValue(customStorageFile));
         cmd.append('\'');
      }
      cmd.append(',');
      String customDownloadUrl = unit.customDownloadUrl();
      if(RString.isEmpty(customDownloadUrl)){
         cmd.append("NULL");
      }else{
         cmd.append('\'');
         cmd.append(RSql.formatValue(customDownloadUrl));
         cmd.append('\'');
      }
      cmd.append(',');
   ...
   public EResult doUpdate(FLogicUnit logicUnit,
      ...
      if(unit.isCustomStorageFileChanged()){
         cmd.append(",`CUSTOM_STORAGE_FILE`=");
         String customStorageFile = unit.customStorageFile();
         if(RString.isEmpty(customStorageFile)){
            cmd.append("NULL");
      ...
      if(unit.isCustomDownloadUrlChanged()){
         cmd.append(",`CUSTOM_DOWNLOAD_URL`=");
         String customDownloadUrl = unit.customDownloadUrl();
         if(RString.isEmpty(customDownloadUrl)){
            cmd.append("NULL");
