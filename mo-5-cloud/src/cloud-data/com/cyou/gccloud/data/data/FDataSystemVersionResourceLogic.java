      ...
      extends FLogicTable
{
   ...
   // 字段指定下载地址的定义。
   public final static SLogicFieldInfo DOWNLOAD_CUSTOM_URL = new SLogicFieldInfo("DOWNLOAD_CUSTOM_URL");
   ...
   // 字段集合的定义。
   public final static String FIELDS = "OUID,OVLD,GUID,PROJECT_ID,VERSION_ID,CODE,DOWNLOAD_URL,DOWNLOAD_SIZE,DOWNLOAD_CUSTOM_URL,NOTE,CREATE_USER_ID,CREATE_DATE,UPDATE_USER_ID,UPDATE_DATE";
   ...
   public EResult doInsert(FLogicUnit logicUnit){
      ...
      cmd.append(",`DOWNLOAD_CUSTOM_URL`");
      cmd.append(",`NOTE`");
      ...
      cmd.append(',');
      String downloadCustomUrl = unit.downloadCustomUrl();
      if(RString.isEmpty(downloadCustomUrl)){
         cmd.append("NULL");
      }else{
         cmd.append('\'');
         cmd.append(RSql.formatValue(downloadCustomUrl));
         cmd.append('\'');
      }
      cmd.append(',');
   ...
   public EResult doUpdate(FLogicUnit logicUnit,
      ...
      if(unit.isDownloadCustomUrlChanged()){
         cmd.append(",`DOWNLOAD_CUSTOM_URL`=");
         String downloadCustomUrl = unit.downloadCustomUrl();
         if(RString.isEmpty(downloadCustomUrl)){
            cmd.append("NULL");
