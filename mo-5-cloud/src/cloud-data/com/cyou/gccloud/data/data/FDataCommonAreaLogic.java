      ...
      extends FLogicTable
{
   ...
   // 字段集合的定义。
   public final static String FIELDS = "OUID,OVLD,GUID,COUNTRY_ID,CODE,LABEL,DISPLAY_CD,DISPLAY_ORDER,ICON_URL,NOTE,CREATE_USER_ID,CREATE_DATE,UPDATE_USER_ID,UPDATE_DATE";
