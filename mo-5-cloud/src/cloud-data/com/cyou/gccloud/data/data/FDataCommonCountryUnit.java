      ...
      extends FLogicUnit
{
   ...
   // 存储字段电话前置代码的定义。
   private String __phonePrefix;

   // 字段电话前置代码的定义。
   protected String _phonePrefix;
   ...
   // 存储字段排序值的定义。
   private int __displyOrder;

   // 字段排序值的定义。
   protected int _displyOrder;
   ...
   // @return 数据内容
   //============================================================
   public boolean isPhonePrefixChanged(){
      return !RString.equals(__phonePrefix, _phonePrefix);
   }
   ...
   // @return 数据内容
   //============================================================
   public boolean isDisplyOrderChanged(){
      return __displyOrder != _displyOrder;
   }
   ...
   // @param value 数据内容
   //============================================================
   public void setDisplyOrder(int value){
      _displyOrder = value;
   }
   ...
   public String get(String name){
      switch(name){
         ...
         case "disply_order":
            return RInteger.toString(_displyOrder);
         case "icon_url":
            return _iconUrl;
         case "note":
            return _note;
   ...
   public void set(String name,
      ...
      switch(name){
         ...
         case "display_cd":
            ...
            break;
         case "disply_order":
            _displyOrder = RInteger.parse(value);
            break;
         case "icon_url":
            _iconUrl = value;
            break;
      ...
      for(IStringPair pair : row){
         ...
         switch(name){
            ...
            case "display_cd":
               ...
               break;
            case "disply_order":
               __displyOrder = RInteger.parse(value);
               _displyOrder = __displyOrder;
               break;
            case "icon_url":
               __iconUrl = value;
               _iconUrl = __iconUrl;
   ...
   public void save(FRow row){
      ...
      row.set("phonePrefix", _phonePrefix);
      row.set("displayCd", _displayCd);
      row.set("displyOrder", _displyOrder);
   ...
   public void saveMap(Map<String, String> map){
      ...
      map.put("phonePrefix", _phonePrefix);
      map.put("displayCd", RInteger.toString(_displayCd));
      map.put("displyOrder", RInteger.toString(_displyOrder));
