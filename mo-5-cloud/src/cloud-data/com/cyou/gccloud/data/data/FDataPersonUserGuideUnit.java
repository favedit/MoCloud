...
//============================================================
@ASourceMachine
public class FDataPersonUserGuideUnit
      extends FLogicUnit
{
   // 存储字段对象标识的定义。
   private long __ouid;
   ...
   // 存储字段引导编号的定义。
   private long __guideId;

   // 字段引导编号的定义。
   protected long _guideId;
   ...
   // <T>构造用户引导表逻辑单元。</T>
   //============================================================
   public FDataPersonUserGuideUnit(){
   }
   ...
   // @return 数据内容
   //============================================================
   public boolean isGuideIdChanged(){
      return __guideId != _guideId;
   }
   ...
   // @return 数据内容
   //============================================================
   public FDataLogicGuideUnit guide(){
      FDataLogicGuideLogic logic = _logicContext.findLogic(FDataLogicGuideLogic.class);
      FDataLogicGuideUnit unit = logic.find(_guideId);
      return unit;
   }
   ...
   // @param value 数据内容
   //============================================================
   public void setGuideId(long value){
      _guideId = value;
   }
   ...
   public void saveMap(Map<String, String> map){
      ...
      map.put("guideId", RLong.toString(_guideId));
