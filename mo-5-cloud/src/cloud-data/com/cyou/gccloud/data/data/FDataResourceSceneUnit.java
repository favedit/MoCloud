...
//============================================================
@ASourceMachine
public class FDataResourceSceneUnit
      extends FLogicUnit
{
   // 存储字段对象标识的定义。
   private long __ouid;
   ...
   //============================================================
   @Override
   public FDataResourceSceneUnit clone(){
      FDataResourceSceneUnit unit = RClass.newInstance(FDataResourceSceneUnit.class);
      copy(unit);
      return unit;
   }
}
