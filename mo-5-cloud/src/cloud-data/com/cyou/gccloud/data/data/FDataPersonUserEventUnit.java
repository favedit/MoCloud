...
//============================================================
@ASourceMachine
public class FDataPersonUserEventUnit
      extends FLogicUnit
{
   // 存储字段对象标识的定义。
   private long __ouid;
   ...
   // <T>构造用户事件表逻辑单元。</T>
   //============================================================
   public FDataPersonUserEventUnit(){
   }
   ...
   // @return 数据内容
   //============================================================
   public boolean isEventIdChanged(){
      return __eventId != _eventId;
   }
   ...
   // @return 数据内容
   //============================================================
   public FDataLogicEventUnit event(){
      FDataLogicEventLogic logic = _logicContext.findLogic(FDataLogicEventLogic.class);
      FDataLogicEventUnit unit = logic.find(_eventId);
      return unit;
   }
   ...
   public void saveMap(Map<String, String> map){
      ...
      map.put("eventId", RLong.toString(_eventId));
