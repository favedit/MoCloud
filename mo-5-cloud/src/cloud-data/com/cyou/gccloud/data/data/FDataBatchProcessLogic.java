...
//============================================================
@ASourceMachine
public class FDataBatchProcessLogic extends FLogicTable
{
   // 后台处理信息的定义。
   ...
   // @return 数据单元
   //============================================================
   public FDataBatchProcessUnit findByGuid(CharSequence guid){
      return findByGuid(null, FDataBatchProcessUnit.class, guid);
   }
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FDataBatchProcessUnit> fetch(int pageSize, int page){
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FDataBatchProcessUnit> fetch(CharSequence whereSql, int pageSize, int page){
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FDataBatchProcessUnit> fetch(CharSequence whereSql, CharSequence orderSql){
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FDataBatchProcessUnit> fetch(CharSequence whereSql, CharSequence orderSql, int pageSize, int page){
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FDataBatchProcessUnit> fetch(CharSequence fields, CharSequence whereSql, CharSequence orderSql, int pageSize, int page){
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FDataBatchProcessUnit> fetch(CharSequence fields, CharSequence whereSql, CharSequence groupSql, CharSequence orderSql, int pageSize, int page){
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FDataBatchProcessUnit> fetchSql(CharSequence code, CharSequence sql, int pageSize, int page){
