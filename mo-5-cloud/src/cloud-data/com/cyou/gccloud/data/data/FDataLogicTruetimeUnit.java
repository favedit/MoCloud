...
//============================================================
@ASourceMachine
public class FDataLogicTruetimeUnit
      extends FLogicUnit
{
   // 存储字段对象标识的定义。
   private long __ouid;
   ...
   //============================================================
   @Override
   public FDataLogicTruetimeUnit clone(){
      FDataLogicTruetimeUnit unit = RClass.newInstance(FDataLogicTruetimeUnit.class);
      copy(unit);
      return unit;
   }
}
