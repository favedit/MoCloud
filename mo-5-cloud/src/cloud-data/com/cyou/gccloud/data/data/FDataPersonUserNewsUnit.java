...
//============================================================
@ASourceMachine
public class FDataPersonUserNewsUnit
      extends FLogicUnit
{
   // 存储字段对象标识的定义。
   private long __ouid;
   ...
   // <T>构造人员新闻访问逻辑单元。</T>
   //============================================================
   public FDataPersonUserNewsUnit(){
   }
   ...
   //============================================================
   @Override
   public FDataPersonUserNewsUnit clone(){
      FDataPersonUserNewsUnit unit = RClass.newInstance(FDataPersonUserNewsUnit.class);
      copy(unit);
      return unit;
   }
}
