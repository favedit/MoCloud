...
//============================================================
@ASourceMachine
public class FDataPersonUserRelationLogic
      extends FLogicTable
{
   // 用户关系表的定义。
   ...
   // 用户关系表的定义。
   public final static SLogicTableInfo TABLE = new SLogicTableInfo("data.person.user.relation", "DT_PSN_USER_RELATION");
   ...
   // 字段应用编号的定义。
   public final static SLogicFieldInfo RELATION_USER_ID = new SLogicFieldInfo("RELATION_USER_ID");
   ...
   // 字段集合的定义。
   public final static String FIELDS = "OUID,OVLD,GUID,USER_ID,RELATION_CD,RELATION_USER_ID,CREATE_USER_ID,CREATE_DATE,UPDATE_USER_ID,UPDATE_DATE";

   //============================================================
   // <T>构造用户关系表逻辑单元。</T>
   //============================================================
   public FDataPersonUserRelationLogic(){
      _name = TABLE.name();
      _classUnit = FDataPersonUserRelationUnit.class;
   }
   ...
   // @param context 逻辑环境
   //============================================================
   public FDataPersonUserRelationLogic(ILogicContext context){
      super(context);
      _name = TABLE.name();
      _classUnit = FDataPersonUserRelationUnit.class;
   }
   ...
   public <T extends FLogicUnit> T find(T unit,
      ...
      if(unit == null){
         if(clazz == null){
            unit = (T)(new FDataPersonUserRelationUnit());
         }else{
   ...
   // @return 数据单元
   //============================================================
   public FDataPersonUserRelationUnit search(CharSequence whereSql){
      return search(null, FDataPersonUserRelationUnit.class, whereSql);
   }
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FDataPersonUserRelationUnit> fetch(int pageSize,
                                                           int page){
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FDataPersonUserRelationUnit> fetch(CharSequence whereSql,
                                                           int pageSize,
                                                           int page){
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FDataPersonUserRelationUnit> fetch(CharSequence fields,
                                                           CharSequence whereSql,
                                                           CharSequence orderSql,
                                                           int pageSize,
                                                           int page){
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FDataPersonUserRelationUnit> fetchSql(CharSequence code,
                                                              CharSequence sql,
                                                              int pageSize,
                                                              int page){
   ...
   public <T extends FLogicUnit> FLogicDataset<T> fetchSql(Class<T> clazz,
      ...
      if(clazz == null){
         result = (FLogicDataset<T>)(new FLogicDataset<FDataPersonUserRelationUnit>(FDataPersonUserRelationUnit.class, _logicContext));
      }else{
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FDataPersonUserRelationUnit> fetchAll(){
      // 生成命令
   ...
   // @return 数据单元
   //============================================================
   public FDataPersonUserRelationUnit doPrepare(){
      FDataPersonUserRelationUnit unit = new FDataPersonUserRelationUnit();
      unit.linkLogicContext(_logicContext);
      doPrepare(unit);
      return unit;
   }
   ...
   public EResult doPrepare(FLogicUnit logicUnit){
      FDataPersonUserRelationUnit unit = (FDataPersonUserRelationUnit)logicUnit;
      unit.setOvld(true);
   ...
   public EResult doInsert(FLogicUnit logicUnit){
      ...
      cmd.append(',');
      long relationUserId = unit.relationUserId();
      if(relationUserId == 0){
         cmd.append("NULL");
      }else{
         cmd.append(relationUserId);
      }
      // 设置更新信息
   ...
   public EResult doUpdate(FLogicUnit logicUnit,
      ...
      if(unit.isRelationUserIdChanged()){
         cmd.append(",`RELATION_USER_ID`=");
         long relationUserId = unit.relationUserId();
         if(relationUserId == 0){
            cmd.append("NULL");
