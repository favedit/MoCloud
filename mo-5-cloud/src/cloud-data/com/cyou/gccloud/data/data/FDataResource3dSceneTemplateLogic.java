...
//============================================================
@ASourceMachine
public class FDataResource3dSceneTemplateLogic
      extends FLogicTable
{
   // 资源3D模板表的定义。
   ...
   // 资源3D模板表的定义。
   public final static SLogicTableInfo TABLE = new SLogicTableInfo("data.resource3d.scene.template", "DT_RS3_TEMPLATE");
   ...
   // <T>构造资源3D模板表逻辑单元。</T>
   //============================================================
   public FDataResource3dSceneTemplateLogic(){
      _name = TABLE.name();
      _classUnit = FDataResource3dSceneTemplateUnit.class;
   }
   ...
   // @param context 逻辑环境
   //============================================================
   public FDataResource3dSceneTemplateLogic(ILogicContext context){
      super(context);
      _name = TABLE.name();
      _classUnit = FDataResource3dSceneTemplateUnit.class;
   }
   ...
   public <T extends FLogicUnit> T find(T unit,
      ...
      if(unit == null){
         if(clazz == null){
            unit = (T)(new FDataResource3dSceneTemplateUnit());
         }else{
   ...
   // @return 数据单元
   //============================================================
   public FDataResource3dSceneTemplateUnit findByGuid(CharSequence guid){
      return findByGuid(null, FDataResource3dSceneTemplateUnit.class, guid);
   }
   ...
   // @return 数据单元
   //============================================================
   public FDataResource3dSceneTemplateUnit search(CharSequence whereSql){
      return search(null, FDataResource3dSceneTemplateUnit.class, whereSql);
   }
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FDataResource3dSceneTemplateUnit> fetch(CharSequence whereSql){
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FDataResource3dSceneTemplateUnit> fetch(int pageSize,
                                                                int page){
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FDataResource3dSceneTemplateUnit> fetch(CharSequence fields,
                                                                CharSequence whereSql,
                                                                CharSequence orderSql,
                                                                int pageSize,
                                                                int page){
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FDataResource3dSceneTemplateUnit> fetchSql(CharSequence code,
                                                                   CharSequence sql,
                                                                   int pageSize,
                                                                   int page){
   ...
   public <T extends FLogicUnit> FLogicDataset<T> fetchSql(Class<T> clazz,
      ...
      if(clazz == null){
         result = (FLogicDataset<T>)(new FLogicDataset<FDataResource3dSceneTemplateUnit>(FDataResource3dSceneTemplateUnit.class, _logicContext));
      }else{
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FDataResource3dSceneTemplateUnit> fetchAll(){
      // 生成命令
   ...
   // @return 数据单元
   //============================================================
   public FDataResource3dSceneTemplateUnit doPrepare(){
      FDataResource3dSceneTemplateUnit unit = new FDataResource3dSceneTemplateUnit();
      unit.linkLogicContext(_logicContext);
      doPrepare(unit);
      return unit;
   }
   ...
   public EResult doPrepare(FLogicUnit logicUnit){
      FDataResource3dSceneTemplateUnit unit = (FDataResource3dSceneTemplateUnit)logicUnit;
      unit.setOvld(true);
