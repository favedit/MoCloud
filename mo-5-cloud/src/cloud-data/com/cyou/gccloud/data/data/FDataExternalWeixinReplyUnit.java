...
//============================================================
@ASourceMachine
public class FDataExternalWeixinReplyUnit
      extends FLogicUnit
{
   // 存储字段对象标识的定义。
   private long __ouid;
   ...
   // 存储字段回复类型的定义。
   private int __replayCd;

   // 字段回复类型的定义。
   protected int _replayCd;
   ...
   // <T>构造微信回复表逻辑单元。</T>
   //============================================================
   public FDataExternalWeixinReplyUnit(){
   }
   ...
   // @return 数据内容
   //============================================================
   public boolean isReplayCdChanged(){
      return __replayCd != _replayCd;
   }
   ...
   // @param value 数据内容
   //============================================================
   public void setReplayCd(int value){
      _replayCd = value;
   }
   ...
   public String get(String name){
      switch(name){
         ...
         case "icon_url":
            return _iconUrl;
         case "replay_cd":
            return RInteger.toString(_replayCd);
         case "news_id":
   ...
   public void set(String name,
      ...
      switch(name){
         ...
         case "icon_url":
            ...
            break;
         case "replay_cd":
            _replayCd = RInteger.parse(value);
            break;
         case "news_id":
      ...
      for(IStringPair pair : row){
         ...
         switch(name){
            ...
            case "icon_url":
               ...
               break;
            case "replay_cd":
               __replayCd = RInteger.parse(value);
               _replayCd = __replayCd;
               break;
            case "news_id":
   ...
   public void saveMap(Map<String, String> map){
      ...
      map.put("replayCd", RInteger.toString(_replayCd));
