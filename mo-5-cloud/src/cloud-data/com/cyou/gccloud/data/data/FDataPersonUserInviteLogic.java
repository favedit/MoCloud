...
//============================================================
@ASourceMachine
public class FDataPersonUserInviteLogic
      extends FLogicTable
{
   // 用户邀请表的定义。
   ...
   // 用户邀请表的定义。
   public final static SLogicTableInfo TABLE = new SLogicTableInfo("data.person.user.invite", "DT_PSN_USER_INVITE");
   ...
   // 字段邀请编号的定义。
   public final static SLogicFieldInfo INVITE_ID = new SLogicFieldInfo("INVITE_ID");

   // 字段邀请用户编号的定义。
   public final static SLogicFieldInfo INVITE_USER_ID = new SLogicFieldInfo("INVITE_USER_ID");
   ...
   // 字段集合的定义。
   public final static String FIELDS = "OUID,OVLD,GUID,USER_ID,PROJECT_ID,INVITE_ID,INVITE_USER_ID,STATUS_CD,CREATE_USER_ID,CREATE_DATE,UPDATE_USER_ID,UPDATE_DATE";

   //============================================================
   // <T>构造用户邀请表逻辑单元。</T>
   //============================================================
   public FDataPersonUserInviteLogic(){
      _name = TABLE.name();
      _classUnit = FDataPersonUserInviteUnit.class;
   }
   ...
   // @param context 逻辑环境
   //============================================================
   public FDataPersonUserInviteLogic(ILogicContext context){
      super(context);
      _name = TABLE.name();
      _classUnit = FDataPersonUserInviteUnit.class;
   }
   ...
   public <T extends FLogicUnit> T find(T unit,
      ...
      if(unit == null){
         if(clazz == null){
            unit = (T)(new FDataPersonUserInviteUnit());
         }else{
   ...
   // @return 数据单元
   //============================================================
   public FDataPersonUserInviteUnit search(CharSequence whereSql){
      return search(null, FDataPersonUserInviteUnit.class, whereSql);
   }
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FDataPersonUserInviteUnit> fetch(int pageSize,
                                                         int page){
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FDataPersonUserInviteUnit> fetch(CharSequence whereSql,
                                                         int pageSize,
                                                         int page){
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FDataPersonUserInviteUnit> fetch(CharSequence fields,
                                                         CharSequence whereSql,
                                                         CharSequence orderSql,
                                                         int pageSize,
                                                         int page){
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FDataPersonUserInviteUnit> fetchSql(CharSequence code,
                                                            CharSequence sql,
                                                            int pageSize,
                                                            int page){
   ...
   public <T extends FLogicUnit> FLogicDataset<T> fetchSql(Class<T> clazz,
      ...
      if(clazz == null){
         result = (FLogicDataset<T>)(new FLogicDataset<FDataPersonUserInviteUnit>(FDataPersonUserInviteUnit.class, _logicContext));
      }else{
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FDataPersonUserInviteUnit> fetchAll(){
      // 生成命令
   ...
   // @return 数据单元
   //============================================================
   public FDataPersonUserInviteUnit doPrepare(){
      FDataPersonUserInviteUnit unit = new FDataPersonUserInviteUnit();
      unit.linkLogicContext(_logicContext);
      doPrepare(unit);
      return unit;
   }
   ...
   public EResult doPrepare(FLogicUnit logicUnit){
      FDataPersonUserInviteUnit unit = (FDataPersonUserInviteUnit)logicUnit;
      unit.setOvld(true);
   ...
   public EResult doInsert(FLogicUnit logicUnit){
      ...
      cmd.append(",`INVITE_ID`");
      cmd.append(",`INVITE_USER_ID`");
      ...
      cmd.append(',');
      long inviteUserId = unit.inviteUserId();
      if(inviteUserId == 0){
         cmd.append("NULL");
      }else{
         cmd.append(inviteUserId);
      }
      cmd.append(',');
