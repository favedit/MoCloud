      ...
      extends FLogicTable
{
   ...
   // 字段电话前置代码的定义。
   public final static SLogicFieldInfo PHONE_PREFIX = new SLogicFieldInfo("PHONE_PREFIX");

   // 字段显示方式的定义。
   public final static SLogicFieldInfo DISPLAY_CD = new SLogicFieldInfo("DISPLAY_CD");

   // 字段排序值的定义。
   public final static SLogicFieldInfo DISPLY_ORDER = new SLogicFieldInfo("DISPLY_ORDER");
   ...
   // 字段集合的定义。
   public final static String FIELDS = "OUID,OVLD,GUID,CODE,NAME,LABEL,PHONE_PREFIX,DISPLAY_CD,DISPLY_ORDER,ICON_URL,NOTE,CREATE_USER_ID,CREATE_DATE,UPDATE_USER_ID,UPDATE_DATE";
   ...
   public EResult doInsert(FLogicUnit logicUnit){
      ...
      cmd.append(',');
      String phonePrefix = unit.phonePrefix();
      if(RString.isEmpty(phonePrefix)){
         cmd.append("NULL");
      }else{
         cmd.append('\'');
         cmd.append(RSql.formatValue(phonePrefix));
         cmd.append('\'');
      }
      cmd.append(',');
      cmd.append(unit.displayCd());
      cmd.append(',');
      cmd.append(unit.displyOrder());
      cmd.append(',');
