...
//============================================================
@ASourceMachine
public class FDataCommonCityLogic
      extends FLogicTable
{
   // 共通城市表的定义。
   ...
   // 字段集合的定义。
   public final static String FIELDS = "OUID,OVLD,GUID,COUNTRY_ID,AREA_ID,PROVINCE_ID,CODE,LABEL,DISPLAY_CD,DISPLAY_ORDER,ICON_URL,NOTE,CREATE_USER_ID,CREATE_DATE,UPDATE_USER_ID,UPDATE_DATE";
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FDataCommonCityUnit> fetch(int pageSize,
                                                   int page){
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FDataCommonCityUnit> fetch(CharSequence fields,
                                                   CharSequence whereSql,
                                                   CharSequence orderSql,
                                                   int pageSize,
                                                   int page){
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FDataCommonCityUnit> fetchSql(CharSequence code,
                                                      CharSequence sql,
                                                      int pageSize,
                                                      int page){
