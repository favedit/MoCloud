...
//============================================================
@ASourceMachine
public class FDataSystemProjectLogic
      extends FLogicTable
{
   // 系统项目表的定义。
   ...
   // 系统项目表的定义。
   public final static SLogicTableInfo TABLE = new SLogicTableInfo("data.system.project", "DT_SYS_PROJECT");
   ...
   // <T>构造系统项目表逻辑单元。</T>
   //============================================================
   public FDataSystemProjectLogic(){
      _name = TABLE.name();
      _classUnit = FDataSystemProjectUnit.class;
   }
   ...
   // @param context 逻辑环境
   //============================================================
   public FDataSystemProjectLogic(ILogicContext context){
      super(context);
      _name = TABLE.name();
      _classUnit = FDataSystemProjectUnit.class;
   }
   ...
   public <T extends FLogicUnit> T find(T unit,
      ...
      if(unit == null){
         if(clazz == null){
            unit = (T)(new FDataSystemProjectUnit());
         }else{
   ...
   // @return 数据单元
   //============================================================
   public FDataSystemProjectUnit search(CharSequence whereSql){
      return search(null, FDataSystemProjectUnit.class, whereSql);
   }
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FDataSystemProjectUnit> fetch(int pageSize,
                                                      int page){
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FDataSystemProjectUnit> fetch(CharSequence whereSql,
                                                      int pageSize,
                                                      int page){
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FDataSystemProjectUnit> fetch(CharSequence fields,
                                                      CharSequence whereSql,
                                                      CharSequence orderSql,
                                                      int pageSize,
                                                      int page){
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FDataSystemProjectUnit> fetchSql(CharSequence code,
                                                         CharSequence sql,
                                                         int pageSize,
                                                         int page){
   ...
   public <T extends FLogicUnit> FLogicDataset<T> fetchSql(Class<T> clazz,
      ...
      if(clazz == null){
         result = (FLogicDataset<T>)(new FLogicDataset<FDataSystemProjectUnit>(FDataSystemProjectUnit.class, _logicContext));
      }else{
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FDataSystemProjectUnit> fetchAll(){
      // 生成命令
   ...
   // @return 数据单元
   //============================================================
   public FDataSystemProjectUnit doPrepare(){
      FDataSystemProjectUnit unit = new FDataSystemProjectUnit();
      unit.linkLogicContext(_logicContext);
      doPrepare(unit);
      return unit;
   }
   ...
   public EResult doPrepare(FLogicUnit logicUnit){
      FDataSystemProjectUnit unit = (FDataSystemProjectUnit)logicUnit;
      unit.setOvld(true);
