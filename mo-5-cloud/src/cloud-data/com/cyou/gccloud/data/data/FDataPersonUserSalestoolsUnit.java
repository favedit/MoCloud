...
//============================================================
@ASourceMachine
public class FDataPersonUserSalestoolsUnit extends FLogicUnit
{
   // 存储字段对象标识的定义。
   private long __ouid;
   ...
   // 存储字段销售工具编号的定义。
   private long __salestoolsId;

   // 字段销售工具编号的定义。
   protected long _salestoolsId;
   ...
   // <T>构造人员销售工具访问逻辑单元。</T>
   //============================================================
   public FDataPersonUserSalestoolsUnit(){
   }
   ...
   // @return 数据内容
   //============================================================
   public boolean isSalestoolsIdChanged(){
      return __salestoolsId != _salestoolsId;
   }
   ...
   // @return 数据内容
   //============================================================
   public long salestoolsId(){
      return _salestoolsId;
   }
   ...
   // @return 数据内容
   //============================================================
   public FDataLogicSalestoolsUnit salestools(){
      FDataLogicSalestoolsLogic logic = _logicContext.findLogic(FDataLogicSalestoolsLogic.class);
      FDataLogicSalestoolsUnit unit = logic.find(_salestoolsId);
      return unit;
   }
   ...
   // @param value 数据内容
   //============================================================
   public void setSalestoolsId(long value){
      _salestoolsId = value;
   }
   ...
   public String get(String name){
      switch(name){
         ...
         case "salestools_id":
            return Long.toString(_salestoolsId);
         case "active_cd":
   ...
   public void set(String name,
      ...
      switch(name){
         ...
         case "user_id":
            ...
            break;
         case "salestools_id":
            _salestoolsId = RLong.parse(value);
            break;
         case "active_cd":
      ...
      for(IStringPair pair : row){
         ...
         switch(name){
            ...
            case "user_id":
               ...
               break;
            case "salestools_id":
               __salestoolsId = RLong.parse(value);
               _salestoolsId = __salestoolsId;
               break;
            case "active_cd":
   ...
   public void save(FRow row){
      ...
      row.set("salestoolsId", _salestoolsId);
   ...
   public void saveMap(Map<String, String> map){
      ...
      map.put("salestoolsId", RLong.toString(_salestoolsId));
   ...
   public void serialize(IDataOutput output){
      ...
      output.writeInt64(_salestoolsId);
   ...
   public void copy(FLogicUnit logicUnit){
      ...
      unit.setSalestoolsId(_salestoolsId);
      unit.setActiveCd(_activeCd);
      unit.activeDate().assign(_activeDate);
      unit.setNote(_note);
   ...
   //============================================================
   @Override
   public FDataPersonUserSalestoolsUnit clone(){
      FDataPersonUserSalestoolsUnit unit = RClass.newInstance(FDataPersonUserSalestoolsUnit.class);
      copy(unit);
      return unit;
   }
}
