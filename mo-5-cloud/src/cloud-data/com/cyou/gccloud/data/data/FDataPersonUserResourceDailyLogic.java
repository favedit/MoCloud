...
//============================================================
@ASourceMachine
public class FDataPersonUserResourceDailyLogic
      extends FLogicTable
{
   // 用户资源日常表的定义。
   ...
   // 用户资源日常表的定义。
   public final static SLogicTableInfo TABLE = new SLogicTableInfo("data.person.user.resource.daily", "DT_PSN_USER_RESOURCE_DAILY");
   ...
   // 字段是否点赞的定义。
   public final static SLogicFieldInfo PARISE_CD = new SLogicFieldInfo("PARISE_CD");

   // 字段是否投票的定义。
   public final static SLogicFieldInfo VOTE_CD = new SLogicFieldInfo("VOTE_CD");
   ...
   // 字段集合的定义。
   public final static String FIELDS = "OUID,OVLD,GUID,USER_ID,RESOURCE_CD,RESOURCE_ID,RECORD_DATE,PARISE_CD,VOTE_CD,SCORE_BEAN,SCORE_POINT,SCORE_GOLD,CREATE_USER_ID,CREATE_DATE,UPDATE_USER_ID,UPDATE_DATE";

   //============================================================
   // <T>构造用户资源日常表逻辑单元。</T>
   //============================================================
   public FDataPersonUserResourceDailyLogic(){
      _name = TABLE.name();
      _classUnit = FDataPersonUserResourceDailyUnit.class;
   }
   ...
   // @param context 逻辑环境
   //============================================================
   public FDataPersonUserResourceDailyLogic(ILogicContext context){
      super(context);
      _name = TABLE.name();
      _classUnit = FDataPersonUserResourceDailyUnit.class;
   }
   ...
   public <T extends FLogicUnit> T find(T unit,
      ...
      if(unit == null){
         if(clazz == null){
            unit = (T)(new FDataPersonUserResourceDailyUnit());
         }else{
   ...
   // @return 数据单元
   //============================================================
   public FDataPersonUserResourceDailyUnit search(CharSequence whereSql){
      return search(null, FDataPersonUserResourceDailyUnit.class, whereSql);
   }
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FDataPersonUserResourceDailyUnit> fetch(int pageSize,
                                                                int page){
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FDataPersonUserResourceDailyUnit> fetch(CharSequence whereSql,
                                                                int pageSize,
                                                                int page){
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FDataPersonUserResourceDailyUnit> fetch(CharSequence fields,
                                                                CharSequence whereSql,
                                                                CharSequence orderSql,
                                                                int pageSize,
                                                                int page){
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FDataPersonUserResourceDailyUnit> fetchSql(CharSequence code,
                                                                   CharSequence sql,
                                                                   int pageSize,
                                                                   int page){
   ...
   public <T extends FLogicUnit> FLogicDataset<T> fetchSql(Class<T> clazz,
      ...
      if(clazz == null){
         result = (FLogicDataset<T>)(new FLogicDataset<FDataPersonUserResourceDailyUnit>(FDataPersonUserResourceDailyUnit.class, _logicContext));
      }else{
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FDataPersonUserResourceDailyUnit> fetchAll(){
      // 生成命令
   ...
   // @return 数据单元
   //============================================================
   public FDataPersonUserResourceDailyUnit doPrepare(){
      FDataPersonUserResourceDailyUnit unit = new FDataPersonUserResourceDailyUnit();
      unit.linkLogicContext(_logicContext);
      doPrepare(unit);
      return unit;
   }
   ...
   public EResult doPrepare(FLogicUnit logicUnit){
      FDataPersonUserResourceDailyUnit unit = (FDataPersonUserResourceDailyUnit)logicUnit;
      unit.setOvld(true);
   ...
   public EResult doInsert(FLogicUnit logicUnit){
      ...
      cmd.append(',');
      cmd.append(unit.pariseCd());
      cmd.append(',');
      cmd.append(unit.voteCd());
      cmd.append(',');
   ...
   public EResult doUpdate(FLogicUnit logicUnit,
      ...
      if(unit.isPariseCdChanged()){
         cmd.append(",`PARISE_CD`=");
         cmd.append(unit.pariseCd());
      }
      if(unit.isVoteCdChanged()){
         cmd.append(",`VOTE_CD`=");
         cmd.append(unit.voteCd());
      }
