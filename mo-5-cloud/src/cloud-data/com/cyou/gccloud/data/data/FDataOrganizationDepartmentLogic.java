...
//============================================================
@ASourceMachine
public class FDataOrganizationDepartmentLogic
      extends FLogicTable
{
   // 组织部门的定义。
   ...
   // 组织部门的定义。
   public final static SLogicTableInfo TABLE = new SLogicTableInfo("data.organization.department", "DT_ORG_DEPARTMENT");
   ...
   // 字段是否有效的定义。
   public final static SLogicFieldInfo VALID_CD = new SLogicFieldInfo("VALID_CD");

   // 字段父编号的定义。
   public final static SLogicFieldInfo PARENT_ID = new SLogicFieldInfo("PARENT_ID");

   // 字段当前路径的定义。
   public final static SLogicFieldInfo PATH_IDS = new SLogicFieldInfo("PATH_IDS");

   // 字段当前的所有父名称的定义。
   public final static SLogicFieldInfo PATH_LABELS = new SLogicFieldInfo("PATH_LABELS");

   // 字段总人数的定义。
   public final static SLogicFieldInfo USER_COUNT = new SLogicFieldInfo("USER_COUNT");
   ...
   // 字段集合的定义。
   public final static String FIELDS = "`OUID`,`OVLD`,`GUID`,`CODE`,`NAME`,`LABEL`,`ICON_URL`,`VALID_CD`,`PARENT_ID`,`PATH_IDS`,`PATH_LABELS`,`USER_COUNT`,`BUILD_DATE`,`DESCRIPTION`,`NOTE`,`CREATE_USER_ID`,`CREATE_DATE`,`UPDATE_USER_ID`,`UPDATE_DATE`";

   //============================================================
   // <T>构造组织部门逻辑单元。</T>
   //============================================================
   public FDataOrganizationDepartmentLogic(){
      _name = TABLE.name();
      _classUnit = FDataOrganizationDepartmentUnit.class;
   }
   ...
   // @param context 逻辑环境
   //============================================================
   public FDataOrganizationDepartmentLogic(ILogicContext context){
      super(context);
      _name = TABLE.name();
      _classUnit = FDataOrganizationDepartmentUnit.class;
   }
   ...
   public <T extends FLogicUnit> T find(T unit,
      ...
      if(unit == null){
         if(clazz == null){
            unit = (T)(new FDataOrganizationDepartmentUnit());
         }else{
   ...
   // @return 数据单元
   //============================================================
   public FDataOrganizationDepartmentUnit findByGuid(CharSequence guid){
      return findByGuid(null, FDataOrganizationDepartmentUnit.class, guid);
   }
   ...
   // @return 数据单元
   //============================================================
   public FDataOrganizationDepartmentUnit search(CharSequence whereSql){
      return search(null, FDataOrganizationDepartmentUnit.class, whereSql);
   }
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FDataOrganizationDepartmentUnit> fetch(CharSequence whereSql){
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FDataOrganizationDepartmentUnit> fetch(int pageSize,
                                                               int page){
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FDataOrganizationDepartmentUnit> fetch(CharSequence fields,
                                                               CharSequence whereSql,
                                                               CharSequence orderSql,
                                                               int pageSize,
                                                               int page){
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FDataOrganizationDepartmentUnit> fetchSql(CharSequence code,
                                                                  CharSequence sql,
                                                                  int pageSize,
                                                                  int page){
   ...
   public <T extends FLogicUnit> FLogicDataset<T> fetchSql(Class<T> clazz,
      ...
      if(clazz == null){
         result = (FLogicDataset<T>)(new FLogicDataset<FDataOrganizationDepartmentUnit>(FDataOrganizationDepartmentUnit.class, _logicContext));
      }else{
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FDataOrganizationDepartmentUnit> fetchAll(){
      // 生成命令
   ...
   // @return 数据单元
   //============================================================
   public FDataOrganizationDepartmentUnit doPrepare(){
      FDataOrganizationDepartmentUnit unit = new FDataOrganizationDepartmentUnit();
      unit.linkLogicContext(_logicContext);
      doPrepare(unit);
      return unit;
   }
   ...
   public EResult doInsert(FLogicUnit logicUnit){
      ...
      cmd.append(",`PATH_IDS`");
      cmd.append(",`PATH_LABELS`");
      cmd.append(",`USER_COUNT`");
      ...
      cmd.append(',');
      String pathIds = unit.pathIds();
      if(RString.isEmpty(pathIds)){
         cmd.append("NULL");
      }else{
         cmd.append('\'');
         cmd.append(RSql.formatValue(pathIds));
         cmd.append('\'');
      }
      cmd.append(',');
      String pathLabels = unit.pathLabels();
      if(RString.isEmpty(pathLabels)){
         cmd.append("NULL");
      }else{
         cmd.append('\'');
         cmd.append(RSql.formatValue(pathLabels));
         cmd.append('\'');
      }
      cmd.append(',');
      cmd.append(unit.userCount());
      cmd.append(',');
