      ...
      extends FLogicUnit
{
   ...
   public void copy(FLogicUnit logicUnit){
      ...
      unit.lastMessageDate().assign(_lastMessageDate);
   ...
   //============================================================
   @Override
   public FDataFinancialCustomerUnit clone(){
      FDataFinancialCustomerUnit unit = RClass.newInstance(FDataFinancialCustomerUnit.class);
      copy(unit);
      return unit;
   }
}
