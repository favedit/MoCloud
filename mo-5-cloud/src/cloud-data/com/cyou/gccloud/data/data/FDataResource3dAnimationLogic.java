...
//============================================================
@ASourceMachine
public class FDataResource3dAnimationLogic
      extends FLogicTable
{
   // 资源3D动画表的定义。
   ...
   // 资源3D动画表的定义。
   public final static SLogicTableInfo TABLE = new SLogicTableInfo("data.resource3d.animation", "DT_RS3_ANIMATION");
   ...
   // <T>构造资源3D动画表逻辑单元。</T>
   //============================================================
   public FDataResource3dAnimationLogic(){
      _name = TABLE.name();
      _classUnit = FDataResource3dAnimationUnit.class;
   }
   ...
   // @param context 逻辑环境
   //============================================================
   public FDataResource3dAnimationLogic(ILogicContext context){
      super(context);
      _name = TABLE.name();
      _classUnit = FDataResource3dAnimationUnit.class;
   }
   ...
   public <T extends FLogicUnit> T find(T unit,
      ...
      if(unit == null){
         if(clazz == null){
            unit = (T)(new FDataResource3dAnimationUnit());
         }else{
   ...
   // @return 数据单元
   //============================================================
   public FDataResource3dAnimationUnit findByGuid(CharSequence guid){
      return findByGuid(null, FDataResource3dAnimationUnit.class, guid);
   }
   ...
   // @return 数据单元
   //============================================================
   public FDataResource3dAnimationUnit search(CharSequence whereSql){
      return search(null, FDataResource3dAnimationUnit.class, whereSql);
   }
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FDataResource3dAnimationUnit> fetch(int pageSize,
                                                            int page){
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FDataResource3dAnimationUnit> fetch(CharSequence fields,
                                                            CharSequence whereSql,
                                                            CharSequence orderSql,
                                                            int pageSize,
                                                            int page){
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FDataResource3dAnimationUnit> fetchSql(CharSequence code,
                                                               CharSequence sql,
                                                               int pageSize,
                                                               int page){
   ...
   public <T extends FLogicUnit> FLogicDataset<T> fetchSql(Class<T> clazz,
      ...
      if(clazz == null){
         result = (FLogicDataset<T>)(new FLogicDataset<FDataResource3dAnimationUnit>(FDataResource3dAnimationUnit.class, _logicContext));
      }else{
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FDataResource3dAnimationUnit> fetchAll(){
      // 生成命令
   ...
   // @return 数据单元
   //============================================================
   public FDataResource3dAnimationUnit doPrepare(){
      FDataResource3dAnimationUnit unit = new FDataResource3dAnimationUnit();
      unit.linkLogicContext(_logicContext);
      doPrepare(unit);
      return unit;
   }
   ...
   public EResult doPrepare(FLogicUnit logicUnit){
      FDataResource3dAnimationUnit unit = (FDataResource3dAnimationUnit)logicUnit;
      unit.setOvld(true);
