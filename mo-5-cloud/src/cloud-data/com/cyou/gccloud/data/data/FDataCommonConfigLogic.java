...
//============================================================
@ASourceMachine
public class FDataCommonConfigLogic
      extends FLogicTable
{
   // 共通配置表的定义。
   ...
   // 共通配置表的定义。
   public final static SLogicTableInfo TABLE = new SLogicTableInfo("data.common.config", "DT_COM_CONFIG");
   ...
   // 字段参数的定义。
   public final static SLogicFieldInfo PARAMETER = new SLogicFieldInfo("PARAMETER");
   ...
   // 字段集合的定义。
   public final static String FIELDS = "OUID,OVLD,GUID,CODE,LABEL,PARAMETER,NOTE,CREATE_USER_ID,CREATE_DATE,UPDATE_USER_ID,UPDATE_DATE";

   //============================================================
   // <T>构造共通配置表逻辑单元。</T>
   //============================================================
   public FDataCommonConfigLogic(){
      _name = TABLE.name();
      _classUnit = FDataCommonConfigUnit.class;
      _timeout = 3600 * 1000;
   }
   ...
   // @param context 逻辑环境
   //============================================================
   public FDataCommonConfigLogic(ILogicContext context){
      super(context);
      _name = TABLE.name();
      _classUnit = FDataCommonConfigUnit.class;
      _timeout = 3600 * 1000;
   ...
   public <T extends FLogicUnit> T find(T unit,
      ...
      if(unit == null){
         if(clazz == null){
            unit = (T)(new FDataCommonConfigUnit());
         }else{
   ...
   // @return 数据单元
   //============================================================
   public FDataCommonConfigUnit search(CharSequence whereSql){
      return search(null, FDataCommonConfigUnit.class, whereSql);
   }
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FDataCommonConfigUnit> fetch(int pageSize,
                                                     int page){
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FDataCommonConfigUnit> fetch(CharSequence whereSql,
                                                     int pageSize,
                                                     int page){
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FDataCommonConfigUnit> fetch(CharSequence fields,
                                                     CharSequence whereSql,
                                                     CharSequence orderSql,
                                                     int pageSize,
                                                     int page){
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FDataCommonConfigUnit> fetchSql(CharSequence code,
                                                        CharSequence sql,
                                                        int pageSize,
                                                        int page){
   ...
   public <T extends FLogicUnit> FLogicDataset<T> fetchSql(Class<T> clazz,
      ...
      if(clazz == null){
         result = (FLogicDataset<T>)(new FLogicDataset<FDataCommonConfigUnit>(FDataCommonConfigUnit.class, _logicContext));
      }else{
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FDataCommonConfigUnit> fetchAll(){
      // 生成命令
   ...
   // @return 数据单元
   //============================================================
   public FDataCommonConfigUnit doPrepare(){
      FDataCommonConfigUnit unit = new FDataCommonConfigUnit();
      unit.linkLogicContext(_logicContext);
      doPrepare(unit);
      return unit;
   }
   ...
   public EResult doPrepare(FLogicUnit logicUnit){
      FDataCommonConfigUnit unit = (FDataCommonConfigUnit)logicUnit;
      unit.setOvld(true);
   ...
   public EResult doInsert(FLogicUnit logicUnit){
      ...
      cmd.append(',');
      String parameter = unit.parameter();
      if(RString.isEmpty(parameter)){
         cmd.append("NULL");
      }else{
         cmd.append('\'');
         cmd.append(RSql.formatValue(parameter));
         cmd.append('\'');
      }
      cmd.append(',');
