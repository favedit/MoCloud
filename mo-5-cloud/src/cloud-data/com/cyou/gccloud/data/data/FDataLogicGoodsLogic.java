...
//============================================================
@ASourceMachine
public class FDataLogicGoodsLogic
      extends FLogicTable
{
   // 业务商品表的定义。
   ...
   // 业务商品表的定义。
   public final static SLogicTableInfo TABLE = new SLogicTableInfo("data.logic.goods", "DT_LGC_GOODS");
   ...
   // 字段重复次数的定义。
   public final static SLogicFieldInfo REPEAT_COUNT = new SLogicFieldInfo("REPEAT_COUNT");

   // 字段重复剩余的定义。
   public final static SLogicFieldInfo REPEAT_REMAIN = new SLogicFieldInfo("REPEAT_REMAIN");
   ...
   // 字段集合的定义。
   public final static String FIELDS = "OUID,OVLD,GUID,TYPE_CD,TYPE_ID,CODE,LABEL,ICON_URL,KEYWORDS,STATUS_CD,DISPLAY_CD,DISPLAY_ORDER,REPEAT_CD,REPEAT_COUNT,REPEAT_REMAIN,BEGIN_DATE,END_DATE,SCORE_BEAN,SCORE_POINT,SCORE_GOLD,DESCRIPTION,CONTENT,NOTE,CREATE_USER_ID,CREATE_DATE,UPDATE_USER_ID,UPDATE_DATE";

   //============================================================
   // <T>构造业务商品表逻辑单元。</T>
   //============================================================
   public FDataLogicGoodsLogic(){
      _name = TABLE.name();
      _classUnit = FDataLogicGoodsUnit.class;
   }
   ...
   // @param context 逻辑环境
   //============================================================
   public FDataLogicGoodsLogic(ILogicContext context){
      super(context);
      _name = TABLE.name();
      _classUnit = FDataLogicGoodsUnit.class;
   }
   ...
   public <T extends FLogicUnit> T find(T unit,
      ...
      if(unit == null){
         if(clazz == null){
            unit = (T)(new FDataLogicGoodsUnit());
         }else{
   ...
   // @return 数据单元
   //============================================================
   public FDataLogicGoodsUnit search(CharSequence whereSql){
      return search(null, FDataLogicGoodsUnit.class, whereSql);
   }
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FDataLogicGoodsUnit> fetch(int pageSize,
                                                   int page){
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FDataLogicGoodsUnit> fetch(CharSequence whereSql,
                                                   int pageSize,
                                                   int page){
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FDataLogicGoodsUnit> fetch(CharSequence fields,
                                                   CharSequence whereSql,
                                                   CharSequence orderSql,
                                                   int pageSize,
                                                   int page){
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FDataLogicGoodsUnit> fetchSql(CharSequence code,
                                                      CharSequence sql,
                                                      int pageSize,
                                                      int page){
   ...
   public <T extends FLogicUnit> FLogicDataset<T> fetchSql(Class<T> clazz,
      ...
      if(clazz == null){
         result = (FLogicDataset<T>)(new FLogicDataset<FDataLogicGoodsUnit>(FDataLogicGoodsUnit.class, _logicContext));
      }else{
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FDataLogicGoodsUnit> fetchAll(){
      // 生成命令
   ...
   // @return 数据单元
   //============================================================
   public FDataLogicGoodsUnit doPrepare(){
      FDataLogicGoodsUnit unit = new FDataLogicGoodsUnit();
      unit.linkLogicContext(_logicContext);
      doPrepare(unit);
      return unit;
   }
   ...
   public EResult doPrepare(FLogicUnit logicUnit){
      FDataLogicGoodsUnit unit = (FDataLogicGoodsUnit)logicUnit;
      unit.setOvld(true);
   ...
   public EResult doInsert(FLogicUnit logicUnit){
      ...
      cmd.append(",`REPEAT_COUNT`");
      cmd.append(",`REPEAT_REMAIN`");
      ...
      cmd.append(',');
      cmd.append(unit.repeatCount());
      cmd.append(',');
      cmd.append(unit.repeatRemain());
      cmd.append(',');
   ...
   public EResult doUpdate(FLogicUnit logicUnit,
      ...
      if(unit.isRepeatCountChanged()){
         cmd.append(",`REPEAT_COUNT`=");
         cmd.append(unit.repeatCount());
      }
      if(unit.isRepeatRemainChanged()){
         cmd.append(",`REPEAT_REMAIN`=");
         cmd.append(unit.repeatRemain());
      }
