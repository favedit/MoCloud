...
//============================================================
@ASourceMachine
public class FDataSystemAccessAuthorityUnit
      extends FLogicUnit
{
   // 存储字段对象标识的定义。
   private long __ouid;
   ...
   //============================================================
   @Override
   public FDataSystemAccessAuthorityUnit clone(){
      FDataSystemAccessAuthorityUnit unit = RClass.newInstance(FDataSystemAccessAuthorityUnit.class);
      copy(unit);
      return unit;
   }
}
