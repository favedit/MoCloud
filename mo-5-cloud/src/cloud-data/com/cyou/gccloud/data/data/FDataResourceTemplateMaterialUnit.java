...
//============================================================
@ASourceMachine
public class FDataResourceTemplateMaterialUnit
      extends FLogicUnit
{
   // 存储字段对象标识的定义。
   private long __ouid;
   ...
   //============================================================
   @Override
   public FDataResourceTemplateMaterialUnit clone(){
      FDataResourceTemplateMaterialUnit unit = RClass.newInstance(FDataResourceTemplateMaterialUnit.class);
      copy(unit);
      return unit;
   }
}
