...
//============================================================
@ASourceMachine
public class FDataExternalWeixinUserLogic
      extends FLogicTable
{
   // 微信用户表的定义。
   ...
   // 微信用户表的定义。
   public final static SLogicTableInfo TABLE = new SLogicTableInfo("data.external.weixin.user", "DT_ENL_WX_USER");
   ...
   // 字段微信公开码的定义。
   public final static SLogicFieldInfo OPEN_CODE = new SLogicFieldInfo("OPEN_CODE");

   // 字段用户昵称的定义。
   public final static SLogicFieldInfo NICK_NAME = new SLogicFieldInfo("NICK_NAME");
   ...
   // 字段集合的定义。
   public final static String FIELDS = "OUID,OVLD,GUID,USER_ID,OPEN_CODE,NICK_NAME,GENDER_CD,ICON_URL,CREATE_USER_ID,CREATE_DATE,UPDATE_USER_ID,UPDATE_DATE";

   //============================================================
   // <T>构造微信用户表逻辑单元。</T>
   //============================================================
   public FDataExternalWeixinUserLogic(){
      _name = TABLE.name();
      _classUnit = FDataExternalWeixinUserUnit.class;
   }
   ...
   // @param context 逻辑环境
   //============================================================
   public FDataExternalWeixinUserLogic(ILogicContext context){
      super(context);
      _name = TABLE.name();
      _classUnit = FDataExternalWeixinUserUnit.class;
   }
   ...
   public <T extends FLogicUnit> T find(T unit,
      ...
      if(unit == null){
         if(clazz == null){
            unit = (T)(new FDataExternalWeixinUserUnit());
         }else{
   ...
   // @return 数据单元
   //============================================================
   public FDataExternalWeixinUserUnit search(CharSequence whereSql){
      return search(null, FDataExternalWeixinUserUnit.class, whereSql);
   }
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FDataExternalWeixinUserUnit> fetch(int pageSize,
                                                           int page){
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FDataExternalWeixinUserUnit> fetch(CharSequence whereSql,
                                                           int pageSize,
                                                           int page){
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FDataExternalWeixinUserUnit> fetch(CharSequence fields,
                                                           CharSequence whereSql,
                                                           CharSequence orderSql,
                                                           int pageSize,
                                                           int page){
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FDataExternalWeixinUserUnit> fetchSql(CharSequence code,
                                                              CharSequence sql,
                                                              int pageSize,
                                                              int page){
   ...
   public <T extends FLogicUnit> FLogicDataset<T> fetchSql(Class<T> clazz,
      ...
      if(clazz == null){
         result = (FLogicDataset<T>)(new FLogicDataset<FDataExternalWeixinUserUnit>(FDataExternalWeixinUserUnit.class, _logicContext));
      }else{
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FDataExternalWeixinUserUnit> fetchAll(){
      // 生成命令
   ...
   // @return 数据单元
   //============================================================
   public FDataExternalWeixinUserUnit doPrepare(){
      FDataExternalWeixinUserUnit unit = new FDataExternalWeixinUserUnit();
      unit.linkLogicContext(_logicContext);
      doPrepare(unit);
      return unit;
   }
   ...
   public EResult doPrepare(FLogicUnit logicUnit){
      FDataExternalWeixinUserUnit unit = (FDataExternalWeixinUserUnit)logicUnit;
      unit.setOvld(true);
   ...
   public EResult doInsert(FLogicUnit logicUnit){
      ...
      cmd.append(",`GUID`");
      cmd.append(",`USER_ID`");
      cmd.append(",`OPEN_CODE`");
      cmd.append(",`NICK_NAME`");
      ...
      cmd.append(',');
      String openCode = unit.openCode();
      if(RString.isEmpty(openCode)){
         cmd.append("NULL");
      }else{
         cmd.append('\'');
         cmd.append(RSql.formatValue(openCode));
         cmd.append('\'');
      }
      cmd.append(',');
      String nickName = unit.nickName();
      if(RString.isEmpty(nickName)){
         cmd.append("NULL");
      }else{
         cmd.append('\'');
         cmd.append(RSql.formatValue(nickName));
         cmd.append('\'');
      }
      cmd.append(',');
