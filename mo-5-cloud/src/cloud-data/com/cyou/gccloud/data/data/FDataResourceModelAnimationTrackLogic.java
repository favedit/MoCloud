...
//============================================================
@ASourceMachine
public class FDataResourceModelAnimationTrackLogic extends FLogicTable
{
   // 资源模型动画跟踪表的定义。
   public final static SLogicConnectionInfo CONNECTION = new SLogicConnectionInfo("data");

   // 资源模型动画跟踪表的定义。
   public final static SLogicTableInfo TABLE = new SLogicTableInfo("data.resource.model.animation.track", "DT_RES_MODEL_ANIMATION_TRACK");
   ...
   // <T>构造资源模型动画跟踪表逻辑单元。</T>
   //============================================================
   public FDataResourceModelAnimationTrackLogic(){
      _name = TABLE.name();
      _classUnit = FDataResourceModelAnimationTrackUnit.class;
   }
   ...
   // @param context 逻辑环境
   //============================================================
   public FDataResourceModelAnimationTrackLogic(ILogicContext context){
      super(context);
      _name = TABLE.name();
      _classUnit = FDataResourceModelAnimationTrackUnit.class;
   }
   ...
   public <T extends FLogicUnit> T find(T unit, Class<T> clazz, long recordId){
      ...
      if(unit == null){
         if(clazz == null){
            unit = (T)(new FDataResourceModelAnimationTrackUnit());
         }else{
   ...
   // @return 数据单元
   //============================================================
   public FDataResourceModelAnimationTrackUnit findByGuid(CharSequence guid){
      return findByGuid(null, FDataResourceModelAnimationTrackUnit.class, guid);
   }
   ...
   // @return 数据单元
   //============================================================
   public FDataResourceModelAnimationTrackUnit search(CharSequence whereSql){
      return search(null, FDataResourceModelAnimationTrackUnit.class, whereSql);
   }
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FDataResourceModelAnimationTrackUnit> fetch(CharSequence whereSql){
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FDataResourceModelAnimationTrackUnit> fetch(int pageSize, int page){
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FDataResourceModelAnimationTrackUnit> fetch(CharSequence whereSql, int pageSize, int page){
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FDataResourceModelAnimationTrackUnit> fetch(CharSequence whereSql, CharSequence orderSql){
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FDataResourceModelAnimationTrackUnit> fetch(CharSequence whereSql, CharSequence orderSql, int pageSize, int page){
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FDataResourceModelAnimationTrackUnit> fetch(CharSequence fields, CharSequence whereSql, CharSequence orderSql, int pageSize, int page){
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FDataResourceModelAnimationTrackUnit> fetch(CharSequence fields, CharSequence whereSql, CharSequence groupSql, CharSequence orderSql, int pageSize, int page){
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FDataResourceModelAnimationTrackUnit> fetchSql(CharSequence code, CharSequence sql, int pageSize, int page){
   ...
   public <T extends FLogicUnit> FLogicDataset<T> fetchSql(Class<T> clazz, CharSequence code, CharSequence sql, int pageSize, int page){
      ...
      if(clazz == null){
         result = (FLogicDataset<T>)(new FLogicDataset<FDataResourceModelAnimationTrackUnit>(FDataResourceModelAnimationTrackUnit.class, _logicContext));
      }else{
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FDataResourceModelAnimationTrackUnit> fetchAll(){
      // 生成命令
   ...
   // @return 数据单元
   //============================================================
   public FDataResourceModelAnimationTrackUnit doPrepare(){
      FDataResourceModelAnimationTrackUnit unit = new FDataResourceModelAnimationTrackUnit();
      unit.linkLogicContext(_logicContext);
      doPrepare(unit);
      return unit;
   }
