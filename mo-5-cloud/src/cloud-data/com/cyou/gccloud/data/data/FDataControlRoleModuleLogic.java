...
//============================================================
@ASourceMachine
public class FDataControlRoleModuleLogic extends FLogicTable
{
   // 控制角色模块表的定义。
   public final static SLogicConnectionInfo CONNECTION = new SLogicConnectionInfo("data");

   // 控制角色模块表的定义。
   public final static SLogicTableInfo TABLE = new SLogicTableInfo("data.control.role.module", "DT_CTL_ROLE_MODULE");
   ...
   // 字段查看有效类型的定义。
   public final static SLogicFieldInfo VIEW_VALID_CD = new SLogicFieldInfo("VIEW_VALID_CD");

   // 字段新建有效类型的定义。
   public final static SLogicFieldInfo INSERT_VALID_CD = new SLogicFieldInfo("INSERT_VALID_CD");

   // 字段修改有效类型的定义。
   public final static SLogicFieldInfo UPDATE_VALID_CD = new SLogicFieldInfo("UPDATE_VALID_CD");

   // 字段删除有效类型的定义。
   public final static SLogicFieldInfo DELETE_VALID_CD = new SLogicFieldInfo("DELETE_VALID_CD");
   ...
   // 字段集合的定义。
   public final static String FIELDS = "`OUID`,`OVLD`,`GUID`,`ROLE_ID`,`MODULE_ID`,`VIEW_VALID_CD`,`INSERT_VALID_CD`,`UPDATE_VALID_CD`,`DELETE_VALID_CD`,`NOTE`,`CREATE_USER_ID`,`CREATE_DATE`,`UPDATE_USER_ID`,`UPDATE_DATE`";

   //============================================================
   // <T>构造控制角色模块表逻辑单元。</T>
   //============================================================
   public FDataControlRoleModuleLogic(){
      _name = TABLE.name();
      _classUnit = FDataControlRoleModuleUnit.class;
   }
   ...
   // @param context 逻辑环境
   //============================================================
   public FDataControlRoleModuleLogic(ILogicContext context){
      super(context);
      _name = TABLE.name();
      _classUnit = FDataControlRoleModuleUnit.class;
   }
   ...
   public <T extends FLogicUnit> T find(T unit, Class<T> clazz, long recordId){
      ...
      if(unit == null){
         if(clazz == null){
            unit = (T)(new FDataControlRoleModuleUnit());
         }else{
   ...
   // @return 数据单元
   //============================================================
   public FDataControlRoleModuleUnit findByGuid(CharSequence guid){
      return findByGuid(null, FDataControlRoleModuleUnit.class, guid);
   }
   ...
   // @return 数据单元
   //============================================================
   public FDataControlRoleModuleUnit search(CharSequence whereSql){
      return search(null, FDataControlRoleModuleUnit.class, whereSql);
   }
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FDataControlRoleModuleUnit> fetch(CharSequence whereSql){
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FDataControlRoleModuleUnit> fetch(int pageSize, int page){
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FDataControlRoleModuleUnit> fetch(CharSequence whereSql, int pageSize, int page){
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FDataControlRoleModuleUnit> fetch(CharSequence whereSql, CharSequence orderSql){
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FDataControlRoleModuleUnit> fetch(CharSequence whereSql, CharSequence orderSql, int pageSize, int page){
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FDataControlRoleModuleUnit> fetch(CharSequence fields, CharSequence whereSql, CharSequence orderSql, int pageSize, int page){
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FDataControlRoleModuleUnit> fetch(CharSequence fields, CharSequence whereSql, CharSequence groupSql, CharSequence orderSql, int pageSize, int page){
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FDataControlRoleModuleUnit> fetchSql(CharSequence code, CharSequence sql, int pageSize, int page){
   ...
   public <T extends FLogicUnit> FLogicDataset<T> fetchSql(Class<T> clazz, CharSequence code, CharSequence sql, int pageSize, int page){
      ...
      if(clazz == null){
         result = (FLogicDataset<T>)(new FLogicDataset<FDataControlRoleModuleUnit>(FDataControlRoleModuleUnit.class, _logicContext));
      }else{
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FDataControlRoleModuleUnit> fetchAll(){
      // 生成命令
   ...
   // @return 数据单元
   //============================================================
   public FDataControlRoleModuleUnit doPrepare(){
      FDataControlRoleModuleUnit unit = new FDataControlRoleModuleUnit();
      unit.linkLogicContext(_logicContext);
      doPrepare(unit);
      return unit;
   }
   ...
   public EResult doInsert(FLogicUnit logicUnit){
      ...
      cmd.append(",`VIEW_VALID_CD`");
      cmd.append(",`INSERT_VALID_CD`");
      cmd.append(",`UPDATE_VALID_CD`");
      cmd.append(",`DELETE_VALID_CD`");
      cmd.append(",`NOTE`");
      ...
      cmd.append(',');
      cmd.append(unit.viewValidCd());
      cmd.append(',');
      cmd.append(unit.insertValidCd());
      cmd.append(',');
      cmd.append(unit.updateValidCd());
      cmd.append(',');
      cmd.append(unit.deleteValidCd());
      cmd.append(',');
   ...
   public EResult doUpdate(FLogicUnit logicUnit,
      ...
      if(unit.isViewValidCdChanged()){
         cmd.append(",`VIEW_VALID_CD`=");
         cmd.append(unit.viewValidCd());
      }
      if(unit.isInsertValidCdChanged()){
         cmd.append(",`INSERT_VALID_CD`=");
         cmd.append(unit.insertValidCd());
      }
      if(unit.isUpdateValidCdChanged()){
         cmd.append(",`UPDATE_VALID_CD`=");
         cmd.append(unit.updateValidCd());
      }
      if(unit.isDeleteValidCdChanged()){
         cmd.append(",`DELETE_VALID_CD`=");
         cmd.append(unit.deleteValidCd());
      }
