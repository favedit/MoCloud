      ...
      extends FLogicUnit
{
   ...
   // <T>构造资源材质表逻辑单元。</T>
   //============================================================
   public FDataResourceMaterialUnit(){
   }
   ...
   //============================================================
   @Override
   public FDataResourceMaterialUnit clone(){
      FDataResourceMaterialUnit unit = RClass.newInstance(FDataResourceMaterialUnit.class);
      copy(unit);
      return unit;
   }
}
