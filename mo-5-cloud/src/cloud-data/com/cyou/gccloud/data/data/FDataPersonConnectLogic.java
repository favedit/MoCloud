...
//============================================================
@ASourceMachine
public class FDataPersonConnectLogic
      extends FLogicTable
{
   // 用户连接表的定义。
   ...
   // 用户连接表的定义。
   public final static SLogicTableInfo TABLE = new SLogicTableInfo("data.person.connect", "DT_PSN_CONNECT");
   ...
   // 字段鉴定代码的定义。
   public final static SLogicFieldInfo TOKEN_CODE = new SLogicFieldInfo("TOKEN_CODE");
   ...
   // 字段GPS纬度的定义。
   public final static SLogicFieldInfo GPS_LATITUDE = new SLogicFieldInfo("GPS_LATITUDE");

   // 字段GPS经度的定义。
   public final static SLogicFieldInfo GPS_LONGITUDE = new SLogicFieldInfo("GPS_LONGITUDE");

   // 字段打包信息的定义。
   public final static SLogicFieldInfo INFO_PACK = new SLogicFieldInfo("INFO_PACK");
   ...
   // 字段集合的定义。
   public final static String FIELDS = "OUID,OVLD,GUID,PROJECT_ID,TOKEN_CODE,USER_ID,ACTIVE_CD,DEVICE_ID,GPS_LATITUDE,GPS_LONGITUDE,INFO_PACK,CREATE_USER_ID,CREATE_DATE,UPDATE_USER_ID,UPDATE_DATE";

   //============================================================
   // <T>构造用户连接表逻辑单元。</T>
   //============================================================
   public FDataPersonConnectLogic(){
      _name = TABLE.name();
      _classUnit = FDataPersonConnectUnit.class;
   }
   ...
   // @param context 逻辑环境
   //============================================================
   public FDataPersonConnectLogic(ILogicContext context){
      super(context);
      _name = TABLE.name();
      _classUnit = FDataPersonConnectUnit.class;
   }
   ...
   public <T extends FLogicUnit> T find(T unit,
      ...
      if(unit == null){
         if(clazz == null){
            unit = (T)(new FDataPersonConnectUnit());
         }else{
   ...
   // @return 数据单元
   //============================================================
   public FDataPersonConnectUnit search(CharSequence whereSql){
      return search(null, FDataPersonConnectUnit.class, whereSql);
   }
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FDataPersonConnectUnit> fetch(int pageSize,
                                                      int page){
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FDataPersonConnectUnit> fetch(CharSequence whereSql,
                                                      int pageSize,
                                                      int page){
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FDataPersonConnectUnit> fetch(CharSequence fields,
                                                      CharSequence whereSql,
                                                      CharSequence orderSql,
                                                      int pageSize,
                                                      int page){
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FDataPersonConnectUnit> fetchSql(CharSequence code,
                                                         CharSequence sql,
                                                         int pageSize,
                                                         int page){
   ...
   public <T extends FLogicUnit> FLogicDataset<T> fetchSql(Class<T> clazz,
      ...
      if(clazz == null){
         result = (FLogicDataset<T>)(new FLogicDataset<FDataPersonConnectUnit>(FDataPersonConnectUnit.class, _logicContext));
      }else{
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FDataPersonConnectUnit> fetchAll(){
      // 生成命令
   ...
   // @return 数据单元
   //============================================================
   public FDataPersonConnectUnit doPrepare(){
      FDataPersonConnectUnit unit = new FDataPersonConnectUnit();
      unit.linkLogicContext(_logicContext);
      doPrepare(unit);
      return unit;
   }
   ...
   public EResult doPrepare(FLogicUnit logicUnit){
      FDataPersonConnectUnit unit = (FDataPersonConnectUnit)logicUnit;
      unit.setOvld(true);
   ...
   public EResult doInsert(FLogicUnit logicUnit){
      ...
      cmd.append(",`GPS_LATITUDE`");
      cmd.append(",`GPS_LONGITUDE`");
      cmd.append(",`INFO_PACK`");
      ...
      cmd.append(',');
      String tokenCode = unit.tokenCode();
      if(RString.isEmpty(tokenCode)){
         cmd.append("NULL");
      }else{
         cmd.append('\'');
         cmd.append(RSql.formatValue(tokenCode));
         cmd.append('\'');
      }
      cmd.append(',');
      ...
      cmd.append(',');
      cmd.append(unit.gpsLatitude());
      cmd.append(',');
      cmd.append(unit.gpsLongitude());
      cmd.append(',');
      String infoPack = unit.infoPack();
      if(RString.isEmpty(infoPack)){
         cmd.append("NULL");
      }else{
         cmd.append('\'');
         cmd.append(RSql.formatValue(infoPack));
         cmd.append('\'');
      }
      // 设置更新信息
   ...
   public EResult doUpdate(FLogicUnit logicUnit,
      ...
      if(unit.isGpsLatitudeChanged()){
         cmd.append(",`GPS_LATITUDE`=");
         cmd.append(unit.gpsLatitude());
      }
      if(unit.isGpsLongitudeChanged()){
         cmd.append(",`GPS_LONGITUDE`=");
         cmd.append(unit.gpsLongitude());
      }
      if(unit.isInfoPackChanged()){
         cmd.append(",`INFO_PACK`=");
         String infoPack = unit.infoPack();
         if(RString.isEmpty(infoPack)){
            cmd.append("NULL");
