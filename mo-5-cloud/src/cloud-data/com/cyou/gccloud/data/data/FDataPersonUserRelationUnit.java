...
//============================================================
@ASourceMachine
public class FDataPersonUserRelationUnit
      extends FLogicUnit
{
   // 存储字段对象标识的定义。
   private long __ouid;
   ...
   // <T>构造用户关系表逻辑单元。</T>
   //============================================================
   public FDataPersonUserRelationUnit(){
   }
   ...
   // @return 数据内容
   //============================================================
   public boolean isRelationUserIdChanged(){
      return __relationUserId != _relationUserId;
   }
   ...
   // @return 数据内容
   //============================================================
   public FDataPersonUserUnit relationUser(){
      FDataPersonUserLogic logic = _logicContext.findLogic(FDataPersonUserLogic.class);
      FDataPersonUserUnit unit = logic.find(_relationUserId);
      return unit;
   }
   ...
   // @param value 数据内容
   //============================================================
   public void setRelationUserId(long value){
   ...
   public String get(String name){
      switch(name){
         ...
         case "relation_user_id":
            return Long.toString(_relationUserId);
         case "create_user_id":
   ...
   public void set(String name,
      ...
      switch(name){
         ...
         case "relation_cd":
            ...
            break;
         case "relation_user_id":
            _relationUserId = RLong.parse(value);
            break;
         case "create_user_id":
      ...
      for(IStringPair pair : row){
         ...
         switch(name){
            ...
            case "relation_cd":
               ...
               break;
            case "relation_user_id":
               __relationUserId = RLong.parse(value);
               _relationUserId = __relationUserId;
               break;
            case "create_user_id":
   ...
   public void save(FRow row){
      ...
      row.set("relationUserId", _relationUserId);
   ...
   public void saveMap(Map<String, String> map){
      ...
      map.put("relationUserId", RLong.toString(_relationUserId));
