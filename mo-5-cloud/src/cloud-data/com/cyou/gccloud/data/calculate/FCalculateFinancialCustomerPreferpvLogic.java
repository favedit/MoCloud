      ...
      extends FLogicTable
{
   ...
   public <T extends FLogicUnit> T find(T unit,
      ...
      if(unit == null){
         if(clazz == null){
            unit = (T)(new FCalculateFinancialCustomerPreferpvUnit());
         }else{
   ...
   public <T extends FLogicUnit> FLogicDataset<T> fetchSql(Class<T> clazz,
      ...
      if(clazz == null){
         result = (FLogicDataset<T>)(new FLogicDataset<FCalculateFinancialCustomerPreferpvUnit>(FCalculateFinancialCustomerPreferpvUnit.class, _logicContext));
      }else{
