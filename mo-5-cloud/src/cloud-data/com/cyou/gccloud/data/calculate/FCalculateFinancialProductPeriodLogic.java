...
//============================================================
@ASourceMachine
public class FCalculateFinancialProductPeriodLogic
      extends FLogicTable
{
   // 产品期数关系表的定义。
   ...
   // 产品期数关系表的定义。
   public final static SLogicTableInfo TABLE = new SLogicTableInfo("calculate.financial.product.period", "CL_FIN_PRODUCT_PERIOD");
   ...
   // 字段期次编号的定义。
   public final static SLogicFieldInfo PRODUCT_ISSUE = new SLogicFieldInfo("PRODUCT_ISSUE");
   ...
   // 字段集合的定义。
   public final static String FIELDS = "`OUID`,`OVLD`,`GUID`,`PRODUCT_CODE`,`PRODUCT_ISSUE`,`CREATE_USER_ID`,`CREATE_DATE`,`UPDATE_USER_ID`,`UPDATE_DATE`";

   //============================================================
   // <T>构造产品期数关系表逻辑单元。</T>
   //============================================================
   public FCalculateFinancialProductPeriodLogic(){
      _name = TABLE.name();
      _classUnit = FCalculateFinancialProductPeriodUnit.class;
   }
   ...
   // @param context 逻辑环境
   //============================================================
   public FCalculateFinancialProductPeriodLogic(ILogicContext context){
      super(context);
      _name = TABLE.name();
      _classUnit = FCalculateFinancialProductPeriodUnit.class;
   }
   ...
   public <T extends FLogicUnit> T find(T unit,
      ...
      if(unit == null){
         if(clazz == null){
            unit = (T)(new FCalculateFinancialProductPeriodUnit());
         }else{
   ...
   // @return 数据单元
   //============================================================
   public FCalculateFinancialProductPeriodUnit findByGuid(CharSequence guid){
      return findByGuid(null, FCalculateFinancialProductPeriodUnit.class, guid);
   }
   ...
   // @return 数据单元
   //============================================================
   public FCalculateFinancialProductPeriodUnit search(CharSequence whereSql){
      return search(null, FCalculateFinancialProductPeriodUnit.class, whereSql);
   }
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FCalculateFinancialProductPeriodUnit> fetch(CharSequence whereSql){
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FCalculateFinancialProductPeriodUnit> fetch(int pageSize,
                                                                    int page){
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FCalculateFinancialProductPeriodUnit> fetch(CharSequence fields,
                                                                    CharSequence whereSql,
                                                                    CharSequence orderSql,
                                                                    int pageSize,
                                                                    int page){
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FCalculateFinancialProductPeriodUnit> fetchSql(CharSequence code,
                                                                       CharSequence sql,
                                                                       int pageSize,
                                                                       int page){
   ...
   public <T extends FLogicUnit> FLogicDataset<T> fetchSql(Class<T> clazz,
      ...
      if(clazz == null){
         result = (FLogicDataset<T>)(new FLogicDataset<FCalculateFinancialProductPeriodUnit>(FCalculateFinancialProductPeriodUnit.class, _logicContext));
      }else{
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FCalculateFinancialProductPeriodUnit> fetchAll(){
      // 生成命令
   ...
   // @return 数据单元
   //============================================================
   public FCalculateFinancialProductPeriodUnit doPrepare(){
      FCalculateFinancialProductPeriodUnit unit = new FCalculateFinancialProductPeriodUnit();
      unit.linkLogicContext(_logicContext);
      doPrepare(unit);
      return unit;
   }
   ...
   public EResult doPrepare(FLogicUnit logicUnit){
      FCalculateFinancialProductPeriodUnit unit = (FCalculateFinancialProductPeriodUnit)logicUnit;
      unit.setOvld(true);
