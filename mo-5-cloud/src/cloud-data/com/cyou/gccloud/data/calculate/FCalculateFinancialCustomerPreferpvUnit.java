...
//============================================================
@ASourceMachine
public class FCalculateFinancialCustomerPreferpvUnit
      extends FLogicUnit
{
   // 存储字段对象标识的定义。
   private long __ouid;
   ...
   // 存储字段时间段的定义。
   private String __timeSection;

   // 字段时间段的定义。
   protected String _timeSection;
   ...
   // <T>构造客户关注时间偏好逻辑单元。</T>
   //============================================================
   public FCalculateFinancialCustomerPreferpvUnit(){
   }
   ...
   // @return 数据内容
   //============================================================
   public boolean isTimeSectionChanged(){
      return !RString.equals(__timeSection, _timeSection);
   }
   ...
   // @param value 数据内容
   //============================================================
   public void setTimeSection(String value){
      _timeSection = value;
   }
   ...
   public void save(FRow row){
      ...
      row.set("timeSection", _timeSection);
      row.set("pv", _pv);
   ...
   public void copy(FLogicUnit logicUnit){
      ...
      unit.setTimeSection(_timeSection);
      unit.setPv(_pv);
   ...
   //============================================================
   @Override
   public FCalculateFinancialCustomerPreferpvUnit clone(){
      FCalculateFinancialCustomerPreferpvUnit unit = RClass.newInstance(FCalculateFinancialCustomerPreferpvUnit.class);
      copy(unit);
      return unit;
   }
}
