...
//============================================================
@ASourceMachine
public class FCacheSystemValidationLogic extends FLogicTable
{
   // 系统短信效验表的定义。
   public final static SLogicConnectionInfo CONNECTION = new SLogicConnectionInfo("cache");

   // 系统短信效验表的定义。
   public final static SLogicTableInfo TABLE = new SLogicTableInfo("cache.system.validation", "CC_SYS_VALIDATION");
   ...
   // 字段手机号的定义。
   public final static SLogicFieldInfo MOBILE_NUMBER = new SLogicFieldInfo("MOBILE_NUMBER");

   // 字段校验类型的定义。
   public final static SLogicFieldInfo VALIDATE_CD = new SLogicFieldInfo("VALIDATE_CD");

   // 字段检查代码的定义。
   public final static SLogicFieldInfo CHECK_CODE = new SLogicFieldInfo("CHECK_CODE");
   ...
   // 字段集合的定义。
   public final static String FIELDS = "`OUID`,`OVLD`,`GUID`,`PASSPORT`,`MOBILE_NUMBER`,`VALIDATE_CD`,`CHECK_CODE`,`CREATE_USER_ID`,`CREATE_DATE`,`UPDATE_USER_ID`,`UPDATE_DATE`";

   //============================================================
   // <T>构造系统短信效验表逻辑单元。</T>
   //============================================================
   public FCacheSystemValidationLogic(){
      _name = TABLE.name();
      _classUnit = FCacheSystemValidationUnit.class;
   }
   ...
   // @param context 逻辑环境
   //============================================================
   public FCacheSystemValidationLogic(ILogicContext context){
      super(context);
      _name = TABLE.name();
      _classUnit = FCacheSystemValidationUnit.class;
   }
   ...
   public <T extends FLogicUnit> T find(T unit, Class<T> clazz, long recordId){
      ...
      if(unit == null){
         if(clazz == null){
            unit = (T)(new FCacheSystemValidationUnit());
         }else{
   ...
   // @return 数据单元
   //============================================================
   public FCacheSystemValidationUnit findByGuid(CharSequence guid){
      return findByGuid(null, FCacheSystemValidationUnit.class, guid);
   }
   ...
   // @return 数据单元
   //============================================================
   public FCacheSystemValidationUnit search(CharSequence whereSql){
      return search(null, FCacheSystemValidationUnit.class, whereSql);
   }
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FCacheSystemValidationUnit> fetch(CharSequence whereSql){
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FCacheSystemValidationUnit> fetch(int pageSize, int page){
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FCacheSystemValidationUnit> fetch(CharSequence whereSql, int pageSize, int page){
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FCacheSystemValidationUnit> fetch(CharSequence whereSql, CharSequence orderSql){
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FCacheSystemValidationUnit> fetch(CharSequence whereSql, CharSequence orderSql, int pageSize, int page){
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FCacheSystemValidationUnit> fetch(CharSequence fields, CharSequence whereSql, CharSequence orderSql, int pageSize, int page){
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FCacheSystemValidationUnit> fetch(CharSequence fields, CharSequence whereSql, CharSequence groupSql, CharSequence orderSql, int pageSize, int page){
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FCacheSystemValidationUnit> fetchSql(CharSequence code, CharSequence sql, int pageSize, int page){
   ...
   public <T extends FLogicUnit> FLogicDataset<T> fetchSql(Class<T> clazz, CharSequence code, CharSequence sql, int pageSize, int page){
      ...
      if(clazz == null){
         result = (FLogicDataset<T>)(new FLogicDataset<FCacheSystemValidationUnit>(FCacheSystemValidationUnit.class, _logicContext));
      }else{
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FCacheSystemValidationUnit> fetchAll(){
      // 生成命令
   ...
   // @return 数据单元
   //============================================================
   public FCacheSystemValidationUnit doPrepare(){
      FCacheSystemValidationUnit unit = new FCacheSystemValidationUnit();
      unit.linkLogicContext(_logicContext);
      doPrepare(unit);
      return unit;
   }
   ...
   public EResult doPrepare(FLogicUnit logicUnit){
      FCacheSystemValidationUnit unit = (FCacheSystemValidationUnit)logicUnit;
      unit.setOvld(true);
   ...
   public EResult doInsert(FLogicUnit logicUnit){
      ...
      cmd.append(",`GUID`");
      cmd.append(",`PASSPORT`");
      cmd.append(",`MOBILE_NUMBER`");
      cmd.append(",`VALIDATE_CD`");
      cmd.append(",`CHECK_CODE`");
      ...
      cmd.append(',');
      String mobileNumber = unit.mobileNumber();
      if(RString.isEmpty(mobileNumber)){
         cmd.append("NULL");
      }else{
         cmd.append('\'');
         cmd.append(RSql.formatValue(mobileNumber));
         cmd.append('\'');
      }
      cmd.append(',');
      cmd.append(unit.validateCd());
      cmd.append(',');
      String checkCode = unit.checkCode();
      if(RString.isEmpty(checkCode)){
         cmd.append("NULL");
      }else{
         cmd.append('\'');
         cmd.append(RSql.formatValue(checkCode));
         cmd.append('\'');
      }
      // 设置更新信息
   ...
   public EResult doUpdate(FLogicUnit logicUnit,
      ...
      if(unit.isValidateCdChanged()){
         cmd.append(",`VALIDATE_CD`=");
         cmd.append(unit.validateCd());
      }
      if(unit.isCheckCodeChanged()){
         cmd.append(",`CHECK_CODE`=");
         String checkCode = unit.checkCode();
         if(RString.isEmpty(checkCode)){
            cmd.append("NULL");
