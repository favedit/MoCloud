      ...
      extends FLogicUnit
{
   ...
   //============================================================
   @Override
   public FStatisticsFinancialDepartmentAmountUnit clone(){
      FStatisticsFinancialDepartmentAmountUnit unit = RClass.newInstance(FStatisticsFinancialDepartmentAmountUnit.class);
      copy(unit);
      return unit;
   }
}
