...
//============================================================
@ASourceMachine
public class FStatisticsFinancialDepartmentCustomerLogic
      extends FLogicTable
{
   // 部门客户统计表的定义。
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FStatisticsFinancialDepartmentCustomerUnit> fetch(int pageSize,
                                                                          int page){
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FStatisticsFinancialDepartmentCustomerUnit> fetch(CharSequence fields,
                                                                          CharSequence whereSql,
                                                                          CharSequence orderSql,
                                                                          int pageSize,
                                                                          int page){
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FStatisticsFinancialDepartmentCustomerUnit> fetchSql(CharSequence code,
                                                                             CharSequence sql,
                                                                             int pageSize,
                                                                             int page){
