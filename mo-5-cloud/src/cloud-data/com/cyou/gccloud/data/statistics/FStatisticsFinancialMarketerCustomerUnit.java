...
//============================================================
@ASourceMachine
public class FStatisticsFinancialMarketerCustomerUnit
      extends FLogicUnit
{
   // 存储字段对象标识的定义。
   private long __ouid;
   ...
   // <T>构造理财师客户表逻辑单元。</T>
   //============================================================
   public FStatisticsFinancialMarketerCustomerUnit(){
   }
   ...
   //============================================================
   @Override
   public FStatisticsFinancialMarketerCustomerUnit clone(){
      FStatisticsFinancialMarketerCustomerUnit unit = RClass.newInstance(FStatisticsFinancialMarketerCustomerUnit.class);
      copy(unit);
      return unit;
   }
}
