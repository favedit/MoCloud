...
//============================================================
@ASourceMachine
public class FStatisticsFinancialCompanyPhaseLogic extends FLogicTable
{
   // 公司阶段统计表的定义。
   public final static SLogicConnectionInfo CONNECTION = new SLogicConnectionInfo("statistics");

   // 公司阶段统计表的定义。
   public final static SLogicTableInfo TABLE = new SLogicTableInfo("statistics.financial.company.phase", "ST_FIN_COMPANY_PHASE");
   ...
   // 字段公司投资的定义。
   public final static SLogicFieldInfo COMPANY_INVESTMENT = new SLogicFieldInfo("COMPANY_INVESTMENT");

   // 字段公司投资总计的定义。
   public final static SLogicFieldInfo COMPANY_INVESTMENT_TOTAL = new SLogicFieldInfo("COMPANY_INVESTMENT_TOTAL");

   // 字段公司赎回的定义。
   public final static SLogicFieldInfo COMPANY_REDEMPTION = new SLogicFieldInfo("COMPANY_REDEMPTION");

   // 字段公司赎回总计的定义。
   public final static SLogicFieldInfo COMPANY_REDEMPTION_TOTAL = new SLogicFieldInfo("COMPANY_REDEMPTION_TOTAL");

   // 字段公司净投的定义。
   public final static SLogicFieldInfo COMPANY_NETINVESTMENT = new SLogicFieldInfo("COMPANY_NETINVESTMENT");

   // 字段公司净投总计的定义。
   public final static SLogicFieldInfo COMPANY_NETINVESTMENT_TOTAL = new SLogicFieldInfo("COMPANY_NETINVESTMENT_TOTAL");

   // 字段公司绩效的定义。
   public final static SLogicFieldInfo COMPANY_PERFORMANCE = new SLogicFieldInfo("COMPANY_PERFORMANCE");

   // 字段公司绩效总计的定义。
   public final static SLogicFieldInfo COMPANY_PERFORMANCE_TOTAL = new SLogicFieldInfo("COMPANY_PERFORMANCE_TOTAL");
   ...
   // <T>构造公司阶段统计表逻辑单元。</T>
   //============================================================
   public FStatisticsFinancialCompanyPhaseLogic(){
      _name = TABLE.name();
      _classUnit = FStatisticsFinancialCompanyPhaseUnit.class;
   }
   ...
   // @param context 逻辑环境
   //============================================================
   public FStatisticsFinancialCompanyPhaseLogic(ILogicContext context){
      super(context);
      _name = TABLE.name();
      _classUnit = FStatisticsFinancialCompanyPhaseUnit.class;
   }
   ...
   public <T extends FLogicUnit> T find(T unit, Class<T> clazz, long recordId){
      ...
      if(unit == null){
         if(clazz == null){
            unit = (T)(new FStatisticsFinancialCompanyPhaseUnit());
         }else{
   ...
   // @return 数据单元
   //============================================================
   public FStatisticsFinancialCompanyPhaseUnit findByGuid(CharSequence guid){
      return findByGuid(null, FStatisticsFinancialCompanyPhaseUnit.class, guid);
   }
   ...
   // @return 数据单元
   //============================================================
   public FStatisticsFinancialCompanyPhaseUnit search(CharSequence whereSql){
      return search(null, FStatisticsFinancialCompanyPhaseUnit.class, whereSql);
   }
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FStatisticsFinancialCompanyPhaseUnit> fetch(CharSequence whereSql){
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FStatisticsFinancialCompanyPhaseUnit> fetch(int pageSize, int page){
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FStatisticsFinancialCompanyPhaseUnit> fetch(CharSequence whereSql, int pageSize, int page){
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FStatisticsFinancialCompanyPhaseUnit> fetch(CharSequence whereSql, CharSequence orderSql){
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FStatisticsFinancialCompanyPhaseUnit> fetch(CharSequence whereSql, CharSequence orderSql, int pageSize, int page){
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FStatisticsFinancialCompanyPhaseUnit> fetch(CharSequence fields, CharSequence whereSql, CharSequence orderSql, int pageSize, int page){
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FStatisticsFinancialCompanyPhaseUnit> fetch(CharSequence fields, CharSequence whereSql, CharSequence groupSql, CharSequence orderSql, int pageSize, int page){
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FStatisticsFinancialCompanyPhaseUnit> fetchSql(CharSequence code, CharSequence sql, int pageSize, int page){
   ...
   public <T extends FLogicUnit> FLogicDataset<T> fetchSql(Class<T> clazz, CharSequence code, CharSequence sql, int pageSize, int page){
      ...
      if(clazz == null){
         result = (FLogicDataset<T>)(new FLogicDataset<FStatisticsFinancialCompanyPhaseUnit>(FStatisticsFinancialCompanyPhaseUnit.class, _logicContext));
      }else{
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FStatisticsFinancialCompanyPhaseUnit> fetchAll(){
      // 生成命令
   ...
   // @return 数据单元
   //============================================================
   public FStatisticsFinancialCompanyPhaseUnit doPrepare(){
      FStatisticsFinancialCompanyPhaseUnit unit = new FStatisticsFinancialCompanyPhaseUnit();
      unit.linkLogicContext(_logicContext);
      doPrepare(unit);
      return unit;
   }
   ...
   public EResult doPrepare(FLogicUnit logicUnit){
      FStatisticsFinancialCompanyPhaseUnit unit = (FStatisticsFinancialCompanyPhaseUnit)logicUnit;
      unit.setOvld(true);
   ...
   public EResult doInsert(FLogicUnit logicUnit){
      ...
      cmd.append(",`COMPANY_INVESTMENT_TOTAL`");
      cmd.append(",`COMPANY_REDEMPTION`");
      cmd.append(",`COMPANY_REDEMPTION_TOTAL`");
      cmd.append(",`COMPANY_NETINVESTMENT`");
      cmd.append(",`COMPANY_NETINVESTMENT_TOTAL`");
      cmd.append(",`COMPANY_PERFORMANCE`");
      cmd.append(",`COMPANY_PERFORMANCE_TOTAL`");
      ...
      cmd.append(',');
      cmd.append(unit.companyInvestment());
      cmd.append(',');
      cmd.append(unit.companyInvestmentTotal());
      cmd.append(',');
      cmd.append(unit.companyRedemption());
      cmd.append(',');
      cmd.append(unit.companyRedemptionTotal());
      cmd.append(',');
      cmd.append(unit.companyNetinvestment());
      cmd.append(',');
      cmd.append(unit.companyNetinvestmentTotal());
      cmd.append(',');
      cmd.append(unit.companyPerformance());
      cmd.append(',');
      cmd.append(unit.companyPerformanceTotal());
      cmd.append(',');
   ...
   public EResult doUpdate(FLogicUnit logicUnit,
      ...
      if(unit.isCompanyInvestmentChanged()){
         cmd.append(",`COMPANY_INVESTMENT`=");
         cmd.append(unit.companyInvestment());
      }
      if(unit.isCompanyInvestmentTotalChanged()){
         cmd.append(",`COMPANY_INVESTMENT_TOTAL`=");
         cmd.append(unit.companyInvestmentTotal());
      }
      if(unit.isCompanyRedemptionChanged()){
         cmd.append(",`COMPANY_REDEMPTION`=");
         cmd.append(unit.companyRedemption());
      }
      if(unit.isCompanyRedemptionTotalChanged()){
         cmd.append(",`COMPANY_REDEMPTION_TOTAL`=");
         cmd.append(unit.companyRedemptionTotal());
      }
      if(unit.isCompanyNetinvestmentChanged()){
         cmd.append(",`COMPANY_NETINVESTMENT`=");
         cmd.append(unit.companyNetinvestment());
      }
      if(unit.isCompanyNetinvestmentTotalChanged()){
         cmd.append(",`COMPANY_NETINVESTMENT_TOTAL`=");
         cmd.append(unit.companyNetinvestmentTotal());
      }
      if(unit.isCompanyPerformanceChanged()){
         cmd.append(",`COMPANY_PERFORMANCE`=");
         cmd.append(unit.companyPerformance());
      }
      if(unit.isCompanyPerformanceTotalChanged()){
         cmd.append(",`COMPANY_PERFORMANCE_TOTAL`=");
         cmd.append(unit.companyPerformanceTotal());
      }
