      ...
      extends FLogicUnit
{
   ...
   //============================================================
   @Override
   public FStatisticsFinancialMarketerAmountUnit clone(){
      FStatisticsFinancialMarketerAmountUnit unit = RClass.newInstance(FStatisticsFinancialMarketerAmountUnit.class);
      copy(unit);
      return unit;
   }
}
