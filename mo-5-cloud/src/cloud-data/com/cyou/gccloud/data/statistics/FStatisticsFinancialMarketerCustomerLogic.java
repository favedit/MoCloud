...
//============================================================
@ASourceMachine
public class FStatisticsFinancialMarketerCustomerLogic extends FLogicTable
{
   // 理财师客户表的定义。
   ...
   public <T extends FLogicUnit> T find(T unit, Class<T> clazz, long recordId){
      ...
      if(unit == null){
         if(clazz == null){
            unit = (T)(new FStatisticsFinancialMarketerCustomerUnit());
         }else{
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FStatisticsFinancialMarketerCustomerUnit> fetch(int pageSize, int page){
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FStatisticsFinancialMarketerCustomerUnit> fetch(CharSequence whereSql, int pageSize, int page){
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FStatisticsFinancialMarketerCustomerUnit> fetch(CharSequence whereSql, CharSequence orderSql){
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FStatisticsFinancialMarketerCustomerUnit> fetch(CharSequence whereSql, CharSequence orderSql, int pageSize, int page){
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FStatisticsFinancialMarketerCustomerUnit> fetch(CharSequence fields, CharSequence whereSql, CharSequence orderSql, int pageSize, int page){
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FStatisticsFinancialMarketerCustomerUnit> fetch(CharSequence fields, CharSequence whereSql, CharSequence groupSql, CharSequence orderSql, int pageSize, int page){
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FStatisticsFinancialMarketerCustomerUnit> fetchSql(CharSequence code, CharSequence sql, int pageSize, int page){
   ...
   public <T extends FLogicUnit> FLogicDataset<T> fetchSql(Class<T> clazz, CharSequence code, CharSequence sql, int pageSize, int page){
      ...
      if(clazz == null){
         result = (FLogicDataset<T>)(new FLogicDataset<FStatisticsFinancialMarketerCustomerUnit>(FStatisticsFinancialMarketerCustomerUnit.class, _logicContext));
      }else{
