      ...
      extends FLogicUnit
{
   ...
   public void copy(FLogicUnit logicUnit){
      ...
      unit.setDepartmentLevel(_departmentLevel);
   ...
   //============================================================
   @Override
   public FStatisticsFinancialDepartmentMarketerUnit clone(){
      FStatisticsFinancialDepartmentMarketerUnit unit = RClass.newInstance(FStatisticsFinancialDepartmentMarketerUnit.class);
      copy(unit);
      return unit;
   }
}
