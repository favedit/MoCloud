...
//============================================================
@ASourceMachine
public class FStatisticsFinancialDepartmentLogic extends FLogicTable
{
   // 部门统计表的定义。
   ...
   // 字段关联顶层编号的定义。
   public final static SLogicFieldInfo LINK_TOP_ID = new SLogicFieldInfo("LINK_TOP_ID");
   ...
   // 字段顶层标签的定义。
   public final static SLogicFieldInfo TOP_LABEL = new SLogicFieldInfo("TOP_LABEL");

   // 字段标签的定义。
   public final static SLogicFieldInfo LABEL = new SLogicFieldInfo("LABEL");

   // 字段标签路径的定义。
   public final static SLogicFieldInfo LABEL_PATH = new SLogicFieldInfo("LABEL_PATH");
   ...
   public <T extends FLogicUnit> T find(T unit, Class<T> clazz, long recordId){
      ...
      if(unit == null){
         if(clazz == null){
            unit = (T)(new FStatisticsFinancialDepartmentUnit());
         }else{
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FStatisticsFinancialDepartmentUnit> fetch(int pageSize, int page){
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FStatisticsFinancialDepartmentUnit> fetch(CharSequence whereSql, int pageSize, int page){
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FStatisticsFinancialDepartmentUnit> fetch(CharSequence whereSql, CharSequence orderSql){
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FStatisticsFinancialDepartmentUnit> fetch(CharSequence whereSql, CharSequence orderSql, int pageSize, int page){
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FStatisticsFinancialDepartmentUnit> fetch(CharSequence fields, CharSequence whereSql, CharSequence orderSql, int pageSize, int page){
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FStatisticsFinancialDepartmentUnit> fetch(CharSequence fields, CharSequence whereSql, CharSequence groupSql, CharSequence orderSql, int pageSize, int page){
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FStatisticsFinancialDepartmentUnit> fetchSql(CharSequence code, CharSequence sql, int pageSize, int page){
   ...
   public <T extends FLogicUnit> FLogicDataset<T> fetchSql(Class<T> clazz, CharSequence code, CharSequence sql, int pageSize, int page){
      ...
      if(clazz == null){
         result = (FLogicDataset<T>)(new FLogicDataset<FStatisticsFinancialDepartmentUnit>(FStatisticsFinancialDepartmentUnit.class, _logicContext));
      }else{
   ...
   public EResult doInsert(FLogicUnit logicUnit){
      ...
      cmd.append('\'');
      cmd.append(',');
      long linkTopId = unit.linkTopId();
      if(linkTopId == 0){
         cmd.append("NULL");
      }else{
         cmd.append(linkTopId);
      }
      cmd.append(',');
      ...
      cmd.append(',');
      String linkIdPath = unit.linkIdPath();
      if(RString.isEmpty(linkIdPath)){
         cmd.append("NULL");
      }else{
         cmd.append('\'');
      ...
      cmd.append(',');
      String topLabel = unit.topLabel();
      if(RString.isEmpty(topLabel)){
         cmd.append("NULL");
      }else{
         cmd.append('\'');
         cmd.append(RSql.formatValue(topLabel));
         cmd.append('\'');
      }
      cmd.append(',');
      ...
      cmd.append(',');
      String labelPath = unit.labelPath();
      if(RString.isEmpty(labelPath)){
         cmd.append("NULL");
      }else{
         cmd.append('\'');
         cmd.append(RSql.formatValue(labelPath));
         cmd.append('\'');
      }
      cmd.append(',');
