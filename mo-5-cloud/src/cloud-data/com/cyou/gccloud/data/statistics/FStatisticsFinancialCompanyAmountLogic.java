...
//============================================================
@ASourceMachine
public class FStatisticsFinancialCompanyAmountLogic
      extends FLogicTable
{
   // 公司数据统计表的定义。
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FStatisticsFinancialCompanyAmountUnit> fetch(int pageSize,
                                                                     int page){
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FStatisticsFinancialCompanyAmountUnit> fetch(CharSequence fields,
                                                                     CharSequence whereSql,
                                                                     CharSequence orderSql,
                                                                     int pageSize,
                                                                     int page){
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FStatisticsFinancialCompanyAmountUnit> fetchSql(CharSequence code,
                                                                        CharSequence sql,
                                                                        int pageSize,
                                                                        int page){
