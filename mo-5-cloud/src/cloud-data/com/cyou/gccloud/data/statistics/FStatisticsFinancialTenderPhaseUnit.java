      ...
      extends FLogicUnit
{
   ...
   public void copy(FLogicUnit logicUnit){
      ...
      unit.setTenderLabel(_tenderLabel);
   ...
   //============================================================
   @Override
   public FStatisticsFinancialTenderPhaseUnit clone(){
      FStatisticsFinancialTenderPhaseUnit unit = RClass.newInstance(FStatisticsFinancialTenderPhaseUnit.class);
      copy(unit);
      return unit;
   }
}
