      ...
      extends FLogicUnit
{
   ...
   public void unserialize(IDataInput input){
      ...
      _isValid = input.readBoolean();
      _linkId = input.readInt64();
      _linkDate.set(input.readInt64());
      _processClass = input.readString();
      _processParameters = input.readString();
      _processCount = input.readInt32();
      _processUnitTotal = input.readInt32();
      _processUnitCount = input.readInt32();
      _processResult = input.readString();
   ...
   public void serialize(IDataOutput output){
      ...
      output.writeBoolean(_isValid);
      output.writeInt64(_linkId);
      output.writeInt64(_linkDate.get());
      output.writeString(_processClass);
      output.writeString(_processParameters);
      output.writeInt32(_processCount);
      output.writeInt32(_processUnitTotal);
      output.writeInt32(_processUnitCount);
      output.writeString(_processResult);
   ...
   public void copy(FLogicUnit logicUnit){
      ...
      unit.setGuid(_guid);
      unit.setCode(_code);
      unit.setIsValid(_isValid);
      unit.setLinkId(_linkId);
      unit.linkDate().assign(_linkDate);
      unit.setProcessClass(_processClass);
      unit.setProcessParameters(_processParameters);
      unit.setProcessCount(_processCount);
      unit.setProcessUnitTotal(_processUnitTotal);
      unit.setProcessUnitCount(_processUnitCount);
      unit.setProcessResult(_processResult);
   ...
   //============================================================
   @Override
   public FStatisticsControllerUnit clone(){
      FStatisticsControllerUnit unit = RClass.newInstance(FStatisticsControllerUnit.class);
      copy(unit);
      return unit;
   }
}
