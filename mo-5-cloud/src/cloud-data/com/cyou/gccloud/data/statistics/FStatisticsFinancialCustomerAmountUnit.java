      ...
      extends FLogicUnit
{
   ...
   //============================================================
   @Override
   public FStatisticsFinancialCustomerAmountUnit clone(){
      FStatisticsFinancialCustomerAmountUnit unit = RClass.newInstance(FStatisticsFinancialCustomerAmountUnit.class);
      copy(unit);
      return unit;
   }
}
