...
//============================================================
@ASourceMachine
public class FLoggerResourceOperationLogic
      extends FLogicTable
{
   // 资源操作日志表的定义。
   ...
   // 资源操作日志表的定义。
   public final static SLogicTableInfo TABLE = new SLogicTableInfo("logger.resource.operation", "LG_RES_OPERATION");
   ...
   // 字段操作代码的定义。
   public final static SLogicFieldInfo OPERATION_CD = new SLogicFieldInfo("OPERATION_CD");
   ...
   // 字段集合的定义。
   public final static String FIELDS = "OUID,OVLD,GUID,RESOURCE_ID,USER_ID,OPERATION_CD,PARAMETERS,CREATE_USER_ID,CREATE_DATE,UPDATE_USER_ID,UPDATE_DATE";

   //============================================================
   // <T>构造资源操作日志表逻辑单元。</T>
   //============================================================
   public FLoggerResourceOperationLogic(){
      _name = TABLE.name();
      _classUnit = FLoggerResourceOperationUnit.class;
   }
   ...
   // @param context 逻辑环境
   //============================================================
   public FLoggerResourceOperationLogic(ILogicContext context){
      super(context);
      _name = TABLE.name();
      _classUnit = FLoggerResourceOperationUnit.class;
   }
   ...
   public <T extends FLogicUnit> T find(T unit,
      ...
      if(unit == null){
         if(clazz == null){
            unit = (T)(new FLoggerResourceOperationUnit());
         }else{
   ...
   // @return 数据单元
   //============================================================
   public FLoggerResourceOperationUnit search(CharSequence whereSql){
      return search(null, FLoggerResourceOperationUnit.class, whereSql);
   }
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FLoggerResourceOperationUnit> fetch(int pageSize,
                                                            int page){
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FLoggerResourceOperationUnit> fetch(CharSequence whereSql,
                                                            int pageSize,
                                                            int page){
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FLoggerResourceOperationUnit> fetch(CharSequence fields,
                                                            CharSequence whereSql,
                                                            CharSequence orderSql,
                                                            int pageSize,
                                                            int page){
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FLoggerResourceOperationUnit> fetchSql(CharSequence code,
                                                               CharSequence sql,
                                                               int pageSize,
                                                               int page){
   ...
   public <T extends FLogicUnit> FLogicDataset<T> fetchSql(Class<T> clazz,
      ...
      if(clazz == null){
         result = (FLogicDataset<T>)(new FLogicDataset<FLoggerResourceOperationUnit>(FLoggerResourceOperationUnit.class, _logicContext));
      }else{
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FLoggerResourceOperationUnit> fetchAll(){
      // 生成命令
   ...
   // @return 数据单元
   //============================================================
   public FLoggerResourceOperationUnit doPrepare(){
      FLoggerResourceOperationUnit unit = new FLoggerResourceOperationUnit();
      unit.linkLogicContext(_logicContext);
      doPrepare(unit);
      return unit;
   }
   ...
   public EResult doPrepare(FLogicUnit logicUnit){
      FLoggerResourceOperationUnit unit = (FLoggerResourceOperationUnit)logicUnit;
      unit.setOvld(true);
