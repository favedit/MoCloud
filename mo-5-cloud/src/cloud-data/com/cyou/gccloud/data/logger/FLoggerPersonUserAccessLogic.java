...
//============================================================
@ASourceMachine
public class FLoggerPersonUserAccessLogic
      extends FLogicTable
{
   // 人员用户访问的定义。
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FLoggerPersonUserAccessUnit> fetch(int pageSize,
                                                           int page){
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FLoggerPersonUserAccessUnit> fetch(CharSequence fields,
                                                           CharSequence whereSql,
                                                           CharSequence orderSql,
                                                           int pageSize,
                                                           int page){
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FLoggerPersonUserAccessUnit> fetchSql(CharSequence code,
                                                              CharSequence sql,
                                                              int pageSize,
                                                              int page){
