      ...
      extends FLogicUnit
{
   ...
   public void copy(FLogicUnit logicUnit){
      ...
      unit.setModuleCode(_moduleCode);
      unit.setModuleAction(_moduleAction);
      unit.setModuleResult(_moduleResult);
      unit.setBrowserUri(_browserUri);
      unit.setPageInfo(_pageInfo);
   ...
   //============================================================
   @Override
   public FLoggerPersonUserModuleUnit clone(){
      FLoggerPersonUserModuleUnit unit = RClass.newInstance(FLoggerPersonUserModuleUnit.class);
      copy(unit);
      return unit;
   }
}
