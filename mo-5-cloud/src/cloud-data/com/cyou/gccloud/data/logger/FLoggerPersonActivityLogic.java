...
//============================================================
@ASourceMachine
public class FLoggerPersonActivityLogic
      extends FLogicTable
{
   // 用户活动日志表的定义。
   ...
   // 用户活动日志表的定义。
   public final static SLogicTableInfo TABLE = new SLogicTableInfo("logger.person.activity", "LG_PSN_ACTIVITY");
   ...
   // 字段集合的定义。
   public final static String FIELDS = "OUID,OVLD,GUID,USER_ID,ACTIVITY_ID,OPERATION_CD,RESOURCE_ID,PARAMETERS,CREATE_USER_ID,CREATE_DATE,UPDATE_USER_ID,UPDATE_DATE";

   //============================================================
   // <T>构造用户活动日志表逻辑单元。</T>
   //============================================================
   public FLoggerPersonActivityLogic(){
      _name = TABLE.name();
      _classUnit = FLoggerPersonActivityUnit.class;
   }
   ...
   // @param context 逻辑环境
   //============================================================
   public FLoggerPersonActivityLogic(ILogicContext context){
      super(context);
      _name = TABLE.name();
      _classUnit = FLoggerPersonActivityUnit.class;
   }
   ...
   public <T extends FLogicUnit> T find(T unit,
      ...
      if(unit == null){
         if(clazz == null){
            unit = (T)(new FLoggerPersonActivityUnit());
         }else{
   ...
   // @return 数据单元
   //============================================================
   public FLoggerPersonActivityUnit search(CharSequence whereSql){
      return search(null, FLoggerPersonActivityUnit.class, whereSql);
   }
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FLoggerPersonActivityUnit> fetch(int pageSize,
                                                         int page){
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FLoggerPersonActivityUnit> fetch(CharSequence whereSql,
                                                         int pageSize,
                                                         int page){
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FLoggerPersonActivityUnit> fetch(CharSequence fields,
                                                         CharSequence whereSql,
                                                         CharSequence orderSql,
                                                         int pageSize,
                                                         int page){
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FLoggerPersonActivityUnit> fetchSql(CharSequence code,
                                                            CharSequence sql,
                                                            int pageSize,
                                                            int page){
   ...
   public <T extends FLogicUnit> FLogicDataset<T> fetchSql(Class<T> clazz,
      ...
      if(clazz == null){
         result = (FLogicDataset<T>)(new FLogicDataset<FLoggerPersonActivityUnit>(FLoggerPersonActivityUnit.class, _logicContext));
      }else{
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FLoggerPersonActivityUnit> fetchAll(){
      // 生成命令
   ...
   // @return 数据单元
   //============================================================
   public FLoggerPersonActivityUnit doPrepare(){
      FLoggerPersonActivityUnit unit = new FLoggerPersonActivityUnit();
      unit.linkLogicContext(_logicContext);
      doPrepare(unit);
      return unit;
   }
   ...
   public EResult doPrepare(FLogicUnit logicUnit){
      FLoggerPersonActivityUnit unit = (FLoggerPersonActivityUnit)logicUnit;
      unit.setOvld(true);
