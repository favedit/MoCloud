...
//============================================================
@ASourceMachine
public class FLoggerPersonOperationLogic
      extends FLogicTable
{
   // 用户操作日志的定义。
   ...
   // 用户操作日志的定义。
   public final static SLogicTableInfo TABLE = new SLogicTableInfo("logger.person.operation", "LG_PSN_OPERATION");
   ...
   // 字段集合的定义。
   public final static String FIELDS = "OUID,OVLD,GUID,USER_ID,OPERATION_CD,PARAMETERS,CREATE_USER_ID,CREATE_DATE,UPDATE_USER_ID,UPDATE_DATE";

   //============================================================
   // <T>构造用户操作日志逻辑单元。</T>
   //============================================================
   public FLoggerPersonOperationLogic(){
      _name = TABLE.name();
      _classUnit = FLoggerPersonOperationUnit.class;
   }
   ...
   // @param context 逻辑环境
   //============================================================
   public FLoggerPersonOperationLogic(ILogicContext context){
      super(context);
      _name = TABLE.name();
      _classUnit = FLoggerPersonOperationUnit.class;
   }
   ...
   public <T extends FLogicUnit> T find(T unit,
      ...
      if(unit == null){
         if(clazz == null){
            unit = (T)(new FLoggerPersonOperationUnit());
         }else{
   ...
   // @return 数据单元
   //============================================================
   public FLoggerPersonOperationUnit search(CharSequence whereSql){
      return search(null, FLoggerPersonOperationUnit.class, whereSql);
   }
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FLoggerPersonOperationUnit> fetch(int pageSize,
                                                          int page){
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FLoggerPersonOperationUnit> fetch(CharSequence whereSql,
                                                          int pageSize,
                                                          int page){
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FLoggerPersonOperationUnit> fetch(CharSequence fields,
                                                          CharSequence whereSql,
                                                          CharSequence orderSql,
                                                          int pageSize,
                                                          int page){
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FLoggerPersonOperationUnit> fetchSql(CharSequence code,
                                                             CharSequence sql,
                                                             int pageSize,
                                                             int page){
   ...
   public <T extends FLogicUnit> FLogicDataset<T> fetchSql(Class<T> clazz,
      ...
      if(clazz == null){
         result = (FLogicDataset<T>)(new FLogicDataset<FLoggerPersonOperationUnit>(FLoggerPersonOperationUnit.class, _logicContext));
      }else{
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FLoggerPersonOperationUnit> fetchAll(){
      // 生成命令
   ...
   // @return 数据单元
   //============================================================
   public FLoggerPersonOperationUnit doPrepare(){
      FLoggerPersonOperationUnit unit = new FLoggerPersonOperationUnit();
      unit.linkLogicContext(_logicContext);
      doPrepare(unit);
      return unit;
   }
   ...
   public EResult doPrepare(FLogicUnit logicUnit){
      FLoggerPersonOperationUnit unit = (FLoggerPersonOperationUnit)logicUnit;
      unit.setOvld(true);
