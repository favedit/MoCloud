...
//============================================================
@ASourceMachine
public class FLoggerSystemLoggerUnit extends FLogicUnit
{
   // 存储字段对象标识的定义。
   private long __ouid;
   ...
   // <T>构造系统跟踪日志表    逻辑单元。</T>
   //============================================================
   public FLoggerSystemLoggerUnit(){
   }
   ...
   // @return 数据内容
   //============================================================
   public boolean isLevelCdChanged(){
      return __levelCd != _levelCd;
   }
   ...
   // @param value 数据内容
   //============================================================
   public void setLevelCd(int value){
      _levelCd = value;
   }
   ...
   public String get(String name){
      switch(name){
         ...
         case "level_cd":
            return RInteger.toString(_levelCd);
         case "code":
            return _code;
         case "parameters":
            return _parameters;
      ...
      for(IStringPair pair : row){
         ...
         switch(name){
            ...
            case "user_id":
               ...
               break;
            case "level_cd":
               __levelCd = RInteger.parse(value);
               _levelCd = __levelCd;
               break;
            case "code":
               __code = value;
   ...
   public void saveMap(Map<String, String> map){
      ...
      map.put("levelCd", RInteger.toString(_levelCd));
      map.put("code", _code);
