...
//============================================================
@ASourceMachine
public class FLoggerPersonUserModuleLogic
      extends FLogicTable
{
   // 人员模块访问的定义。
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FLoggerPersonUserModuleUnit> fetch(int pageSize,
                                                           int page){
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FLoggerPersonUserModuleUnit> fetch(CharSequence fields,
                                                           CharSequence whereSql,
                                                           CharSequence orderSql,
                                                           int pageSize,
                                                           int page){
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FLoggerPersonUserModuleUnit> fetchSql(CharSequence code,
                                                              CharSequence sql,
                                                              int pageSize,
                                                              int page){
