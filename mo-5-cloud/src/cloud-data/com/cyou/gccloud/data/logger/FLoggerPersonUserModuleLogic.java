...
//============================================================
@ASourceMachine
public class FLoggerPersonUserModuleLogic extends FLogicTable
{
   // 人员模块访问的定义。
   public final static SLogicConnectionInfo CONNECTION = new SLogicConnectionInfo("logger");

   // 人员模块访问的定义。
   public final static SLogicTableInfo TABLE = new SLogicTableInfo("logger.person.user.module", "LG_PSN_USER_MODULE");
   ...
   // 字段模块代码的定义。
   public final static SLogicFieldInfo MODULE_CODE = new SLogicFieldInfo("MODULE_CODE");

   // 字段模块命令的定义。
   public final static SLogicFieldInfo MODULE_ACTION = new SLogicFieldInfo("MODULE_ACTION");

   // 字段模块结果的定义。
   public final static SLogicFieldInfo MODULE_RESULT = new SLogicFieldInfo("MODULE_RESULT");
   ...
   // 字段集合的定义。
   public final static String FIELDS = "`OUID`,`OVLD`,`GUID`,`USER_ID`,`PASSPORT`,`MODULE_CODE`,`MODULE_ACTION`,`MODULE_RESULT`,`BROWSER_URI`,`PAGE_INFO`,`CREATE_USER_ID`,`CREATE_DATE`,`UPDATE_USER_ID`,`UPDATE_DATE`";

   //============================================================
   // <T>构造人员模块访问逻辑单元。</T>
   //============================================================
   public FLoggerPersonUserModuleLogic(){
      _name = TABLE.name();
      _classUnit = FLoggerPersonUserModuleUnit.class;
   }
   ...
   // @param context 逻辑环境
   //============================================================
   public FLoggerPersonUserModuleLogic(ILogicContext context){
      super(context);
      _name = TABLE.name();
      _classUnit = FLoggerPersonUserModuleUnit.class;
   }
   ...
   public <T extends FLogicUnit> T find(T unit, Class<T> clazz, long recordId){
      ...
      if(unit == null){
         if(clazz == null){
            unit = (T)(new FLoggerPersonUserModuleUnit());
         }else{
   ...
   // @return 数据单元
   //============================================================
   public FLoggerPersonUserModuleUnit findByGuid(CharSequence guid){
      return findByGuid(null, FLoggerPersonUserModuleUnit.class, guid);
   }
   ...
   // @return 数据单元
   //============================================================
   public FLoggerPersonUserModuleUnit search(CharSequence whereSql){
      return search(null, FLoggerPersonUserModuleUnit.class, whereSql);
   }
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FLoggerPersonUserModuleUnit> fetch(CharSequence whereSql){
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FLoggerPersonUserModuleUnit> fetch(int pageSize, int page){
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FLoggerPersonUserModuleUnit> fetch(CharSequence whereSql, int pageSize, int page){
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FLoggerPersonUserModuleUnit> fetch(CharSequence whereSql, CharSequence orderSql){
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FLoggerPersonUserModuleUnit> fetch(CharSequence whereSql, CharSequence orderSql, int pageSize, int page){
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FLoggerPersonUserModuleUnit> fetch(CharSequence fields, CharSequence whereSql, CharSequence orderSql, int pageSize, int page){
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FLoggerPersonUserModuleUnit> fetch(CharSequence fields, CharSequence whereSql, CharSequence groupSql, CharSequence orderSql, int pageSize, int page){
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FLoggerPersonUserModuleUnit> fetchSql(CharSequence code, CharSequence sql, int pageSize, int page){
   ...
   public <T extends FLogicUnit> FLogicDataset<T> fetchSql(Class<T> clazz, CharSequence code, CharSequence sql, int pageSize, int page){
      ...
      if(clazz == null){
         result = (FLogicDataset<T>)(new FLogicDataset<FLoggerPersonUserModuleUnit>(FLoggerPersonUserModuleUnit.class, _logicContext));
      }else{
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FLoggerPersonUserModuleUnit> fetchAll(){
      // 生成命令
   ...
   // @return 数据单元
   //============================================================
   public FLoggerPersonUserModuleUnit doPrepare(){
      FLoggerPersonUserModuleUnit unit = new FLoggerPersonUserModuleUnit();
      unit.linkLogicContext(_logicContext);
      doPrepare(unit);
      return unit;
   }
   ...
   public EResult doPrepare(FLogicUnit logicUnit){
      FLoggerPersonUserModuleUnit unit = (FLoggerPersonUserModuleUnit)logicUnit;
      unit.setOvld(true);
   ...
   public EResult doInsert(FLogicUnit logicUnit){
      ...
      cmd.append(",`USER_ID`");
      cmd.append(",`PASSPORT`");
      cmd.append(",`MODULE_CODE`");
      cmd.append(",`MODULE_ACTION`");
      cmd.append(",`MODULE_RESULT`");
      ...
      cmd.append(',');
      String moduleCode = unit.moduleCode();
      if(RString.isEmpty(moduleCode)){
         cmd.append("NULL");
      }else{
         cmd.append('\'');
         cmd.append(RSql.formatValue(moduleCode));
         cmd.append('\'');
      }
      cmd.append(',');
      String moduleAction = unit.moduleAction();
      if(RString.isEmpty(moduleAction)){
         cmd.append("NULL");
      }else{
         cmd.append('\'');
         cmd.append(RSql.formatValue(moduleAction));
         cmd.append('\'');
      }
      cmd.append(',');
      String moduleResult = unit.moduleResult();
      if(RString.isEmpty(moduleResult)){
         cmd.append("NULL");
      }else{
         cmd.append('\'');
         cmd.append(RSql.formatValue(moduleResult));
         cmd.append('\'');
      }
      cmd.append(',');
