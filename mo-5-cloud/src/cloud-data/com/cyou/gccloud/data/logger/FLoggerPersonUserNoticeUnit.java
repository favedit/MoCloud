      ...
      extends FLogicUnit
{
   ...
   // 存储字段公告编号的定义。
   private long __noticeId;

   // 字段公告编号的定义。
   protected long _noticeId;
   ...
   // @return 数据内容
   //============================================================
   public boolean isNoticeIdChanged(){
      return __noticeId != _noticeId;
   }
      ...
      for(IStringPair pair : row){
         ...
         switch(name){
            ...
            case "user_id":
               ...
               break;
            case "notice_id":
               __noticeId = RLong.parse(value);
               _noticeId = __noticeId;
               break;
            case "active_cd":
