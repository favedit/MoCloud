...
//============================================================
@ASourceMachine
public class FLoggerSystemLoggerLogic extends FLogicTable
{
   // 系统跟踪日志表    的定义。
   public final static SLogicConnectionInfo CONNECTION = new SLogicConnectionInfo("logger");

   // 系统跟踪日志表    的定义。
   public final static SLogicTableInfo TABLE = new SLogicTableInfo("logger.system.logger", "LG_SYS_LOGGER");
   ...
   // 字段级别的定义。
   public final static SLogicFieldInfo LEVEL_CD = new SLogicFieldInfo("LEVEL_CD");
   ...
   // 字段集合的定义。
   public final static String FIELDS = "`OUID`,`OVLD`,`GUID`,`RECORD_DATE`,`SERVER_CODE`,`SERVER_HOST`,`USER_ID`,`LEVEL_CD`,`CODE`,`PARAMETERS`,`DESCRIPTION`,`CREATE_USER_ID`,`CREATE_DATE`,`UPDATE_USER_ID`,`UPDATE_DATE`";

   //============================================================
   // <T>构造系统跟踪日志表    逻辑单元。</T>
   //============================================================
   public FLoggerSystemLoggerLogic(){
      _name = TABLE.name();
      _classUnit = FLoggerSystemLoggerUnit.class;
   }
   ...
   // @param context 逻辑环境
   //============================================================
   public FLoggerSystemLoggerLogic(ILogicContext context){
      super(context);
      _name = TABLE.name();
      _classUnit = FLoggerSystemLoggerUnit.class;
   }
   ...
   public <T extends FLogicUnit> T find(T unit, Class<T> clazz, long recordId){
      ...
      if(unit == null){
         if(clazz == null){
            unit = (T)(new FLoggerSystemLoggerUnit());
         }else{
   ...
   // @return 数据单元
   //============================================================
   public FLoggerSystemLoggerUnit findByGuid(CharSequence guid){
      return findByGuid(null, FLoggerSystemLoggerUnit.class, guid);
   }
   ...
   // @return 数据单元
   //============================================================
   public FLoggerSystemLoggerUnit search(CharSequence whereSql){
      return search(null, FLoggerSystemLoggerUnit.class, whereSql);
   }
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FLoggerSystemLoggerUnit> fetch(CharSequence whereSql){
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FLoggerSystemLoggerUnit> fetch(int pageSize, int page){
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FLoggerSystemLoggerUnit> fetch(CharSequence whereSql, int pageSize, int page){
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FLoggerSystemLoggerUnit> fetch(CharSequence whereSql, CharSequence orderSql){
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FLoggerSystemLoggerUnit> fetch(CharSequence whereSql, CharSequence orderSql, int pageSize, int page){
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FLoggerSystemLoggerUnit> fetch(CharSequence fields, CharSequence whereSql, CharSequence orderSql, int pageSize, int page){
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FLoggerSystemLoggerUnit> fetch(CharSequence fields, CharSequence whereSql, CharSequence groupSql, CharSequence orderSql, int pageSize, int page){
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FLoggerSystemLoggerUnit> fetchSql(CharSequence code, CharSequence sql, int pageSize, int page){
   ...
   public <T extends FLogicUnit> FLogicDataset<T> fetchSql(Class<T> clazz, CharSequence code, CharSequence sql, int pageSize, int page){
      ...
      if(clazz == null){
         result = (FLogicDataset<T>)(new FLogicDataset<FLoggerSystemLoggerUnit>(FLoggerSystemLoggerUnit.class, _logicContext));
      }else{
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FLoggerSystemLoggerUnit> fetchAll(){
      // 生成命令
   ...
   // @return 数据单元
   //============================================================
   public FLoggerSystemLoggerUnit doPrepare(){
      FLoggerSystemLoggerUnit unit = new FLoggerSystemLoggerUnit();
      unit.linkLogicContext(_logicContext);
      doPrepare(unit);
      return unit;
   }
