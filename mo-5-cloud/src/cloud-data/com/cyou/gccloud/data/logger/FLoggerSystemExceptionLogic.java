      ...
      extends FLogicTable
{
   ...
   // 字段集合的定义。
   public final static String FIELDS = "OUID,OVLD,GUID,RECORD_DATE,SERVER_CODE,USER_ID,CODE,PARAMETERS,DESCRIPTION,CREATE_USER_ID,CREATE_DATE,UPDATE_USER_ID,UPDATE_DATE";
