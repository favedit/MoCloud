         ...
         IGcSessionConsole
{
   ...
   @Override
   public FLogicDataset<FGcSessionInfo> findByUserAndAppId(ILogicContext context,
                                                           long userId,
                                                           long applicationId){
      String whereSql = "(" + FCacheSystemSessionLogic.USER_ID + "=" + userId + ") AND (" + FCacheSystemSessionLogic.OVLD + "=1) AND (" + FCacheSystemSessionLogic.APPLICATION_ID + "=" + applicationId;
      FCacheSystemSessionLogic logic = findLogic(context);
      FLogicDataset<FGcSessionInfo> sessions = logic.fetchClass(FGcSessionInfo.class, whereSql);
      return sessions;
   }
