...
// <T>整数校验器。</T>
//============================================================
public class RGcIntegerValidator
{
   // 资源访问接口
   private static IResource _resource = RResource.find(RGcIntegerValidator.class);
   ...
   public static void checkValue(IMessageContext context,
                                 ...
                                 String label){
      // 获得内容
      int valueInteger = RInteger.parse(value);
      //............................................................
      String text = null;
      String code = null;
      String length = null;
      ...
      if(RString.isNotEmpty(valueMin)){
         int min = RInteger.parse(valueMin);
      ...
      if(RString.isNotEmpty(valueMax)){
         int max = RInteger.parse(valueMax);
