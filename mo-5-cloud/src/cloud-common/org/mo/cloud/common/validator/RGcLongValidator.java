...
// <T>长整数校验器。</T>
//============================================================
public class RGcLongValidator
{
   // 资源访问接口
   private static IResource _resource = RResource.find(RGcLongValidator.class);
   ...
   public static void checkValue(IMessageContext context,
                                 ...
                                 String label){
      // 获得内容
      long valueInteger = RLong.parse(value);
      //............................................................
      String text = null;
      String code = null;
      String length = null;
