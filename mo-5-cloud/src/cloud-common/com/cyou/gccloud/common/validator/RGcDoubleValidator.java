...
// <T>整数校验器。</T>
//============================================================
public class RGcDoubleValidator
{
   // 资源访问接口
   private static IResource _resource = RResource.find(RGcDoubleValidator.class);
   ...
   public static void checkValue(IMessageContext context,
                                 ...
                                 String label){
      // 获得内容
      double valueInteger = RDouble.parse(value);
      //............................................................
      String text = null;
      String code = null;
      String length = null;
      ...
      if(RString.isNotEmpty(valueMin)){
         double min = RDouble.parse(valueMin);
      ...
      if(RString.isNotEmpty(valueMax)){
         double max = RDouble.parse(valueMax);
