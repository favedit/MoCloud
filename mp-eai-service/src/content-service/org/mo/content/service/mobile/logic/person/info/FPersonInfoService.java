...
// <T>登录服务。</T>
//============================================================
public class FPersonInfoService
      extends FObject
      implements
         IPersonInfoService
{
   ...
   // ============================================================
   @Override
   public EResult personInfo(IWebContext context,
                             IWebInput input,
                             IWebOutput output,
      ...
      // 返回上一次的打卡时间和用户的个人信息
      FDataPersonInfo userInfo = _personInfoConsole.getUserInfo(sessionInfo.userId(), logicContext);
      if(userInfo != null){
      ...
      // 查看用户是否有最新的公告
      FLogicDataset<FDataLogicNoticeUnit> noticeUnits = _personInfoConsole.isThereNotices(sessionInfo.userId(), sessionContext, logicContext, _sessionConsole, _webSessionConsole);
