...
// <T>登录服务。</T>
//============================================================
public class FLoginService extends FObject implements ILoginService {
    // 日志输出接口
    ...
    // ============================================================
    @Override
    public EResult login(IWebContext context, IWebInput input,
        ...
        FDataSystemApplicationUnit applicationUnit = _loginConsole
                .getApplicationUnitByGuid(logicContext, applicationStr);
        ...
        if (user.statusCd() == EGcAuthorityResult.OaSuccess) {
            ...
            icon_url.setText("http://service.test.eai.ezubo.com/manage/images/userdefault.png");
    ...
    // ============================================================
    @Override
    public EResult autoLogin(IWebContext context, IWebInput input,
            IWebOutput output, ILogicContext logicContext,
            IWebSession sessionContext) {
        // FXmlNode inputNode = input.config();
    ...
    // ============================================================
    @Override
    public EResult logout(IWebContext context, IWebInput input,
            IWebOutput output, ILogicContext logicContext,
            IWebSession sessionContext) {
        // 获得参数
        String sessionCode = context.head("mo-session-id");
    ...
    public EResult query(IWebContext context, IWebInput input,
        ...
        FDataPersonUserUnit user = _loginConsole.query(context, userGuid,
                logicContext, sessionContext);
    ...
    // ============================================================
    @Override
    public EResult update(IWebContext context, IWebInput input,
            IWebOutput output, ILogicContext logicContext,
            IWebSession sessionContext) {
        ...
        FXmlNode xruntime = output.config().createNode("User");
        FDataPersonUserUnit user = _loginConsole.update(context, unit,
                logicContext, sessionContext);
        // 如果返回-1意味着根据guid没有找到用户
        if (user.statusCd() == -1) {
            xruntime.set("status_cd", user.statusCd());
    ...
    // ============================================================
    @Override
    public EResult feedback(IWebContext context, IWebInput input,
            IWebOutput output, ILogicContext logicContext,
            IWebSession sessionContext) {
        // 获得参数
        // FXmlNode inputNode = input.config();
