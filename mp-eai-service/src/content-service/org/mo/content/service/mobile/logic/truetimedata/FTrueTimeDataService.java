...
// <T>实时数据服务。</T>
//============================================================
public class FTrueTimeDataService extends FObject implements
    ...
    public EResult query(IWebContext context, IWebInput input,
        ...
        FDataLogicTruetimeUnit newsUnit = _trueTimeDataConsole.getNewsByGuid(
                guid, logicContext);
        if (newsUnit != null) {
    ...
    public EResult select(IWebContext context, IWebInput input,
            IWebOutput output, ILogicContext logicContext) {
        _logger.debug(this, "FNewsService_select",
                "FNewsService_select begin. ");
        ...
        FLogicDataset<FDataLogicTruetimeUnit> newsUnits = _trueTimeDataConsole
        ...
        if (newsUnits != null && newsUnits.count() > 0) {
            for (Iterator<FDataLogicTruetimeUnit> iterator = newsUnits
                ...
                if (guidStr != null && (!"".equals(guidStr))) {
                    ...
                    if (newsUnit.linkCd() == EGcLink.Content) {
                        xruntime.createNode("info_url")
                                .setText(
                                        _trueTimeDataHost
                                                + "mobile/logic/truetimedata/TrueTimeData.wa?do=getContent&guid="
                                                + newsUnit.guid());
                    }
                } else {
