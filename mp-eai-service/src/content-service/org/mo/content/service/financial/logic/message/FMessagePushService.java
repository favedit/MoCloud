...
// <T>短信推送服务。</T>
//============================================================
public class FMessagePushService extends FObject implements IMessagePushService {
    // 日志输出接口
    ...
    public EResult pushSMS(IWebContext context, IWebSession sessionContext,
        ...
        _logger.debug(this, "pushSMS ",
                "The Method pushSMS From FMessagePushService  is beginning. ");
        ...
        _logger.debug(this, "pushSMS",
                "-----------------------linkIdStr={1},loginDateStr={2}",
                linkIdStr, loginDateStr);
        String linkId = "12";
        String dateTimeStr = new TDateTime(RDateTime.currentDateTime())
                .toString();
        ...
        _messagePushConsole.pushSMS(linkId, dateTimeStr, logicContext, context,
                sessionContext);
        return EResult.Success;
    }
