...
//@version 151106
//============================================================
public class FStatisticsMarketerCustomerConsole
      extends FAbstractLogicUnitConsole<FStatisticsFinancialMarketerCustomerLogic, FStatisticsFinancialMarketerCustomerUnit>
      implements
         IStatisticsMarketerCustomerConsole
{

   // 日志输出接口
   private static ILogger _logger = RLogger.find(FStatisticsMarketerCustomerConsole.class);
   ...
   // <T>构造设备控制台。</T>
   //============================================================
   public FStatisticsMarketerCustomerConsole(){
