...
// <T>建周短信发送控制台。</T>
//============================================================
public class FMessageConsole extends FObject implements IMessageConsole {
    // 日志输出接口
    ...
    public int sendBatchMessage(String mobile, String msgText) {
        _logger.debug(
                this,
                "sendBatchMessage",
                "The Method sendBatchMessage From FMessageConsole  is beginning. mobile={1},msgText={2}",
                mobile, msgText);
        BusinessService bs = new BusinessService();
        bs.setWebService(webServiceURL);
        int result = bs.sendBatchMessage(passport1, password1, mobile, msgText
                + sign);
        return result;
    }
}
