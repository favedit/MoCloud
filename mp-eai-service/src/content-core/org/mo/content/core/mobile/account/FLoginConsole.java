...
// <T>登录控制台。</T>
//============================================================
public class FLoginConsole extends FObject implements ILoginConsole {
    // 日志输出接口
    ...
    public FDataPersonUserInfo getUserInfo(long user_id,
        ...
        FLogicDataset<FDataPersonUserInfo> userInfos = userLogic.fetchClass(
                FDataPersonUserInfo.class, userFSql);
