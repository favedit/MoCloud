...
// <T>投资模式。</T>
//============================================================
public class FPerformanceModel
      extends FObject
{
   // 代码
   ...
   public double calculateGain(double currency,
      ...
      double gain = 0;
      // 计算盈利
      if(_horizonUnit == EPerformanceUnit.Day){
         gain = currency * _rateDay * _horizonCount;
      }else if(_horizonUnit == EPerformanceUnit.Month){
   ...
   public void loadConfig(FXmlNode xconfig){
      ...
      if(horizonUnit.equals("day")){
         _horizonUnit = EPerformanceUnit.Day;
      }else if(horizonUnit.equals("month")){
         _horizonUnit = EPerformanceUnit.Month;
      }else{
