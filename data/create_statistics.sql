...
( 
   ...
   `COMPANY_INVESTMENT`            DOUBLE, 
   `COMPANY_INVESTMENT_TOTAL`      DOUBLE, 
   `COMPANY_REDEMPTION`            DOUBLE, 
   `COMPANY_REDEMPTION_TOTAL`      DOUBLE, 
   `COMPANY_NETINVESTMENT`         DOUBLE, 
   `COMPANY_NETINVESTMENT_TOTAL`   DOUBLE, 
   `COMPANY_PERFORMANCE`           DOUBLE, 
   `COMPANY_PERFORMANCE_TOTAL`     DOUBLE, 
   `MARKETER_REGISTER`             INTEGER, 
   `MARKETER_TOTAL`                BIGINT, 
   `CUSTOMER_REGISTER`             INTEGER, 
   `CUSTOMER_TOTAL`                INTEGER, 
...
ALTER TABLE ST_FIN_COMPANY_PHASE 
   ADD CONSTRAINT ST_FIN_COM_PHS_UK_DAT UNIQUE ( RECORD_DATE, COMPANY_ID ); 
