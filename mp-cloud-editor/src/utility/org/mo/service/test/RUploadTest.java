...
public class RUploadTest
{
   ...
   public static void main(String[] args){
      ...
      //      inputNode.set("action", "login");
      //      inputNode.createNode("Passport").setText("maocy");
      //      inputNode.createNode("Password").setText("maocy");
      //
      //      FByteFile file = new FByteFile("D:/ADT-22.6.2.zip");
      //      byte data[] = file.toArray();
      //      file.close();
      //
      //      String url = "http://localhost:89/cloud.resource.upload.wv?type_cd=application&code=" + "abcd.zip" + "&size=" + data.length + "&position=" + 0 + "&length=" + data.length;
      //      FHttpConnection connection = new FHttpConnection(url);
      ...
      //      connection.request().setData(data);
