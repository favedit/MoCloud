         ...
         INoticeConsole
{
   ...
   public FDataLogicNoticeUnit markRead(long userId,
                                        ...
                                        ILogicContext logicContext){
      FLoggerPersonUserNoticeLogic personUserNoticeLogic = logicContext.findLogic(FLoggerPersonUserNoticeLogic.class);
      ...
      if(resultLong == 0){
         ...
         if(noticeUnits != null && noticeUnits.count() > 0){
            ...
            FLoggerPersonUserNoticeUnit minUnit1 = personUserNoticeLogic.fetch(whereSql5).first();
            ...
            FLoggerPersonUserNoticeUnit maxUnit2 = personUserNoticeLogic.fetch(whereSql6).first();
            ...
            FLogicDataset<FLoggerPersonUserNoticeUnit> fetch2 = personUserNoticeLogic.fetch(whereSql10);
