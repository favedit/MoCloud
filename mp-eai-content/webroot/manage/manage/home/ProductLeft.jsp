      ...
      <div id="cy_left">
         ...
         <ul class="accordion">
            <li id="one" class="common"> <a href="#one">设备管理</a>
               <ul class="sub-menu">
                  <li><a href="/manage/device/Device.wa" target="right">设备信息</a></li>
               </ul>
            </li>
            <li id="two" class="classify"> <a href="#two">用户管理</a>
               <ul class="sub-menu">
                  <li><a href="/manage/logger/user/Access.wa" target="right">用户日志</a></li>
                  <li><a href="/manage/person/user/Access.wa" target="right">白名单</a></li>
               </ul>
            </li>
         </ul>
