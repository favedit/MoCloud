<%@ include file='/apl/public.inc' %>
   ...
   <HEAD>
      <TITLE>
         ...
         <jh:equals source="&page.sceneCode" value="ChartMarketerManage">e租宝-全球理财师数据展示中心-钰诚集团智慧企业</jh:equals>
         <jh:equals source="&page.sceneCode" value="ChartStatisticsMarketer">e租宝-全国各省投资总额展示中心-钰诚集团智慧企业</jh:equals>
         <jh:equals source="&page.sceneCode" value="ChartPerformenceMarketer">e租宝-全球实时统计数据展示中心-钰诚集团智慧企业</jh:equals>
      </TITLE>
