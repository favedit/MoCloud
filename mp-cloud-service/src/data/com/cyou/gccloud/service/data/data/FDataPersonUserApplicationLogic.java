...
// <T>用户应用表逻辑。</T>
//============================================================
public class FDataPersonUserApplicationLogic extends FLogicDataset
{
   // 用户应用表的定义。
   public final static FLogicTable Table = new FLogicTable("DT_PSN_USER_APPLICATION");
   ...
   // 字段应用编号的定义。
   public final static FLogicField FieldApplicationId = new FLogicField("APPLICATION_ID");

   // 字段评价代码的定义。
   public final static FLogicField FieldEstimateCd = new FLogicField("ESTIMATE_CD");
   ...
   // <T>构造用户应用表逻辑单元。</T>
   //============================================================
   public FDataPersonUserApplicationLogic(){
   }
   ...
   // @param connect 数据链接
   //============================================================
   public FDataPersonUserApplicationLogic(ISqlConnect connect){
   ...
   //============================================================
   public FDataPersonUserApplicationLogic(ISqlConnection connection){
   ...
   // @return 数据单元
   //============================================================
   public FDataPersonUserApplicationUnit find(long recordId){
      // 检查记录编号
      if(0 == recordId){
         return null;
      }
      ...
      // 获得数据
      FDataPersonUserApplicationUnit unit = new FDataPersonUserApplicationUnit();
      unit.load(row);
      return unit;
   }
   ...
   // @return 数据单元
   //============================================================
   public FDataPersonUserApplicationUnit serach(String whereSql){
      // 生成命令
      FSql sql = new FSql("SELECT * FROM ");
      sql.append(Table.name());
      sql.append(" WHERE ");
   ...
   // @return 数据单元集合
   //============================================================
   public FDataPersonUserApplicationUnit[] fetch(String whereSql){
   ...
   // @return 数据单元集合
   //============================================================
   public FDataPersonUserApplicationUnit[] fetch(String whereSql, String orderSql){
   ...
   // @return 数据单元集合
   //============================================================
   public FDataPersonUserApplicationUnit[] fetch(String whereSql, String orderSql, int limitCount){
      // 生成命令
      FSql sql = new FSql("SELECT * FROM ");
      sql.append(Table.name());
      ...
      // 获得数据
      FDataPersonUserApplicationUnit[] units = new FDataPersonUserApplicationUnit[count];
   ...
   // @return 数据单元集合
   //============================================================
   public FDataPersonUserApplicationUnit[] fetchAll(){
      return fetch(null);
   }
   ...
   // @return 处理结果
   //============================================================
   public boolean doInsert(FDataPersonUserApplicationUnit unit){
      // 生成命令
      ...
      sql.append(',');
      sql.append(unit.userId());
      sql.append(',');
      sql.append(unit.applicationId());
      sql.append(',');
      sql.append(unit.estimateCd());
   ...
   // @return 处理结果
   //============================================================
   public boolean doUpdate(FDataPersonUserApplicationUnit unit, long recordId){
      // 检查记录编号
      if(0 == recordId){
