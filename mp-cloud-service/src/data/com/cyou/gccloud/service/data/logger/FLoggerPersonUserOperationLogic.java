...
// <T>用户操作日志逻辑。</T>
//============================================================
public class FLoggerPersonUserOperationLogic extends FLogicDataset
{
   // 用户操作日志的定义。
   public final static FLogicTable Table = new FLogicTable("LG_PSN_USER_OPERATION");
   ...
   // 字段操作代码的定义。
   public final static FLogicField FieldOperationCd = new FLogicField("OPERATION_CD");
   ...
   // <T>构造用户操作日志逻辑单元。</T>
   //============================================================
   public FLoggerPersonUserOperationLogic(){
   }
   ...
   // @return 数据单元
   //============================================================
   public FLoggerPersonUserOperationUnit find(long recordId){
      // 检查记录编号
      if(0 == recordId){
         return null;
      }
      ...
      // 获得数据
      FLoggerPersonUserOperationUnit unit = new FLoggerPersonUserOperationUnit();
      unit.load(row);
      return unit;
   }
   ...
   // @return 数据单元
   //============================================================
   public FLoggerPersonUserOperationUnit serach(String whereSql){
      // 生成命令
      FSql sql = new FSql("SELECT * FROM ");
      sql.append(Table.name());
      sql.append(" WHERE ");
   ...
   // @return 数据单元集合
   //============================================================
   public FLoggerPersonUserOperationUnit[] fetch(String whereSql){
   ...
   // @return 数据单元集合
   //============================================================
   public FLoggerPersonUserOperationUnit[] fetch(String whereSql, String orderSql){
   ...
   // @return 数据单元集合
   //============================================================
   public FLoggerPersonUserOperationUnit[] fetch(String whereSql, String orderSql, int limitCount){
      // 生成命令
      FSql sql = new FSql("SELECT * FROM ");
      sql.append(Table.name());
      ...
      // 获得数据
      FLoggerPersonUserOperationUnit[] units = new FLoggerPersonUserOperationUnit[count];
   ...
   // @return 数据单元集合
   //============================================================
   public FLoggerPersonUserOperationUnit[] fetchAll(){
      return fetch(null);
   }
   ...
   // @return 处理结果
   //============================================================
   public boolean doInsert(FLoggerPersonUserOperationUnit unit){
      // 生成命令
   ...
   // @return 处理结果
   //============================================================
   public boolean doUpdate(FLoggerPersonUserOperationUnit unit, long recordId){
      // 检查记录编号
      if(0 == recordId){
