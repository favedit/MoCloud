package com.cyou.gccloud.service.data.cache;
...
// <T>系统会话表逻辑。</T>
//============================================================
public class FCacheSystemSessionLogic extends FLogicDataset
{
   // 系统会话表的定义。
   public final static FLogicTable Table = new FLogicTable("CC_SYS_SESSION");
   ...
   // @return 数据单元
   //============================================================
   public FCacheSystemSessionUnit find(long recordId){
      // 检查记录编号
      if(0 == recordId){
         return null;
      }
   ...
   // @return 数据单元
   //============================================================
   public FCacheSystemSessionUnit serach(String whereSql){
      // 生成命令
      FSql sql = new FSql("SELECT * FROM ");
      sql.append(Table.name());
      sql.append(" WHERE ");
   ...
   // @return 数据单元集合
   //============================================================
   public FCacheSystemSessionUnit[] fetch(String whereSql){
   ...
   // @return 数据单元集合
   //============================================================
   public FCacheSystemSessionUnit[] fetch(String whereSql, String orderSql){
   ...
   // @return 数据单元集合
   //============================================================
   public FCacheSystemSessionUnit[] fetch(String whereSql, String orderSql, int limitCount){
      // 生成命令
      FSql sql = new FSql("SELECT * FROM ");
      sql.append(Table.name());
      ...
      // 获得数据
      FCacheSystemSessionUnit[] units = new FCacheSystemSessionUnit[count];
   ...
   // @return 数据单元集合
   //============================================================
   public FCacheSystemSessionUnit[] fetchAll(){
      return fetch(null);
   }
   ...
   // @return 处理结果
   //============================================================
   public boolean doInsert(FCacheSystemSessionUnit unit){
      // 生成命令
   ...
   // @return 处理结果
   //============================================================
   public boolean doUpdate(FCacheSystemSessionUnit unit, long recordId){
      // 检查记录编号
      if(0 == recordId){
