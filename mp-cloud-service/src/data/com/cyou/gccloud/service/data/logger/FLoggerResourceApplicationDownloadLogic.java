package com.cyou.gccloud.service.data.logger;
...
// <T>应用下载日志表逻辑。</T>
//============================================================
public class FLoggerResourceApplicationDownloadLogic extends FLogicDataset
{
   // 应用下载日志表的定义。
   public final static FLogicTable Table = new FLogicTable("LG_RES_APPLICATION_DOWNLOAD");
   ...
   // <T>构造应用下载日志表逻辑单元。</T>
   //============================================================
   public FLoggerResourceApplicationDownloadLogic(){
   }
   ...
   // @return 数据单元
   //============================================================
   public FLoggerResourceApplicationDownloadUnit find(long recordId){
      // 检查记录编号
      if(0 == recordId){
         return null;
      }
      ...
      // 获得数据
      FLoggerResourceApplicationDownloadUnit unit = new FLoggerResourceApplicationDownloadUnit();
      unit.load(row);
      return unit;
   }
   ...
   // @return 数据单元
   //============================================================
   public FLoggerResourceApplicationDownloadUnit serach(String whereSql){
      // 生成命令
      FSql sql = new FSql("SELECT * FROM ");
      sql.append(Table.name());
      sql.append(" WHERE ");
   ...
   // @return 数据单元集合
   //============================================================
   public FLoggerResourceApplicationDownloadUnit[] fetch(String whereSql){
   ...
   // @return 数据单元集合
   //============================================================
   public FLoggerResourceApplicationDownloadUnit[] fetch(String whereSql, String orderSql){
   ...
   // @return 数据单元集合
   //============================================================
   public FLoggerResourceApplicationDownloadUnit[] fetch(String whereSql, String orderSql, int limitCount){
      // 生成命令
      FSql sql = new FSql("SELECT * FROM ");
      sql.append(Table.name());
      ...
      // 获得数据
      FLoggerResourceApplicationDownloadUnit[] units = new FLoggerResourceApplicationDownloadUnit[count];
   ...
   // @return 数据单元集合
   //============================================================
   public FLoggerResourceApplicationDownloadUnit[] fetchAll(){
      return fetch(null);
   }
   ...
   // @return 处理结果
   //============================================================
   public boolean doInsert(FLoggerResourceApplicationDownloadUnit unit){
      // 生成命令
   ...
   // @return 处理结果
   //============================================================
   public boolean doUpdate(FLoggerResourceApplicationDownloadUnit unit, long recordId){
      // 检查记录编号
      if(0 == recordId){
