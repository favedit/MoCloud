...
// <T>用户应用表逻辑单元。</T>
//============================================================
public class FDataPersonUserApplicationUnit extends FLogicUnit
{
   // 存储字段对象标识的定义。
   private long __ouid;
   ...
   // <T>构造用户应用表逻辑单元。</T>
   //============================================================
   public FDataPersonUserApplicationUnit(){
   }
   ...
   public void load(FRow row){
      ...
      _ouid = __ouid;
      __userId = RLong.parse(row.get("user_id"));
      _userId = __userId;
      __applicationId = RLong.parse(row.get("application_id"));
      _applicationId = __applicationId;
      __estimateCd = row.getInteger("estimate_cd");
