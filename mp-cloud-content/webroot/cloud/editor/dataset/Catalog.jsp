...
<ToolBar width='100%' align='right'>
	<ToolButtonText name='btnForm' label='数据集合列表' icon='sys.pst.mgr' target='frmMain' page='#/editor/dataset/Dataset.wa?do=list&amp;form_name=cloud.editor.dataset.DatasetList'/>
	<ToolButton name='btnRefresh' icon='tool.refresh' action='refreshNode()'/>
</ToolBar>
</XML>
<!-- TreeView config ----------------------------------------->
<jc:tree name='xTree' source='cloud.editor.dataset'/>
<!-- Body begin ---------------------------------------------->
