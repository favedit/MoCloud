...
function submitForm(){		
	...
	progress();	
	var url = "/cloud/product/resource/channel/ResourceChannel.wa?do=isExist&date="+new Date().valueOf();
	var data ={"moduleId":$('#moduleId').val(),"code":$('#code').val()};
	$.ajax({
	   type:"POST",
	   url:url,
	   data:data,
...
<div class="easyui-panel" fit='true'>
  <form id="form" method="post" action="/cloud/product/resource/channel/ResourceChannel.wa?do=insert" enctype="multipart/form-data">
    <div id="cy_right" style="width:100%">
      <div class="right_title"> <span>添加资源频道</span> </div>
      <div class="btn_bar">
        <div class="nav_btn"> <a href="#" onClick="submitForm()" class="add_btn"></a> <a href="/cloud/product/resource/channel/ResourceChannel.wa" class="back_btn"></a> </div>
      </div>
    </div>
      ...
      <table align="left">
        <tr>
          ...
          <td align="left"><input name="ouid" style="width:80px;text-align:right;" disabled class="easyui-validatebox textbox disabled" id="ouid"/>
            ...
            <input type="checkbox" id="displayCd" name="displayCd" checked="true">
            显示
            </input></td>
        </tr>
        <tr>
          <td align="left">图标</td>
          <td align="left"><input id="iconUrl" name="iconUri" type="file" class="checkImageType"/>
            <font color="#FF0000">(100*100)</font></td>
        </tr>
        <tr>
          <td align="left">模块</td>
          <td><select class="easyui-combobox" style="width:600px;" id="moduleId" name="moduleId" data-options="valueField:'ouid',textField:'label',editable:false" />
          </td>
        </tr>
        <tr>
          <td align="left">代码</td>
