...
<jh:define source="&resourceTypePage.Unit" alias="resourceType"></jh:define>
<HTML>
<HEAD>
...
function submitForm(){
	...
	var url = "/cloud/product/resource/type/ResourceType.wa?do=canModify&date="+new Date().valueOf();
...
<div class="easyui-panel" fit='true'>
  <form id="form" method="post" action="/cloud/product/resource/type/ResourceType.wa?do=updateSave" enctype="multipart/form-data">
    <div id="cy_right" style="width:100%">
      <div class="right_title"> <span>编辑资源类型</span> </div>
      <div class="btn_bar" style='boder:1px solid black'>
        <div class="nav_btn"> <a href="#" onClick="submitForm()" class="sub_btn"></a> <a href="/cloud/product/resource/type/ResourceType.wa" class="back_btn"></a> </div>
      </div>
    </div>
    <div class='cy_edit_panel'>
      <table border="0">
        <tr>
          ...
          <td align="left"><input id="ouid" name="ouid" style="width:80px;text-align:right;" class="disabled" readonly value="<jh:write source='&resourceType.ouid'/>"/>
            ...
            <input id="oriDisplayCd" style="display:none" value="<jh:write source='&resourceType.displayCd'/>"/></td>
        </tr>
        <tr>
        <td align="left">图标</td>
        <td align="left"><img id="oriIcon" onerror="imgNotfind();"/>
          <input id="oriIconUrl" style="display:none" value="<jh:write source='&resourceType.iconUrl' />"/>
        ...
        <tr>
          ...
          <td align="left"><select class="easyui-combobox" id="moduleId" name="moduleId" style="width:600px;" data-options="valueField:'ouid',textField:'label',onSelect:onModuleSelect,editable:false"/>
            <input id="oriModuleId" name="oriModuleId" readonly type="hidden" value="<jh:write source='&resourceType.moduleId'/>"/></td>
        </tr>
       	<tr>
          <td align="left">频道</td>
          <td align="left"><select class="easyui-combobox" id="channelId" name="channelId" style="width:600px;" data-options="valueField:'ouid',textField:'label',editable:false"/>
            <input id="oriChannelId" name="oriChannelId" readonly type="hidden" value="<jh:write source='&resourceType.channelId'/>"/></td>
        </tr>
        <tr>
        ...
        validtype="length[1,80]" value="<jh:write source='&resourceType.code'/>"/></td>
        </tr>
        <tr>
          <td align="left">标题</td>
          <td align="left" ><input id="label" class="easyui-validatebox textbox notnull" autocomplete="off" style="width:600px;text-align:left;" validtype="length[1,200]" data-options="required:true" name="label" value="<jh:write source='&resourceType.label'/>"/></td>
        </tr>
        <tr>
          <td align="left">排序值</td>
          <td align="left"><input id="displayOrder" name="displayOrder" class="easyui-numberbox" style="width:600px;text-align:right" data-options="required:true" value="<jh:write source='&resourceType.displayOrder'/>"/></td>
        </tr>
        <tr>
          <td align="left">备注</td>
          <td align="left"><textarea id="note" name="note" autocomplete="off" class="border_change" style="width:600px;height:140px"><jh:write source='&resourceType.note' format='text'/></textarea></td>
        </tr>
      </table>
    </div>
  </form>
