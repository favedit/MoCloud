...
function submitForm(){		
	...
	var url = "/cloud/product/resource/page/ResourcePage.wa?do=isExist&date="+new Date().valueOf();
...
<div class="easyui-panel" fit='true'>
  <form id="form" method="post" action="/cloud/product/resource/page/ResourcePage.wa?do=insert" enctype="multipart/form-data">
    <div id="cy_right" style="width:100%">
      <div class="right_title"> <span>添加资源页</span> </div>
      <div class="btn_bar">
        <div class="nav_btn"> <a href="#" onClick="submitForm()" class="add_btn"></a> <a href="/cloud/product/resource/page/ResourcePage.wa" class="back_btn"></a> </div>
      </div>
    </div>
    <div class='cy_edit_panel'>
      <table align="left">
        ...
        <tr>
          <td align="left">代码</td>
          <td align="left"><input id="code" name="code" style="width:600px;text-align:left;" autocomplete="off" class="easyui-validatebox textbox" 
          validtype="length[0,80]" value=""/>
        </tr>
        <tr>
          <td align="left">标签</td>
