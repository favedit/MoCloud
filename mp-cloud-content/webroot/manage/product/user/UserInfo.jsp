    ...
    <div class='cy_edit_panel'>
      <table border="0">
        ...
        <tr>
          ...
          <td align="left"><input id="label" class="easyui-validatebox textbox" validtype="length[1,80]" style="width:120px;" value="<jh:write source='&user.label'/>"/></td>
        ...
        <tr>
          ...
          <td align="left"><input class="disabled" disabled style="width:120px;" value="<jh:write source='&user.contactPhone'/>"/></td>
          <td align="left" width="49">电话权限</td>
          <td align="left" width="191"><input class="disabled" disabled style="width:120px;" value="<jh:write source='&user.contactPhoneSecurityLabel'/>"/>
            <%-- <input type="checkbox"/>
            已验证--%></td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td align="left"><input class="disabled" disabled style="width:120px;" value="<jh:write source='&user.contactMsn'/>"/></td>
          <td align="left" width="49">MSN权限</td>
          <td align="left" width="191"><input class="disabled" disabled style="width:120px;" value="<jh:write source='&user.msnSecurityCdLabel'/>"/></td>
        </tr>
        <tr>
        ...
        <tr>
          <td width="48" height="30" align="left">学校</td>
          <td align="left"><input id="oriSchoolId" type="hidden" value="<jh:write source='&user.schoolId'/>"/>
            <select id="schoolId" name="schoolId" class="easyui-combogrid" style="width:120px;">
            </select></td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          value="<jh:write source='&user.scoreLevel'/>" data-options="required:true"/></td>
        </tr>
        <tr>
          ...
          value="<jh:write source='&user.scoreGold'/>" data-options="required:true"/></td>
          ...
          value="<jh:write source='&user.scoreGoldExperience'/>" data-options="required:true"/></td>
        </tr>
        <tr>
          ...
          value="<jh:write source='&user.scorePoint'/>" data-options="required:true"/></td>
          ...
          value="<jh:write source='&user.scorePointExperience'/>" data-options="required:true"/></td>
        </tr>
        <tr>
          ...
          value="<jh:write source='&user.scoreBean'/>" data-options="required:true"/></td>
          ...
          value="<jh:write source='&user.scoreBeanExperience'/>" data-options="required:true"/></td>
        </tr>
      </table>
    </div>
  </form>
