...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
    ...
    <script type="text/javascript" src="/manage/ajs/cookie.js" ></script>
...
function submitForm(){
		...
		$.ajax({
		   type: "POST",
		   url: "/manage/login/Login.wa?do=loginUser&date="+new Date().valueOf(),
		   data:data,
		   success: function(msg){
			  ...
			  if(result == '0'){	
				  ...
				  alertx("无此用户","warning");				  
   			      ...
   			      location.href="/manage/home/Frame.wa";
			  }else if(result == '2'){
...
<center>
	<div id="login">
    	<div id="input">
            ...
            <div class="loginbtn">
              <input name="" onclick="submitForm()" type="image" src="/manage/images/loginbtn.png">
          </div>
        	<dl class="inp_3">
            	<dd>
