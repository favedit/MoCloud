package org.mo.eai.online.resource;
...
public class RDbImportData
{
   ...
   public static void importProcess() throws Exception{
      // 设置数据
      String path = RRs3Configuration.RootPath + "/MoResource/AssestEai";
      // 导入处理
   ...
   public static void main(String[] args) throws Exception{
      ...
      RAop.initialize(configPath + "/mp-cloud-content/src/config/application-eai-online.xml");
      try{
         importProcess();
      }catch(Exception e){
