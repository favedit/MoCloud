...
// <T>纹理数据。</T>
//============================================================
public class FBitmapImageServlet
      extends FObject
      implements
         IBitmapImageServlet
{
   // 日志输出接口
   private static ILogger _logger = RLogger.find(FBitmapImageServlet.class);
   ...
   public void view(IWebContext context,
      ...
      //............................................................
      // 生成预览
      byte[] data = _bitmapImageConsole.makeViewData(logicContext, guid);
      int dataLength = 0;
      if(data != null){
   ...
   public void preview(IWebContext context,
      ...
      //............................................................
      // 生成预览
      byte[] data = _bitmapImageConsole.makePreviewData(logicContext, guid);
      int dataLength = 0;
      if(data != null){
         dataLength = data.length;
      }
