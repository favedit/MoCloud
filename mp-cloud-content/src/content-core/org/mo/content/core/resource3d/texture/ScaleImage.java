...
public class ScaleImage
{
   ...
   */
   ...
   public static void main(String[] args){
      ...
      try{
         is.saveImageAsJpg("d:/firefox.jpg", "d:/test.jpg", 768, 680);
      }catch(Exception e){
   ...
   public void saveImageAsJpg(String fromFileStr,
   ...
   * 决定图像尺寸
   */
   private int DetermineResultSize(int w,
                                   int h){
   ...
   // 处理边缘
   private void CalTempContrib(int start,
                               int stop){
      double weight = 0;
   ...
   private int ComRGB(int redValue,
                      int greenValue,
                      int blueValue){
   ...
   // 行水平滤波
   private int HorizontalFilter(BufferedImage bufImg,
                                int startX,
                                int stopX,
                                int start,
                                int stop,
   ...
   // 图片水平滤波
   private BufferedImage HorizontalFiltering(BufferedImage bufImage,
                                             int iOutW){
   ...
   private int VerticalFilter(BufferedImage pbInImage,
                              int startY,
                              int stopY,
                              int start,
                              int stop,
   ...
   private BufferedImage VerticalFiltering(BufferedImage pbImage,
                                           int iOutH){
