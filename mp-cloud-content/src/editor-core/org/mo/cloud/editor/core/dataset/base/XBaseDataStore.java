package org.mo.cloud.editor.core.dataset.base;

import org.mo.cloud.editor.core.dataset.common.XDatasetFace;
         ...
         XDatasetFace
{
   ...
   // 超时设定的名称定义
   public static final String PTY_LOGIC_TIMEOUT = "logic_timeout";
   ...
   public String innerGet(String name){
      ...
      }else if(PTY_LOGIC_TIMEOUT.equalsIgnoreCase(name)){
         return getLogicTimeout();
   ...
   public void loadConfig(FXmlNode config, EXmlConfig type){
      ...
      if(EXmlConfig.Full == type){
         ...
         if(config.contains("logic_timeout")){
            setLogicTimeout(config.get(PTY_LOGIC_TIMEOUT));
         }
         ...
         if(RString.isEmpty(getLogicTimeout())){
            if(config.contains("logic_timeout")){
               setLogicTimeout(config.get(PTY_LOGIC_TIMEOUT));
            }
         }
   ...
   public void saveConfig(FXmlNode config, EXmlConfig type){
      ...
      if(EXmlConfig.Full == type){
         ...
         if(RString.isNotEmpty(getLogicTimeout())){
            config.set(PTY_LOGIC_TIMEOUT, getLogicTimeout());
         }
         ...
         String sLogicTimeout = getLogicTimeout();
         if(RString.isNotEmpty(sLogicTimeout)){
            config.set(PTY_LOGIC_TIMEOUT, sLogicTimeout);
         }
