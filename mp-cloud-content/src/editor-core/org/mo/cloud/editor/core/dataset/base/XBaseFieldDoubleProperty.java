...
import org.mo.cloud.editor.core.dataset.common.XFieldPropertyFace;
...
//============================================================
// <T>双精度浮点数字段(属性)对象的XML节点基类。</T>
//============================================================
public abstract class XBaseFieldDoubleProperty
      extends FXmlObject
      implements
         XFieldPropertyFace
{
   // 名称定义
   public static final String NAME = "FieldDoublePropery";
