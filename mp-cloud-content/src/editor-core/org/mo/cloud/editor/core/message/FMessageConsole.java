...
import org.mo.cloud.editor.core.message.common.XMessage;
import org.mo.cloud.editor.core.message.common.XMessageGroup;
import org.mo.cloud.editor.core.message.common.XMessageItem;
import org.mo.cloud.editor.core.message.common.XMessageStruct;
         ...
         IMessageConsole
{
   ...
   protected void makeSourceItemConfig(FXmlNode xmessage,
      ...
      try{
         ...
         // 设置Java属性
         xitem.set("data_type_java", REditorJavaSource.convertDataType(type, typeName));
         // 设置枚举属性
         if("Enum".equals(type)){
