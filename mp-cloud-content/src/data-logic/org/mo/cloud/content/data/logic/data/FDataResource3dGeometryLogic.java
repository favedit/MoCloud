...
//============================================================
@ASourceMachine
public class FDataResource3dGeometryLogic
      extends FLogicTable
{
   // 资源3D网格表的定义。
   ...
   // 资源3D网格表的定义。
   public final static SLogicTableInfo TABLE = new SLogicTableInfo("data.resource3d.geometry", "DT_RS3_GEOMETRY");
   ...
   // 字段顶点个数的定义。
   public final static SLogicFieldInfo VERTEX_COUNT = new SLogicFieldInfo("VERTEX_COUNT");

   // 字段索引个数的定义。
   public final static SLogicFieldInfo INDEX_COUNT = new SLogicFieldInfo("INDEX_COUNT");
   ...
   // 字段集合的定义。
   public final static String FIELDS = "OUID,OVLD,GUID,RESOURCE_ID,CODE,LABEL,VERTEX_COUNT,INDEX_COUNT,DESCRIPTION,CONTENT,NOTE,CREATE_USER_ID,CREATE_DATE,UPDATE_USER_ID,UPDATE_DATE";

   //============================================================
   // <T>构造资源3D网格表逻辑单元。</T>
   //============================================================
   public FDataResource3dGeometryLogic(){
      _name = TABLE.name();
      _classUnit = FDataResource3dGeometryUnit.class;
   }
   ...
   // @param context 逻辑环境
   //============================================================
   public FDataResource3dGeometryLogic(ILogicContext context){
      super(context);
      _name = TABLE.name();
      _classUnit = FDataResource3dGeometryUnit.class;
   }
   ...
   public <T extends FLogicUnit> T find(T unit,
      ...
      if(unit == null){
         if(clazz == null){
            unit = (T)(new FDataResource3dGeometryUnit());
         }else{
   ...
   // @return 数据单元
   //============================================================
   public FDataResource3dGeometryUnit search(CharSequence whereSql){
      return search(null, FDataResource3dGeometryUnit.class, whereSql);
   }
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FDataResource3dGeometryUnit> fetch(int pageSize,
                                                           int page){
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FDataResource3dGeometryUnit> fetch(CharSequence whereSql,
                                                           int pageSize,
                                                           int page){
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FDataResource3dGeometryUnit> fetch(CharSequence fields,
                                                           CharSequence whereSql,
                                                           CharSequence orderSql,
                                                           int pageSize,
                                                           int page){
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FDataResource3dGeometryUnit> fetchSql(CharSequence code,
                                                              CharSequence sql,
                                                              int pageSize,
                                                              int page){
   ...
   public <T extends FLogicUnit> FLogicDataset<T> fetchSql(Class<T> clazz,
      ...
      if(clazz == null){
         result = (FLogicDataset<T>)(new FLogicDataset<FDataResource3dGeometryUnit>(FDataResource3dGeometryUnit.class, _logicContext));
      }else{
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FDataResource3dGeometryUnit> fetchAll(){
      // 生成命令
   ...
   // @return 数据单元
   //============================================================
   public FDataResource3dGeometryUnit doPrepare(){
      FDataResource3dGeometryUnit unit = new FDataResource3dGeometryUnit();
      unit.linkLogicContext(_logicContext);
      doPrepare(unit);
      return unit;
   }
   ...
   public EResult doPrepare(FLogicUnit logicUnit){
      FDataResource3dGeometryUnit unit = (FDataResource3dGeometryUnit)logicUnit;
      unit.setOvld(true);
   ...
   public EResult doInsert(FLogicUnit logicUnit){
      ...
      cmd.append(",`CODE`");
      cmd.append(",`LABEL`");
      cmd.append(",`VERTEX_COUNT`");
      cmd.append(",`INDEX_COUNT`");
      ...
      cmd.append(',');
      cmd.append(unit.vertexCount());
      cmd.append(',');
      cmd.append(unit.indexCount());
      cmd.append(',');
   ...
   public EResult doUpdate(FLogicUnit logicUnit,
      ...
      if(unit.isVertexCountChanged()){
         cmd.append(",`VERTEX_COUNT`=");
         cmd.append(unit.vertexCount());
      }
      if(unit.isIndexCountChanged()){
         cmd.append(",`INDEX_COUNT`=");
         cmd.append(unit.indexCount());
      }
