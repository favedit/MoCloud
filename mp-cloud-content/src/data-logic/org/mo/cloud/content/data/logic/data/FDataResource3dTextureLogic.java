      ...
      extends FLogicTable
{
   ...
   // 字段集合的定义。
   public final static String FIELDS = "OUID,OVLD,GUID,RESOURCE_ID,CODE,LABEL,DESCRIPTION,CONTENT,NOTE,CREATE_USER_ID,CREATE_DATE,UPDATE_USER_ID,UPDATE_DATE";
