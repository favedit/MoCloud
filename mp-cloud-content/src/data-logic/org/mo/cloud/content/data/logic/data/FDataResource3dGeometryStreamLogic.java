package org.mo.cloud.content.data.logic.data;
...
//============================================================
@ASourceMachine
public class FDataResource3dGeometryStreamLogic
      extends FLogicTable
{
   // 资源3D网格数据表的定义。
   ...
   // 资源3D网格数据表的定义。
   public final static SLogicTableInfo TABLE = new SLogicTableInfo("data.resource3d.geometry.stream", "DT_RS3_GEOMETRY_STREAM");
   ...
   // 字段网格编号的定义。
   public final static SLogicFieldInfo GEOMETRY_ID = new SLogicFieldInfo("GEOMETRY_ID");

   // 字段代码的定义。
   public final static SLogicFieldInfo CODE = new SLogicFieldInfo("CODE");

   // 字段名称的定义。
   public final static SLogicFieldInfo FORMAT_CD = new SLogicFieldInfo("FORMAT_CD");
   ...
   // 字段集合的定义。
   public final static String FIELDS = "OUID,OVLD,GUID,GEOMETRY_ID,CODE,FORMAT_CD,DATA_STRIDE,DATA_COUNT,NOTE,CREATE_USER_ID,CREATE_DATE,UPDATE_USER_ID,UPDATE_DATE";

   //============================================================
   // <T>构造资源3D网格数据表逻辑单元。</T>
   //============================================================
   public FDataResource3dGeometryStreamLogic(){
      _name = TABLE.name();
      _classUnit = FDataResource3dGeometryStreamUnit.class;
   }
   ...
   // @param context 逻辑环境
   //============================================================
   public FDataResource3dGeometryStreamLogic(ILogicContext context){
      super(context);
      _name = TABLE.name();
      _classUnit = FDataResource3dGeometryStreamUnit.class;
   }
   ...
   public <T extends FLogicUnit> T find(T unit,
      ...
      if(unit == null){
         if(clazz == null){
            unit = (T)(new FDataResource3dGeometryStreamUnit());
         }else{
   ...
   // @return 数据单元
   //============================================================
   public FDataResource3dGeometryStreamUnit search(CharSequence whereSql){
      return search(null, FDataResource3dGeometryStreamUnit.class, whereSql);
   }
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FDataResource3dGeometryStreamUnit> fetch(int pageSize,
                                                                 int page){
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FDataResource3dGeometryStreamUnit> fetch(CharSequence whereSql,
                                                                 int pageSize,
                                                                 int page){
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FDataResource3dGeometryStreamUnit> fetch(CharSequence fields,
                                                                 CharSequence whereSql,
                                                                 CharSequence orderSql,
                                                                 int pageSize,
                                                                 int page){
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FDataResource3dGeometryStreamUnit> fetchSql(CharSequence code,
                                                                    CharSequence sql,
                                                                    int pageSize,
                                                                    int page){
   ...
   public <T extends FLogicUnit> FLogicDataset<T> fetchSql(Class<T> clazz,
      ...
      if(clazz == null){
         result = (FLogicDataset<T>)(new FLogicDataset<FDataResource3dGeometryStreamUnit>(FDataResource3dGeometryStreamUnit.class, _logicContext));
      }else{
   ...
   // @return 数据单元集合
   //============================================================
   public FLogicDataset<FDataResource3dGeometryStreamUnit> fetchAll(){
      // 生成命令
   ...
   // @return 数据单元
   //============================================================
   public FDataResource3dGeometryStreamUnit doPrepare(){
      FDataResource3dGeometryStreamUnit unit = new FDataResource3dGeometryStreamUnit();
      unit.linkLogicContext(_logicContext);
      doPrepare(unit);
      return unit;
   }
   ...
   public EResult doPrepare(FLogicUnit logicUnit){
      FDataResource3dGeometryStreamUnit unit = (FDataResource3dGeometryStreamUnit)logicUnit;
      unit.setOvld(true);
   ...
   public EResult doInsert(FLogicUnit logicUnit){
      ...
      cmd.append("`OVLD`");
      cmd.append(",`GUID`");
      cmd.append(",`GEOMETRY_ID`");
      cmd.append(",`CODE`");
      cmd.append(",`FORMAT_CD`");
      ...
      cmd.append('\'');
      cmd.append(',');
      long geometryId = unit.geometryId();
      if(geometryId == 0){
         cmd.append("NULL");
      }else{
         cmd.append(geometryId);
      }
      cmd.append(',');
