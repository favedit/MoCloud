...
//============================================================
@ASourceMachine
public class FDataResource3dMaterialTextureUnit
      extends FLogicUnit
{
   // 存储字段对象标识的定义。
   private long __ouid;
   ...
   // 存储字段位图编号的定义。
   private long __textureBitmapId;

   // 字段位图编号的定义。
   protected long _textureBitmapId;
   ...
   // <T>构造资源3D材质纹理表逻辑单元。</T>
   //============================================================
   public FDataResource3dMaterialTextureUnit(){
   }
   ...
   // @return 数据内容
   //============================================================
   public FDataResource3dMaterialUnit material(){
      FDataResource3dMaterialLogic logic = _logicContext.findLogic(FDataResource3dMaterialLogic.class);
      FDataResource3dMaterialUnit unit = logic.find(_materialId);
      return unit;
   }
   ...
   // @return 数据内容
   //============================================================
   public boolean isTextureBitmapIdChanged(){
      return __textureBitmapId != _textureBitmapId;
   }
   ...
   // @return 数据内容
   //============================================================
   public long textureBitmapId(){
      return _textureBitmapId;
   }
   ...
   // @return 数据内容
   //============================================================
   public FDataResource3dTextureBitmapUnit textureBitmap(){
      FDataResource3dTextureBitmapLogic logic = _logicContext.findLogic(FDataResource3dTextureBitmapLogic.class);
      FDataResource3dTextureBitmapUnit unit = logic.find(_textureBitmapId);
      return unit;
   }
   ...
   // @param value 数据内容
   //============================================================
   public void setTextureBitmapId(long value){
      _textureBitmapId = value;
   }
   ...
   public String get(String name){
      switch(name){
         ...
         case "texture_bitmap_id":
            return Long.toString(_textureBitmapId);
         case "note":
            return _note;
         case "create_user_id":
   ...
   public void set(String name,
      ...
      switch(name){
         ...
         case "texture_id":
            ...
            break;
         case "texture_bitmap_id":
            _textureBitmapId = RLong.parse(value);
            break;
         case "note":
            _note = value;
            break;
      ...
      for(IStringPair pair : row){
         ...
         switch(name){
            ...
            case "texture_id":
               ...
               break;
            case "texture_bitmap_id":
               __textureBitmapId = RLong.parse(value);
               _textureBitmapId = __textureBitmapId;
               break;
            case "note":
               __note = value;
               _note = __note;
